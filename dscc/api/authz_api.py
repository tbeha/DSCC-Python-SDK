...
class AuthzApi:
    ...
    def get_access_controls(
        self,
        permission: Annotated[Optional[List[StrictStr]], Field(description="List of permissions, each of which, has the form \"resource type.permission\" (ex. volume.read,volume.write). The word \"ANY\" can be used as a wild card for the resource type (ex. ANY.read). Omitting the permission parameters is equivalent to asking for all user permissions.")] = None,
        ...
        :param permission: List of permissions, each of which, has the form \"resource type.permission\" (ex. volume.read,volume.write). The word \"ANY\" can be used as a wild card for the resource type (ex. ANY.read). Omitting the permission parameters is equivalent to asking for all user permissions.
        ...
        _param = self._get_access_controls_serialize(
    ...
    @validate_call
    def get_access_controls_with_http_info(
        self,
        permission: Annotated[Optional[List[StrictStr]], Field(description="List of permissions, each of which, has the form \"resource type.permission\" (ex. volume.read,volume.write). The word \"ANY\" can be used as a wild card for the resource type (ex. ANY.read). Omitting the permission parameters is equivalent to asking for all user permissions.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccessControlsResponse]:
        """Get User Accessible Resources
    ...
    @validate_call
    def get_access_controls_without_preload_content(
        self,
        permission: Annotated[Optional[List[StrictStr]], Field(description="List of permissions, each of which, has the form \"resource type.permission\" (ex. volume.read,volume.write). The word \"ANY\" can be used as a wild card for the resource type (ex. ANY.read). Omitting the permission parameters is equivalent to asking for all user permissions.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_access_controls_serialize(
        self,
        permission,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/access-controls',
    ...
    def get_resource_types_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceTypesResponse]:
        """Get resource types with read permissions
