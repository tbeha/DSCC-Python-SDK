...
class DeviceType4ApplicationSets(BaseModel):
    """
    ...
    app_set_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Application set name. `Filter`", alias="appSetName")
    app_set_type: Optional[StrictStr] = Field(default=None, description="Name of the resource. `Filter`", alias="appSetType")
    ...
    id: Optional[StrictStr] = Field(default=None, description="uid of the applicationset `Filter`")
    ...
    members: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Volume Names. `Filter`")
    ...
    remote_recovery_point: Optional[DeviceType4RecoveryPoint] = Field(default=None, alias="remoteRecoveryPoint")
    ...
    serial_number: Optional[StrictStr] = Field(default=None, description="Serial number. This field is deprecated.", alias="serialNumber")
    ...
    system_id: Optional[StrictStr] = Field(default=None, description="SystemUid/serialNumber of the array. `Filter`", alias="systemId")
    type: Optional[StrictStr] = Field(default=None, description="type")
    vv_set_type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Type of the volume-set. `Filter`", alias="vvSetType")
    zero_rto_config: Optional[StrictStr] = Field(default=None, description="Zero RTO configuration. Supported config is Active Peer Persistence. Classic Peer Persistence is not supported for HPE Alletra Storage MP.", alias="zeroRtoConfig")
    __properties: ClassVar[List[str]] = ["appSetBusinessUnit", "appSetComments", "appSetExcludeAIQoS", "appSetId", "appSetImportance", "appSetName", "appSetType", "appSetTypeEnum", "associatedLinks", "comment", "commonResourceAttributes", "customerId", "displayName", "domain", "drState", "exportStatus", "generation", "id", "initiators", "isFailoverAllowed", "isOverrideAllowed", "isPrimary", "isSyncAllowed", "kvPairsPresent", "members", "name", "nonZeroRtoConfig", "remoteRecoveryPoint", "replicationPartner", "replicationState", "replicationTraffic", "replicationType", "role", "serialNumber", "sizeMiB", "snapSetParentId", "snapSetParentName", "systemId", "type", "vvSetType", "zeroRtoConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remoteRecoveryPoint": DeviceType4RecoveryPoint.from_dict(obj["remoteRecoveryPoint"]) if obj.get("remoteRecoveryPoint") is not None else None,
