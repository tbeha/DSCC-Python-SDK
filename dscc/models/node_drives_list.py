...
class NodeDrivesList(BaseModel):
    """
    NodeDrivesList
    """ # noqa: E501
    ...
    size_mi_b: Optional[StrictInt] = Field(default=None, description="Size in MiB. `Filter, Sort`", alias="sizeMiB")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "displayname", "domain", "fwVersion", "generation", "id", "manufacturing", "maxLBA", "name", "nodeDeviceId", "nodeDriveId", "nodeDriveType", "nodeId", "resourceUri", "sedState", "sizeMiB", "systemId", "type", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "manufacturing": Manufacturing.from_dict(obj["manufacturing"]) if obj.get("manufacturing") is not None else None,
