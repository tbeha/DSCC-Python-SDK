...
class HostGroupSummaryObject(BaseModel):
    """
    ...
    user_created: Optional[StrictBool] = Field(default=None, description="Idicates whether user created host or discovered host", alias="userCreated")
    __properties: ClassVar[List[str]] = ["id", "isMergable", "markedForDelete", "name", "systems", "userCreated"]
