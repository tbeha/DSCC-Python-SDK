...
class NimbleAccessControlRecordDetailsWithRequestUri(BaseModel):
    """
    NimbleAccessControlRecordDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed access-control-record object", alias="requestUri")
    ...
    creation_time: Optional[StrictInt] = Field(default=None, description="Time when this access control record was created.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the access control record.")
    initiator_group_id: Optional[StrictStr] = Field(default=None, description="Identifier for the initiator group.")
    initiator_group_name: Optional[StrictStr] = Field(default=None, description="Name of the initiator group. (this argument is deprecated)")
    last_modified: Optional[StrictInt] = Field(default=None, description="Time when this access control record was last modified.")
    ...
    pe_lun: Optional[StrictInt] = Field(default=None, description="LUN (Logical Unit Number) to associate with this protocol endpoint. Valid LUNs are in the 0-2047 range.")
    pe_name: Optional[StrictStr] = Field(default=None, description="Name of the protocol endpoint this access control record applies to.")
    ...
    snap_name: Optional[StrictStr] = Field(default=None, description="Name of the snapshot this access control record applies to.")
    vol_id: Optional[StrictStr] = Field(default=None, description="Identifier for the volume this access control record applies to.")
    vol_name: Optional[StrictStr] = Field(default=None, description="Name of the volume this access control record applies to.")
