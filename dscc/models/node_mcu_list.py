...
class NodeMcuList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "domain", "fwVersion", "generation", "id", "model", "name", "nodeDeviceId", "nodeId", "resetReason", "resourceUri", "state", "systemId", "type", "upSince"]
