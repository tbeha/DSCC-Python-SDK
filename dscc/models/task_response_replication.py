...
class TaskResponseReplication(BaseModel):
    """
    TaskResponseReplication
    """ # noqa: E501
    response: Optional[List[NimbleTestConfigurationResponse]] = Field(default=None, description="Test Configuration Response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [NimbleTestConfigurationResponse.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
