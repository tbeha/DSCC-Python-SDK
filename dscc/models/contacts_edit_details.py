...
class ContactsEditDetails(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="Unique Identifier of the contact. This field is not editable.")
    ...
    system_id: Optional[StrictStr] = Field(default=None, description="SystemUid/serialNumber of the array. This field is not editable.", alias="systemId")
    __properties: ClassVar[List[str]] = ["company", "companyCode", "country", "fax", "firstName", "id", "includeSvcAlerts", "lastName", "notificationSeverities", "preferredLanguage", "primaryEmail", "primaryPhone", "receiveEmail", "receiveGrouped", "secondaryEmail", "secondaryPhone", "systemId"]
