...
class NimblevolumeCapacityHistory(BaseModel):
    """
    ...
    series_data: Optional[List[Optional[NimblevolumeCapacitySeriesData]]] = None
    __properties: ClassVar[List[str]] = ["commonResourceAttributes", "count", "requestURI", "series_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "series_data": [NimblevolumeCapacitySeriesData.from_dict(_item) for _item in obj["series_data"]] if obj.get("series_data") is not None else None
        })
        return _obj
