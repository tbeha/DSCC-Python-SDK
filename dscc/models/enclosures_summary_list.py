...
class EnclosuresSummaryList(BaseModel):
    """
    EnclosuresSummaryList
    """ # noqa: E501
    items: Optional[List[EnclosuresList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [EnclosuresList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
