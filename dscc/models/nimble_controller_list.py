...
class NimbleControllerList(BaseModel):
    """
    NimbleControllerList
    """ # noqa: E501
    items: Optional[List[NimbleControllerListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for controller objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of controllers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleControllerListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
