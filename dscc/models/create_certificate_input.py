...
class CreateCertificateInput(BaseModel):
    ...
    subject_alt_name: Optional[CertSubjectAltName] = Field(default=None, alias="subjectAltName")
    ...
    def service_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['QW_CLIENT', 'QW_SERVER', 'WSAPI', 'CLI', 'CIM', 'VASA', 'EKM_CLIENT', 'SYSLOG_GEN_CLIENT', 'SYSLOG_SEC_CLIENT', 'UNIFIED_SERVER']):
            raise ValueError("must be one of enum values ('QW_CLIENT', 'QW_SERVER', 'WSAPI', 'CLI', 'CIM', 'VASA', 'EKM_CLIENT', 'SYSLOG_GEN_CLIENT', 'SYSLOG_SEC_CLIENT', 'UNIFIED_SERVER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subjectAltName": CertSubjectAltName.from_dict(obj["subjectAltName"]) if obj.get("subjectAltName") is not None else None,
            "type": obj.get("type")
        })
        return _obj
