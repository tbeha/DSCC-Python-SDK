...
class DeviceType4SnapshotsListSingle(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adminAllocationSettings", "baseId", "comment", "commonResourceAttributes", "compressionPolicy", "consoleUri", "conversionType", "copyOfID", "creationTime", "customerId", "dataReduction", "dedup", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCapacity", "snapshotId", "snapshotType", "spaceCalculationTime", "started", "state", "systemId", "thinProvisioned", "type", "unrefSpaceFreedTime", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "vlunSectorSize", "wwn"]
