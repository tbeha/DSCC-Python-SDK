...
class DeviceType4SwitchPSDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "generation", "id", "manufacturing", "name", "requestUri", "resourceUri", "state", "switchName", "switchPSId", "switchUid", "systemId", "type"]
