...
class NodeBatteriesSummaryList(BaseModel):
    """
    NodeBatteriesSummaryList
    """ # noqa: E501
    items: Optional[List[NodeBatteriesList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of node Batteries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NodeBatteriesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
