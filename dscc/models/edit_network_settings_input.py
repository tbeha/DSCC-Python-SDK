...
class EditNetworkSettingsInput(BaseModel):
    """
    ...
    proxy_params: Optional[EditNetworkSettingsInputProxyParams] = Field(default=None, alias="proxyParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proxyParams": EditNetworkSettingsInputProxyParams.from_dict(obj["proxyParams"]) if obj.get("proxyParams") is not None else None
        })
        return _obj
