...
class EnclosureExpandersSummaryList(BaseModel):
    """
    EnclosureExpandersSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[EnclosureExpanderList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure fans object", alias="requestUri")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [EnclosureExpanderList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
