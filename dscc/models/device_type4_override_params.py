...
class DeviceType4OverrideParams(BaseModel):
    """
    DeviceType4OverrideParams
    """ # noqa: E501
    target_name: Optional[StrictStr] = Field(default=None, description="Replication partner name (target name) on which the override action is to be performed.", alias="targetName")
    __properties: ClassVar[List[str]] = ["targetName"]
