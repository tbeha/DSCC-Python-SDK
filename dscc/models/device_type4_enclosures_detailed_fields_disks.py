...
class DeviceType4EnclosuresDetailedFieldsDisks(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsDisks
    """ # noqa: E501
    items: Optional[List[DeviceType4disksLists]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4disksLists.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
