...
class DeviceType4PortsSummaryList(BaseModel):
    """
    DeviceType4PortsSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4portsList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of ports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4portsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
