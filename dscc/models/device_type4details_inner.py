...
class DeviceType4detailsInner(BaseModel):
    """
    DeviceType4detailsInner
    """ # noqa: E501
    args: Optional[List[DeviceType4detailsInnerArgsInner]] = None
    default: Optional[StrictStr] = Field(default=None, description="Text in the default language")
    key: Optional[StrictStr] = Field(default=None, description="Key of the message")
    __properties: ClassVar[List[str]] = ["args", "default", "key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": [DeviceType4detailsInnerArgsInner.from_dict(_item) for _item in obj["args"]] if obj.get("args") is not None else None,
