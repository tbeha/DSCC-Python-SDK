...
class SwitchOverParams(BaseModel):
    """
    SwitchOverParams
    """ # noqa: E501
    target_name: Optional[StrictStr] = Field(default=None, description="Replication partner name (target name) on which the switchover action is to be performed.", alias="targetName")
