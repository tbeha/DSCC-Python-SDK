...
class VolumeCapacityHistory(BaseModel):
    """
    volume capacity trends for given granularity
    """ # noqa: E501
    capacity_data: Optional[VolumeCapacityHistoryCapacityData] = Field(default=None, alias="capacityData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacityData": VolumeCapacityHistoryCapacityData.from_dict(obj["capacityData"]) if obj.get("capacityData") is not None else None,
