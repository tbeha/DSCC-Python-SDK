...
class DeviceType4SetEKMBackupConfigInput(BaseModel):
    """
    DeviceType4SetEKMBackupConfigInput
    """ # noqa: E501
    parameters: Optional[DeviceType4SetEKMBackupConfigParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": DeviceType4SetEKMBackupConfigParams.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
