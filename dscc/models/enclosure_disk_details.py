...
class EnclosureDiskDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "requestUri", "resourceUri", "systemId", "temperature", "type", "wwn"]
