...
class NimbleStorageSystemDetailsWithRequestUri(BaseModel):
    """
    NimbleStorageSystemDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed storage system object", alias="requestUri")
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the group. A 42 digit hexadecimal number.")
