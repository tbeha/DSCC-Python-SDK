...
class DeviceType4SystemConfigParams(BaseModel):
    """
    DeviceType4SystemConfigParams
    """ # noqa: E501
    items: Optional[DeviceType4systemSettingsDetails] = None
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for system settings details", alias="requestUri")
    __properties: ClassVar[List[str]] = ["items", "requestUri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": DeviceType4systemSettingsDetails.from_dict(obj["items"]) if obj.get("items") is not None else None,
