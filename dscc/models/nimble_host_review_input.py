...
class NimbleHostReviewInput(BaseModel):
    """
    Request body for provisioning review post call
    """ # noqa: E501
    host_groups: Optional[List[Optional[StrictStr]]] = Field(default=None, description="list of host groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "host_groups": obj.get("host_groups")
        })
        return _obj
