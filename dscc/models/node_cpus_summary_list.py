...
class NodeCpusSummaryList(BaseModel):
    """
    NodeCpusSummaryList
    """ # noqa: E501
    items: Optional[List[NodeCpuList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of node Cpus.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NodeCpuList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
