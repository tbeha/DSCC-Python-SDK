...
class DeviceType4DiskPortPosition(BaseModel):
    """
    Port Position
    """ # noqa: E501
    node: Optional[StrictInt] = Field(default=None, description="node ID")
    port: Optional[StrictInt] = Field(default=None, description="port ID")
    slot: Optional[StrictInt] = Field(default=None, description="slot ID")
