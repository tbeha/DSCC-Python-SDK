...
class NimbleNetworkSettingDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["active_since", "array_list", "associatedLinks", "commonResourceAttributes", "consoleUri", "creation_time", "customerId", "generation", "group_leader_array", "iscsi_automatic_connection_method", "iscsi_connection_rebalancing", "last_active", "last_modified", "mgmt_ip", "resourceUri", "route_list", "secondary_mgmt_ip", "subnet_list", "type"]
