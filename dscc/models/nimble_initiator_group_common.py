...
class NimbleInitiatorGroupCommon(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "creation_time", "customerId", "description", "fc_initiators", "fc_sessions", "fc_tdz_ports", "full_name", "generation", "iscsi_initiators", "last_modified", "metadata", "num_connections", "resourceUri", "sc_HostId", "search_name", "target_subnets", "type", "volume_count", "volume_list"]
