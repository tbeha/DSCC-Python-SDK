...
class NimbleSnapshotCollectionCommon(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allow_writes", "associated_links", "commonResourceAttributes", "consoleUri", "creation_time", "customerId", "description", "generation", "is_complete", "is_external_trigger", "is_manual", "is_manually_managed", "is_mfa_protected", "is_replica", "is_unmanaged", "last_modified", "metadata", "origin_name", "peer_snapcoll_id", "repl_status", "replicate_to", "resourceUri", "snapshots_list", "type", "volcoll_creator_id", "volcoll_creator_name"]
