...
class DeviceType4RemoveRemoteProtectionInputSchema(BaseModel):
    """
    DeviceType4RemoveRemoteProtectionInputSchema
    """ # noqa: E501
    partner_id: StrictStr = Field(description="Replication partner ID where remote protection is created", alias="partnerId")
    __properties: ClassVar[List[str]] = ["partnerId"]
