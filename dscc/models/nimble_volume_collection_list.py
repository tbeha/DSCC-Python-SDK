...
class NimbleVolumeCollectionList(BaseModel):
    """
    NimbleVolumeCollectionList
    """ # noqa: E501
    items: Optional[List[NimbleVolumeCollectionListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for volumeCollection objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Volume Collections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleVolumeCollectionListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
