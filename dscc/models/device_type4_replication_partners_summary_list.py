...
class DeviceType4ReplicationPartnersSummaryList(BaseModel):
    """
    DeviceType4ReplicationPartnersSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4ReplicationPartnerList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for replication partner list where volume set is remote protected", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of  replication partners.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4ReplicationPartnerList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
