...
class DeviceType4friendlyCertificate(BaseModel):
    """
    Friendly info of the SMTP/mail server certificate
    """ # noqa: E501
    valid_from: Optional[DeviceType4friendlyCertificateValidFrom] = Field(default=None, alias="ValidFrom")
    valid_until: Optional[DeviceType4friendlyCertificateValidUntil] = Field(default=None, alias="ValidUntil")
    issued_to: Optional[StrictStr] = Field(default=None, description="Certificate issued to", alias="issuedTo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ValidFrom": DeviceType4friendlyCertificateValidFrom.from_dict(obj["ValidFrom"]) if obj.get("ValidFrom") is not None else None,
            "ValidUntil": DeviceType4friendlyCertificateValidUntil.from_dict(obj["ValidUntil"]) if obj.get("ValidUntil") is not None else None,
