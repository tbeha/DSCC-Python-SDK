...
class DeviceType4portISCSI(BaseModel):
    """
    DeviceType4portISCSI
    """ # noqa: E501
    delimited_mac_address: Optional[StrictStr] = Field(default=None, description="MAC address of the iSCSI port", alias="delimitedMacAddress")
    gateway_address: Optional[StrictStr] = Field(default=None, description="Gateway Address of iSCSI port", alias="gatewayAddress")
    gateway_address_v6: Optional[StrictStr] = Field(default=None, description="Gateway Address of iSCSI port.", alias="gatewayAddressV6")
    ...
    ip_address_v6: Optional[StrictStr] = Field(default=None, description="IPv6 address of iSCSI port.", alias="ipAddressV6")
    ...
    subnet_mask_v6: Optional[StrictStr] = Field(default=None, description="Netmask of iSCSI port.", alias="subnetMaskV6")
    ...
    __properties: ClassVar[List[str]] = ["delimitedMacAddress", "gatewayAddress", "gatewayAddressV6", "iSNSPrimaryAddress", "iSNSTcpPort", "ipAddress", "ipAddressV6", "iscsiName", "macAddress", "mtu", "sendTargetGroupTag", "subnetMask", "subnetMaskV6", "supportsVlan", "targetPortalGroupTag"]
