...
class CreateProtectionPolicyInputSchema(BaseModel):
    """
    ...
    schedules: Optional[List[PrimeraProtectionScheduleInputSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedules": [PrimeraProtectionScheduleInputSchema.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None
        })
        return _obj
