...
class CapacityInfoSolo(BaseModel):
    """
    Device capacity details
    """ # noqa: E501
    capacity_summary: Optional[CapacitySummary] = Field(default=None, alias="capacitySummary")
    __properties: ClassVar[List[str]] = ["capacitySummary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacitySummary": CapacitySummary.from_dict(obj["capacitySummary"]) if obj.get("capacitySummary") is not None else None
        })
        return _obj
