...
class DeviceType4softwareVersionsSoloComponentsInner(BaseModel):
    """
    DeviceType4softwareVersionsSoloComponentsInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["baseVersion", "fullVersion", "name", "release"]
