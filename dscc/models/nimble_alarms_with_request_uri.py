...
class NimbleAlarmsWithRequestUri(BaseModel):
    """
    NimbleAlarmsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed alarms object", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["ack_time", "activity", "alarm_type", "array", "category", "curr_onset_event_id", "id", "next_notification_time", "object_id", "object_name", "object_type", "onset_time", "remind_every", "remind_every_unit", "severity", "status", "user_full_name", "user_id", "user_name", "associated_links", "commonResourceAttributes", "consoleUri", "customerId", "generation", "resourceUri", "summary", "type"]
