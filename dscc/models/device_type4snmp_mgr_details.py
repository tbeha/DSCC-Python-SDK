...
class DeviceType4snmpMgrDetails(BaseModel):
    """
    ...
    snmp: Optional[DeviceType4snmpDetails] = None
    system_id: Optional[StrictStr] = Field(default=None, description="SystemId of the storage system", alias="systemId")
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "snmp", "systemId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snmp": DeviceType4snmpDetails.from_dict(obj["snmp"]) if obj.get("snmp") is not None else None,
