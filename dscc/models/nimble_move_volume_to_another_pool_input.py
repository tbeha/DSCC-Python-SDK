...
class NimbleMoveVolumeToAnotherPoolInput(BaseModel):
    """
    Input to move Nimble volume to another pool.
    """ # noqa: E501
    dest_pool_id: Optional[StrictStr] = Field(description="ID of the destination pool or folder. Specify a pool ID when the volumes should not be in a folder; otherwise, specify a folder ID and the pool will be derived from the folder. A 42 digit hexadecimal number")
    __properties: ClassVar[List[str]] = ["dest_pool_id"]
