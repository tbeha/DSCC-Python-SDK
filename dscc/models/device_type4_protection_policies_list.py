...
class DeviceType4ProtectionPoliciesList(BaseModel):
    """
    Response body for view protection policy
    """ # noqa: E501
    associated_links: Optional[List[DeviceType4ProtectionPoliciesListAssociatedLinksInner]] = Field(default=None, description="Associated Links", alias="associatedLinks")
    items: Optional[List[Optional[DeviceType4ProtectionPolicy]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestURI for Protection Policy for application set", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of protection policies for application set.")
    __properties: ClassVar[List[str]] = ["associatedLinks", "items", "pageLimit", "pageOffset", "requestUri", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associatedLinks": [DeviceType4ProtectionPoliciesListAssociatedLinksInner.from_dict(_item) for _item in obj["associatedLinks"]] if obj.get("associatedLinks") is not None else None,
            "items": [DeviceType4ProtectionPolicy.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
