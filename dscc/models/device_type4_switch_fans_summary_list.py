...
class DeviceType4SwitchFansSummaryList(BaseModel):
    """
    DeviceType4SwitchFansSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4SwitchFanList]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of switches")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4SwitchFanList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
