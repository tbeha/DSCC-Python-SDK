...
class DeviceType4EnclosuresSummaryList(BaseModel):
    """
    DeviceType4EnclosuresSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4enclosuresList]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosures object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosures")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosuresList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
