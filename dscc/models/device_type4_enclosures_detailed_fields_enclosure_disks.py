...
class DeviceType4EnclosuresDetailedFieldsEnclosureDisks(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsEnclosureDisks
    """ # noqa: E501
    items: Optional[List[DeviceType4enclosureDiskLists]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosureDisks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureDiskLists.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
