...
class CertificateDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "certType", "commonResourceAttributes", "commonname", "consoleUri", "customerId", "displayname", "domain", "enddate", "fingerprint", "generation", "id", "issuer", "pem", "requestUri", "serial", "service", "signaturetype", "startdate", "subject", "subjectaltname", "systemId", "text", "type", "uri"]
