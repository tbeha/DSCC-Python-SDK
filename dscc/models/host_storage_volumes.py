...
class HostStorageVolumes(BaseModel):
    """
    HostStorageVolumes
    """ # noqa: E501
    items: Optional[List[Optional[HostVolumes]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of volume count for the host.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [HostVolumes.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
