...
class LocalKeyManagerList(BaseModel):
    """
    LocalKeyManagerList
    """ # noqa: E501
    items: Optional[List[Optional[LocalKeyManager]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for local key manager", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of local key managers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [LocalKeyManager.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
