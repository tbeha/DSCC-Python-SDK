...
class NimbleFolderList(BaseModel):
    """
    NimbleFolderList
    """ # noqa: E501
    items: Optional[List[NimbleFolderListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for folder objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of folders.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleFolderListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
