...
class VasaServiceConfig(BaseModel):
    """
    VasaServiceConfig
    """ # noqa: E501
    cert_mgmt: Optional[StrictStr] = Field(default=None, description="Specify the cert mode for vasa provider, supports values either server or locked_client", alias="certMgmt")
