...
class NimbleErrorWithArguments(BaseModel):
    """
    NimbleErrorWithArguments
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Error code.")
    severity: Optional[StrictStr] = Field(default=None, description="Severity of the error. Possible values: 'warn', 'debug', 'error', 'fatal', 'info'.")
    text: Optional[StrictStr] = Field(default=None, description="Full error message with argument populated.")
    __properties: ClassVar[List[str]] = ["code", "severity", "text"]
