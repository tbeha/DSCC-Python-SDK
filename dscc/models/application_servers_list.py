...
class ApplicationServersList(BaseModel):
    """
    ApplicationServersList
    """ # noqa: E501
    items: Optional[List[Optional[ApplicationServer]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for application server objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of application servers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ApplicationServer.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
