...
class NimbleCreateFolderInput(BaseModel):
    """
    ...
    host_initiator_group_ids: Optional[List[StrictStr]] = Field(default=None, description="List of Host Initiator group IDs", alias="hostInitiatorGroupIDs")
    host_initiators_ids: Optional[List[StrictStr]] = Field(default=None, description="List of Host Initiator IDs", alias="hostInitiatorsIDs")
    ...
    pool_id: StrictStr = Field(description="ID of the pool where the folder resides.")
    ...
    __properties: ClassVar[List[str]] = ["access_protocol", "agent_type", "appserver_id", "description", "hostInitiatorGroupIDs", "hostInitiatorsIDs", "inherited_vol_perfpol_id", "limit_iops", "limit_mbps", "limit_size_bytes", "name", "overdraft_limit_pct", "pool_id", "provisioned_limit_size_bytes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if host_initiator_group_ids (nullable) is None
        # and model_fields_set contains the field
        if self.host_initiator_group_ids is None and "host_initiator_group_ids" in self.model_fields_set:
            _dict['hostInitiatorGroupIDs'] = None

        # set to None if host_initiators_ids (nullable) is None
        # and model_fields_set contains the field
        if self.host_initiators_ids is None and "host_initiators_ids" in self.model_fields_set:
            _dict['hostInitiatorsIDs'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostInitiatorGroupIDs": obj.get("hostInitiatorGroupIDs"),
            "hostInitiatorsIDs": obj.get("hostInitiatorsIDs"),
