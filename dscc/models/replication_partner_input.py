...
class ReplicationPartnerInput(BaseModel):
    """
    ...
    source: Optional[CreateRemoteCopyTargetInput]
    target: Optional[CreateRemoteCopyTargetInput]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": CreateRemoteCopyTargetInput.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": CreateRemoteCopyTargetInput.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
