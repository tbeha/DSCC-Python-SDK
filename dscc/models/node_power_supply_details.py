...
class NodePowerSupplyDetails(BaseModel):
    """
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed node power object", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "fanspeed", "fanstate", "generation", "id", "locateEnabled", "manufacturing", "name", "nodePowerId", "primaryNodeId", "requestUri", "resourceUri", "safeToRemove", "secondaryNodeId", "serviceLED", "state", "systemId", "type"]
