...
class Vlan(BaseModel):
    ...
    send_target_group_tag: Optional[StrictStr] = Field(default=None, description="The SendTargets Group Tag (STGT) for the iSCSI port", alias="sendTargetGroupTag")
    subnet_mask: Optional[StrictStr] = Field(default=None, description="VLAN Subnet mask for the iSCSI port", alias="subnetMask")
    target_portal_group_tag: Optional[StrictStr] = Field(default=None, description="The Target portal Group Tag (TPGT) for the iSCSI port", alias="targetPortalGroupTag")
    vlan_id: Optional[StrictStr] = Field(default=None, description="VLAN id for the iSCSI port", alias="vlanId")
    __properties: ClassVar[List[str]] = ["gatewayAddress", "iSNSPrimaryAddress", "iSNSTcpPort", "ipAddress", "mtu", "sendTargetGroupTag", "subnetMask", "targetPortalGroupTag", "vlanId"]
