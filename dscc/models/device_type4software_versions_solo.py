...
class DeviceType4softwareVersionsSolo(BaseModel):
    """
    ...
    components: Optional[List[Optional[DeviceType4softwareVersionsSoloComponentsInner]]] = None
    full_version: Optional[StrictStr] = Field(default=None, description="Full Version", alias="fullVersion")
    patches: Optional[StrictStr] = Field(default=None, description="Set of Patches")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [DeviceType4softwareVersionsSoloComponentsInner.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None,
