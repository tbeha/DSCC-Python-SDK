...
class RemoveCertificatesInput(BaseModel):
    """
    Request body for deleting the certificates
    """ # noqa: E501
    certificates: List[RemoveCertificateInput] = Field(description="List of certificate IDs to be deleted")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [RemoveCertificateInput.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None
        })
        return _obj
