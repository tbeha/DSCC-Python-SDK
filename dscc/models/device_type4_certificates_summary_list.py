...
class DeviceType4CertificatesSummaryList(BaseModel):
    """
    DeviceType4CertificatesSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4certificatesList]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed certificates object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of certificates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4certificatesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
