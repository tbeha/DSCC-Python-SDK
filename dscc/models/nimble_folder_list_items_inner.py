...
class NimbleFolderListItemsInner(BaseModel):
    """
    NimbleFolderListItemsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the folder. `Filter`")
    name: Optional[StrictStr] = Field(default=None, description="Name of the folder. `Filter, Sort`")
    pool_id: Optional[StrictStr] = Field(default=None, description="ID of the pool where the folder resides.`Filter, Sort`")
    pool_name: Optional[StrictStr] = Field(default=None, description="Name of the pool where the folder resides.`Filter, Sort`")
