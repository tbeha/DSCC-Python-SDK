...
class DeviceType4PortPositionInput(BaseModel):
    """
    ...
    port: StrictInt = Field(description="Port position port number")
    slot: StrictInt = Field(description="Port position slot number")
