...
class NimbleProtectionTemplateDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agent_username", "associated_links", "commonResourceAttributes", "consoleUri", "customerId", "description", "full_name", "generation", "repl_priority", "resourceUri", "schedule_list", "search_name", "type", "vcenter_username"]
