...
class NimblePinnedVolumeInfo(BaseModel):
    """
    NimblePinnedVolumeInfo
    """ # noqa: E501
    size_pinned_cache_bytes: Optional[StrictInt] = Field(default=None, description="Total pinned cache size of the volume in bytes.")
