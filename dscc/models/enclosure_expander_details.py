...
class EnclosureExpanderDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "domain", "elementStatusCode", "enclosureDeviceId", "enclosureExpanderId", "enclosureId", "enclosureName", "generation", "id", "name", "requestUri", "resourceUri", "systemId", "type"]
