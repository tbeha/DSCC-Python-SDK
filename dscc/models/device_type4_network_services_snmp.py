...
class DeviceType4NetworkServicesSnmp(BaseModel):
    """
    DeviceType4NetworkServicesSnmp
    """ # noqa: E501
    items: Optional[DeviceType4snmpMgrDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": DeviceType4snmpMgrDetails.from_dict(obj["items"]) if obj.get("items") is not None else None,
