...
class EditThrottle(BaseModel):
    """
    A single throttle for the partner.
    """ # noqa: E501
    days: Optional[StrictStr] = Field(default=None, description="Comma separated list of days of the week or 'all'.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the throttle.")
    thr_at_time: Optional[StrictInt] = Field(default=None, description="Start time for the throttle.")
    thr_bandwidth: Optional[StrictInt] = Field(default=None, description="Bandwidth for the throttle in megabits per second or as the largest possible 64-bit signed integer (9223372036854775807) to indicate that there is no limit. This attribute is superseded by thr_bandwidth_limit_kbps. Use either thr_bandwidth or thr_bandwidth_kbps to set throttle bandwidth.")
    thr_bandwidth_kbps: Optional[StrictInt] = Field(default=None, description="Bandwidth for the throttle in kilobits per second or as the largest possible 64-bit signed integer (9223372036854775807) to indicate that there is no limit. This atttibute is superseded by thr_bandwidth_limit_kbps. Use either thr_bandwidth or thr_bandwidth_kbps to set throttle bandwidth.")
    thr_bandwidth_limit_kbps: Optional[StrictInt] = Field(default=None, description="Bandwidth for the throttle in kilobits per second or -1 to indicate that there is no limit.")
    thr_until_time: Optional[StrictInt] = Field(default=None, description="End time for the throttle.")
    __properties: ClassVar[List[str]] = ["days", "description", "thr_at_time", "thr_bandwidth", "thr_bandwidth_kbps", "thr_bandwidth_limit_kbps", "thr_until_time"]
