...
class DeviceType4VolumeSetPut(BaseModel):
    """
    ...
    app_set_type: Optional[DeviceType4volumeSetApplicationTypePut] = Field(default=None, alias="appSetType")
    ...
    edit_app_set_qos_config_input: Optional[DeviceType4EditAppSetQosConfigInput] = Field(default=None, alias="editAppSetQosConfigInput")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editAppSetQosConfigInput": DeviceType4EditAppSetQosConfigInput.from_dict(obj["editAppSetQosConfigInput"]) if obj.get("editAppSetQosConfigInput") is not None else None,
