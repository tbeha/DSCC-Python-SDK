...
class DeviceType4StorageSystemList(BaseModel):
    """
    DeviceType4StorageSystemList
    """ # noqa: E501
    items: Optional[List[DeviceType4StorageSystemDetailList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4StorageSystemDetailList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
