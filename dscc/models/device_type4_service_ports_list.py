...
class DeviceType4ServicePortsList(BaseModel):
    """
    DeviceType4ServicePortsList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4servicePorts]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed volume set object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of serviceports.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4servicePorts.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
