...
class DeviceType4SystemLatencyFactorsLatencyBands(BaseModel):
    """
    DeviceType4SystemLatencyFactorsLatencyBands
    """ # noqa: E501
    read: Optional[List[Optional[DeviceType4SystemLatencyFactorsLatencyBandsReadInner]]] = None
    write: Optional[List[DeviceType4SystemLatencyFactorsLatencyBandsWriteInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": [DeviceType4SystemLatencyFactorsLatencyBandsReadInner.from_dict(_item) for _item in obj["read"]] if obj.get("read") is not None else None,
            "write": [DeviceType4SystemLatencyFactorsLatencyBandsWriteInner.from_dict(_item) for _item in obj["write"]] if obj.get("write") is not None else None
        })
        return _obj
