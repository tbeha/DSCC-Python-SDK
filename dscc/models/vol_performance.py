...
class VolPerformance(BaseModel):
    ...
    iops: Optional[NimbleKpiMetrics] = None
    latency: Optional[NimbleKpiMetrics] = None
    ...
    throughput: Optional[NimbleKpiMetrics] = None
    __properties: ClassVar[List[str]] = ["commonResourceAttributes", "iops", "latency", "requestURI", "resourceUri", "throughput"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iops": NimbleKpiMetrics.from_dict(obj["iops"]) if obj.get("iops") is not None else None,
            "latency": NimbleKpiMetrics.from_dict(obj["latency"]) if obj.get("latency") is not None else None,
            "requestURI": obj.get("requestURI"),
            "resourceUri": obj.get("resourceUri"),
            "throughput": NimbleKpiMetrics.from_dict(obj["throughput"]) if obj.get("throughput") is not None else None
        })
        return _obj
