...
class NimbleReplicationPartnerDetails(BaseModel):
    """
    NimbleReplicationPartnerDetails
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="RequestURI for detailed replication partner objects", alias="requestURI")
    array_serial: Optional[StrictStr] = Field(default=None, description="Serial number of group leader array of the partner. Plain string.")
    cfg_sync_status: Optional[StrictStr] = Field(default=None, description="Indicates whether all volumes and volume collections have been synced to the partner. Possible values: N/A, Yes, No. ")
    creation_time: Optional[StrictInt] = Field(default=None, description="Time when this replication partner was created. Seconds since last epoch i.e. 00:00 January 1, 1970.")
    folder_id: Optional[StrictStr] = Field(default=None, description="The Folder ID within the pool where volumes replicated from this partner will be created. This is not supported for pool partners. A 42 digit hexadecimal number. ")
    folder_name: Optional[StrictStr] = Field(default=None, description="The Folder name within the pool where volumes replicated from this partner will be created. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    hostname: Optional[StrictStr] = Field(default=None, description="IP address or hostname of partner interface. This must be the partners Group Management IP address. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for a replication partner. A 42 digit hexadecimal number.")
    is_alive: Optional[StrictBool] = Field(default=None, description="Whether the partner is available, and responding to pings. Possible values: true, false")
    name: Optional[StrictStr] = Field(default=None, description="Name of replication partner. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    partner_type: Optional[StrictStr] = Field(default=None, description="Type of the partner, Possible values: 'group' or 'pool'. ")
    paused: Optional[StrictBool] = Field(default=None, description="Indicates whether replication traffic from/to this partner has been halted. Possible values: true, false")
    pool_id: Optional[StrictStr] = Field(default=None, description="The pool ID where volumes replicated from this partner will be created. Replica volumes created as clones ignore this parameter and are always created in the same pool as their parent volume. A 42 digit hexadecimal number.")
    pool_name: Optional[StrictStr] = Field(default=None, description="The pool name where volumes replicated from this partner will be created. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    repl_hostname: Optional[StrictStr] = Field(default=None, description="IP address or hostname of partner data interface. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    subnet_label: Optional[StrictStr] = Field(default=None, description="Label of the subnet used to replicate to this partner. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    subnet_netmask: Optional[StrictStr] = Field(default=None, description="Subnet mask used to replicate to this partner. A netmask expressed as a 32 bit binary value must have the highest bit set (2^31) and the lowest bit clear (2^0) with the first zero followed by only zeros.")
    subnet_network: Optional[StrictStr] = Field(default=None, description="Subnet used to replicate to this partner. Four numbers in the range [0,255] separated by periods.")
    subnet_type: Optional[StrictStr] = Field(default=None, description="Type of the subnet used to replicate to this partner. Possible values: invalid, unconfigured, mgmt, data, mgmt_data")
    system_id: Optional[StrictStr] = Field(default=None, description="Identifier for a system or array. A 42 digit hexadecimal number.", alias="systemId")
    version: Optional[StrictInt] = Field(default=None, description="Replication version of the partner. Signed 64-bit integer.")
    volume_collection_list_count: Optional[StrictInt] = Field(default=None, description="Count of volume collections that are replicating from/to this partner. Unsigned 64-bit integer.")
