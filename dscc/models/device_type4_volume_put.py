...
class DeviceType4VolumePut(BaseModel):
    """
    ...
    size_mib: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Size of the volume to be edited.", alias="sizeMib")
