...
class DeviceType4NwCimEditCim(BaseModel):
    """
    ...
    http_state: Optional[StrictBool] = Field(default=None, description="Specifies whether HTTPState is enabled or disabled for CIM Server. Unsupported from version 10.4.0 and above", alias="httpState")
    https_state: Optional[StrictBool] = Field(default=None, description="Specifies whether HTTPS state is enabled or disabled for cim server. Unsupported from version 10.4.0 and above", alias="httpsState")
