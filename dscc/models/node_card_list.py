...
class NodeCardList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "displayname", "domain", "fwVersion", "generation", "id", "locateEnabled", "manufacturing", "name", "nodeCardType", "nodeDeviceId", "nodeId", "resourceUri", "revision", "safeToRemove", "serviceLed", "slot", "systemId", "type"]
