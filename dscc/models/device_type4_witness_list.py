...
class DeviceType4WitnessList(BaseModel):
    """
    DeviceType4WitnessList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4Witness]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="Request URI for quorum witness objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of witnesses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4Witness.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
