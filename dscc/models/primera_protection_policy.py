...
class PrimeraProtectionPolicy(BaseModel):
    """
    ...
    policy: Optional[PrimeraProtectionPolicyPolicy] = None
    ...
    schedules: Optional[PrimeraProtectionPolicySchedules] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy": PrimeraProtectionPolicyPolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "protectionPolicyType": obj.get("protectionPolicyType"),
            "schedules": PrimeraProtectionPolicySchedules.from_dict(obj["schedules"]) if obj.get("schedules") is not None else None,
            "type": obj.get("type")
        })
        return _obj
