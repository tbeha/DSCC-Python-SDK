...
class DeviceType4Vvolscs(BaseModel):
    """
    DeviceType4Vvolscs
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4vVolscDetails]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4vVolscDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
