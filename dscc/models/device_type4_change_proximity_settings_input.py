...
class DeviceType4ChangeProximitySettingsInput(BaseModel):
    """
    Request body to change proximity settings
    """ # noqa: E501
    hosts: List[DeviceType4HostProximityInput]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hosts": [DeviceType4HostProximityInput.from_dict(_item) for _item in obj["hosts"]] if obj.get("hosts") is not None else None
        })
        return _obj
