...
class DeviceType4SystemPerformance(BaseModel):
    """
    system performance statistics
    """ # noqa: E501
    customer_id: Optional[StrictStr] = Field(default=None, description="customerId", alias="customerId")
    iops: Optional[DeviceType4pmPerfData] = None
    latency: Optional[DeviceType4pmPerfData] = None
    ...
    throughput: Optional[DeviceType4pmPerfData] = None
    __properties: ClassVar[List[str]] = ["customerId", "iops", "latency", "requestUri", "resourceUri", "throughput"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iops": DeviceType4pmPerfData.from_dict(obj["iops"]) if obj.get("iops") is not None else None,
            "latency": DeviceType4pmPerfData.from_dict(obj["latency"]) if obj.get("latency") is not None else None,
            "requestUri": obj.get("requestUri"),
            "resourceUri": obj.get("resourceUri"),
            "throughput": DeviceType4pmPerfData.from_dict(obj["throughput"]) if obj.get("throughput") is not None else None
        })
        return _obj
