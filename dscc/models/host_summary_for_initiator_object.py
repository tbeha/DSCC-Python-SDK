...
class HostSummaryForInitiatorObject(BaseModel):
    """
    HostSummaryForInitiatorObject
    """ # noqa: E501
    host_groups: Optional[List[Optional[HostGroupSummaryObject]]] = Field(default=None, description="Host group to which the host belongs to.", alias="hostGroups")
    ...
    __properties: ClassVar[List[str]] = ["hostGroups", "id", "ipAddress", "isMergable", "isVvolHost", "markedForDelete", "name", "systems", "userCreated"]
