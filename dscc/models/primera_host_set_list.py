...
class PrimeraHostSetList(BaseModel):
    """
    List of primera Host Paths
    """ # noqa: E501
    items: Optional[List[PrimeraHostSetListObj]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PrimeraHostSetListObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
