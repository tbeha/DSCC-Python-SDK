...
class DeviceType4EnclosurePowerDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["acStatus", "associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosurePowerId", "enclosurePowerSupplyId", "enclosureType", "enclosureUid", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "requestUri", "resourceUri", "safeToRemove", "state", "systemId", "type"]
