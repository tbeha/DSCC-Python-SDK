...
class NimbleNetworkInterfacesDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["array_id", "array_name_or_serial", "associated_links", "commonResourceAttributes", "consoleUri", "controller_id", "controller_name", "customerId", "generation", "id", "ip_list", "is_present", "link_speed", "link_status", "mac", "max_link_speed", "mtu", "name", "nic_type", "port", "resourceUri", "slot", "type"]
