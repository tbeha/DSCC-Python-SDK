...
class VolumePerformanceHistory(BaseModel):
    """
    ...
    history_data: Optional[VolumePerformanceHistoryHistoryData] = Field(default=None, alias="historyData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "historyData": VolumePerformanceHistoryHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
