...
class NimblefibreChannelConfigsWithRequestUri(BaseModel):
    """
    NimblefibreChannelConfigsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed fibre channel configs object", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["group_leader_array", "id", "array_list", "associated_links", "commonResourceAttributes", "consoleUri", "controller_name", "customerId", "generation", "resourceUri", "type"]
