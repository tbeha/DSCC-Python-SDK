...
class NimbleDemoteVolumeCollectionsInput(BaseModel):
    """
    Perform demote action on a volume collection.
    """ # noqa: E501
    invoke_on_upstream_partner: Optional[StrictBool] = Field(default=None, description="Invoke demote request on upstream partner. Default: 'false'. Possible values: 'true', 'false'.")
    replication_partner_id: StrictStr = Field(description="Replication partner ID of the new owner. A 42 digit hexadecimal number.")
    __properties: ClassVar[List[str]] = ["invoke_on_upstream_partner", "replication_partner_id"]
