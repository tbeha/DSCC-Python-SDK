...
class DeviceType4EnclosureSledDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "dc4data", "diskCount", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "okIndicator", "portBypassA", "portBypassB", "power", "predFailIndicator", "protocol", "requestUri", "resourceUri", "safeToRemove", "sledId", "stateLoopA", "stateLoopB", "systemId", "temperature", "type", "wwn"]
