...
class DeviceType4Hosts(BaseModel):
    """
    HPE Alletra Storage MP Host details
    """ # noqa: E501
    agent: Optional[DeviceType4HostAgent] = None
    ...
    common_resource_attributes: Optional[CommonResourceAttributesDeviceType4Host] = Field(default=None, alias="commonResourceAttributes")
    descriptors: Optional[DeviceType4HostDescriptors] = None
    ...
    hostpaths: Optional[List[Optional[DeviceType4HostPathsForDeviceType4Host]]] = None
    id: Optional[StrictStr] = Field(default=None, description="Host Resource UID")
    ...
    persona: Optional[DeviceType4Persona] = None
    ...
    state: Optional[DeviceType4HostState] = None
    ...
    system_uid: Optional[StrictStr] = Field(default=None, description="Serial Number of the system", alias="systemUid")
    ...
    __properties: ClassVar[List[str]] = ["agent", "associatedLinks", "commonResourceAttributes", "descriptors", "displayname", "domain", "generation", "hostId", "hostpaths", "id", "initiatorChapEnabled", "initiatorChapName", "initiatorEncryptedChapSecret", "isVvolHost", "minLunId", "name", "persona", "resourceUri", "sc_HostId", "state", "stateDescription", "stateVal", "systemUid", "systemWWN", "targetChapEnabled", "targetChapName", "targetEncryptedChapSecret", "uaRepLun", "uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": DeviceType4HostAgent.from_dict(obj["agent"]) if obj.get("agent") is not None else None,
            ...
            "commonResourceAttributes": CommonResourceAttributesDeviceType4Host.from_dict(obj["commonResourceAttributes"]) if obj.get("commonResourceAttributes") is not None else None,
            "descriptors": DeviceType4HostDescriptors.from_dict(obj["descriptors"]) if obj.get("descriptors") is not None else None,
            "displayname": obj.get("displayname"),
            "domain": obj.get("domain"),
            "generation": obj.get("generation"),
            "hostId": obj.get("hostId"),
            "hostpaths": [DeviceType4HostPathsForDeviceType4Host.from_dict(_item) for _item in obj["hostpaths"]] if obj.get("hostpaths") is not None else None,
            "id": obj.get("id"),
            ...
            "name": obj.get("name"),
            "persona": DeviceType4Persona.from_dict(obj["persona"]) if obj.get("persona") is not None else None,
            "resourceUri": obj.get("resourceUri"),
            "sc_HostId": obj.get("sc_HostId"),
            "state": DeviceType4HostState.from_dict(obj["state"]) if obj.get("state") is not None else None,
