...
class DeviceType4SwitchList(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the resource. `Filter`")
    ...
    resource_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed switch object", alias="resourceUri")
    ...
    __properties: ClassVar[List[str]] = ["activeIPAddress", "associatedLinks", "commonResourceAttributes", "customerId", "dhcpServers", "displayname", "domain", "fanState", "fwVersion", "generation", "id", "locateEnabled", "macAddress", "manufacturing", "mode", "name", "primaryPath", "ps1State", "ps2State", "resourceUri", "secondaryPath", "state", "switchId", "systemId", "temperatureDetail", "temperatureState", "type", "vlans"]
