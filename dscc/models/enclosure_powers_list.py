...
class EnclosurePowersList(BaseModel):
    """
    EnclosurePowersList
    """ # noqa: E501
    ...
    resource_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure power object", alias="resourceUri")
    ...
    __properties: ClassVar[List[str]] = ["acStatus", "associatedLinks", "commonResourceAttributes", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosurePowerId", "enclosureType", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "resourceUri", "safeToRemove", "state", "systemId", "type"]
