...
class DeviceType4EnclosureConnectorsSummaryList(BaseModel):
    """
    DeviceType4EnclosureConnectorsSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4enclosureConnectorsList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure connectors object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="number of enclosure connetcors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureConnectorsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
