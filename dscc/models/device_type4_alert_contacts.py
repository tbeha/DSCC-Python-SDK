...
class DeviceType4AlertContacts(BaseModel):
    """
    ...
    items: Optional[List[Optional[DeviceType4AlertContactsDetails]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of contacts")
    __properties: ClassVar[List[str]] = ["associatedLinks", "items", "pageLimit", "pageOffset", "requestUri", "systemId", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DeviceType4AlertContactsDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
