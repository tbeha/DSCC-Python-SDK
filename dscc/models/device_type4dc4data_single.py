...
class DeviceType4dc4dataSingle(BaseModel):
    """
    DeviceType4dc4dataSingle
    """ # noqa: E501
    hpl_led: Optional[DeviceType4HPLLEDSINGLE] = Field(default=None, alias="hplLED")
    left: Optional[StrictBool] = None
    right: Optional[StrictBool] = None
    system_led: Optional[DeviceType4SYSTEMLEDSINGLE] = Field(default=None, alias="systemLED")
