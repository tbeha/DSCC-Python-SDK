...
class DeviceType4VolumesList(BaseModel):
    """
    DeviceType4VolumesList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4VolumeDetailsList]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4VolumeDetailsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
