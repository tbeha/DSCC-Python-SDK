...
class HostChapObject(BaseModel):
    """
    HostChapObject
    """ # noqa: E501
    ...
    initiator_chap_name: Optional[StrictStr] = Field(default=None, description="Name of initiator CHAP set on iSCSI host", alias="initiatorChapName")
    initiator_encrypted_chap_secret: Optional[StrictStr] = Field(default=None, description="Encrypted Initiator CHAP secret set on iSCSI host", alias="initiatorEncryptedChapSecret")
    ...
    target_chap_name: Optional[StrictStr] = Field(default=None, description="Name of target CHAP set on iSCSI host", alias="targetChapName")
    target_encrypted_chap_secret: Optional[StrictStr] = Field(default=None, description="Encrypted Target CHAP secret set on iSCSI host", alias="targetEncryptedChapSecret")
