...
class NimbleStorageSystemSummaryList(BaseModel):
    """
    NimbleStorageSystemSummaryList
    """ # noqa: E501
    items: Optional[List[NimbleStorageSystemSummaryListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for Nimble storage objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of systems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleStorageSystemSummaryListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
