...
class DeviceType4vcenterSettingDetailList(BaseModel):
    """
    ...
    friendly_cert: Optional[DeviceType4friendlyCert] = Field(default=None, alias="friendlyCert")
    ...
    status: Optional[DeviceType4vcenterStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "friendlyCert": DeviceType4friendlyCert.from_dict(obj["friendlyCert"]) if obj.get("friendlyCert") is not None else None,
            ...
            "status": DeviceType4vcenterStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
