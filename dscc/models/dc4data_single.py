...
class Dc4dataSingle(BaseModel):
    """
    Dc4dataSingle
    """ # noqa: E501
    hpl_led: Optional[HPLLEDSINGLE] = Field(default=None, alias="hplLED")
    left: Optional[StrictBool] = None
    right: Optional[StrictBool] = None
    system_led: Optional[SYSTEMLEDSINGLE] = Field(default=None, alias="systemLED")
