...
class DeviceType4systemSettingsDetailsSystemParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fcRawSpaceAlert", "maxVolumeRetention", "overprovRatioLimit", "overprovRatioWarning"]
