...
class DeviceType4softwareVersions(BaseModel):
    """
    ...
    components: Optional[List[Optional[DeviceType4softwareVersionsComponentsInner]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [DeviceType4softwareVersionsComponentsInner.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None,
