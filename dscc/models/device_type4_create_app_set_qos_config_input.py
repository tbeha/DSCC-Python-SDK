...
class DeviceType4CreateAppSetQosConfigInput(BaseModel):
    """
    ...
    enable_sr_alert: Optional[StrictBool] = Field(default=None, description="Sets the SR alert with the criterion name as the vvset name based on the max limits being set on the QoS parameters.", alias="enableSrAlert")
    ...
    __properties: ClassVar[List[str]] = ["bandwidthMaxLimitKiB", "enable", "enableSrAlert", "iopsMaxLimit", "perTb"]
