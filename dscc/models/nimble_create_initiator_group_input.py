...
class NimbleCreateInitiatorGroupInput(BaseModel):
    """
    Create Nimble intiator group input.
    """ # noqa: E501
    access_protocol: StrictStr = Field(description="Initiator group access protocol.")
    ...
    name: StrictStr = Field(description="Name of initiator group. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    target_subnets: Optional[List[Optional[NimbleTargetSubnets]]] = Field(default=None, description="List of target subnet labels. If specified, discovery and access to volumes will be restricted to")
    __properties: ClassVar[List[str]] = ["access_protocol", "app_uuid", "description", "fc_initiators", "fc_tdz_ports", "host_type", "iscsi_initiators", "metadata", "name", "target_subnets"]
