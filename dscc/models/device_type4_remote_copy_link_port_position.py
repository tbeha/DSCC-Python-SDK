...
class DeviceType4RemoteCopyLinkPortPosition(BaseModel):
    """
    DeviceType4RemoteCopyLinkPortPosition
    """ # noqa: E501
    node: Optional[StrictInt] = Field(default=None, description="Port position node number")
    port: Optional[StrictInt] = Field(default=None, description="Port position port number")
    slot: Optional[StrictInt] = Field(default=None, description="Port position slot number")
