...
class DeviceType4RcLinkPerformanceHistoryData(BaseModel):
    """
    ...
    history_data: Optional[DeviceType4RcLinkPerformanceHistoryDataHistoryData] = Field(default=None, alias="historyData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "historyData": DeviceType4RcLinkPerformanceHistoryDataHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
