...
class CreateCloneSnapshotInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["autoLun", "destinationCpg", "destinationSnapshotCpg", "destinationVolume", "hostGroupId", "lun", "priority"]
