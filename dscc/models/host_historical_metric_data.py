...
class HostHistoricalMetricData(BaseModel):
    """
    Timeseries data for particular metric type
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="count of series data")
    series_data: Optional[List[Optional[HostMetricSeriesData]]] = Field(default=None, alias="seriesData")
    __properties: ClassVar[List[str]] = ["count", "seriesData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "seriesData": [HostMetricSeriesData.from_dict(_item) for _item in obj["seriesData"]] if obj.get("seriesData") is not None else None
        })
        return _obj
