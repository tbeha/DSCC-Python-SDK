...
class PercentageBucketSetInner(BaseModel):
    """
    PercentageBucketSetInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the histogram bucket")
    percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average Percentage of I/O happened in size bucket throughout the interval")
