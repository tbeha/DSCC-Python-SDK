...
class DeviceType4HostPathList(BaseModel):
    """
    DeviceType4HostPathList
    """ # noqa: E501
    items: Optional[List[DeviceType4HostPathListObj]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for HPE Alletra Storage MP Hostpath objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of host paths.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4HostPathListObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
