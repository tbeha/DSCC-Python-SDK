...
class SystemHeadroom(BaseModel):
    """
    Headroom for the storage-system
    """ # noqa: E501
    performance: Optional[PerformanceHeadroom] = None
    __properties: ClassVar[List[str]] = ["performance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "performance": PerformanceHeadroom.from_dict(obj["performance"]) if obj.get("performance") is not None else None
        })
        return _obj
