...
class PrimeraHostPathList(BaseModel):
    """
    PrimeraHostPathList
    """ # noqa: E501
    items: Optional[List[PrimeraHostPathListObj]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for primera Hostpath objects", alias="requestUri")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PrimeraHostPathListObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
