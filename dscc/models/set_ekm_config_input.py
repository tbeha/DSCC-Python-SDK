...
class SetEKMConfigInput(BaseModel):
    """
    SetEKMConfigInput
    """ # noqa: E501
    parameters: Optional[SetEKMConfigParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": SetEKMConfigParams.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
