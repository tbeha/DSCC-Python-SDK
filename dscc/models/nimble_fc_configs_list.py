...
class NimbleFCConfigsList(BaseModel):
    """
    NimbleFCConfigsList
    """ # noqa: E501
    items: Optional[List[NimbleFCConfigsListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for  Fibre Channel Configs", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Fibre Channel Configs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleFCConfigsListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
