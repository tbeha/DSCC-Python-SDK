...
class NimbleHostReview(BaseModel):
    """
    host review
    """ # noqa: E501
    changes: Optional[NimbleChanges] = None
    initiators: Optional[List[Optional[NimbleInitiatorReview]]] = Field(default=None, description="list of initiator reviews")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    __properties: ClassVar[List[str]] = ["changes", "initiators", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": NimbleChanges.from_dict(obj["changes"]) if obj.get("changes") is not None else None,
            "initiators": [NimbleInitiatorReview.from_dict(_item) for _item in obj["initiators"]] if obj.get("initiators") is not None else None,
            "name": obj.get("name")
        })
        return _obj
