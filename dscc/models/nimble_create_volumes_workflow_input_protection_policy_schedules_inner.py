...
class NimbleCreateVolumesWorkflowInputProtectionPolicySchedulesInner(BaseModel):
    """
    ...
    start_time: Optional[StrictStr] = Field(default=None, description="start time", alias="startTime")
    __properties: ClassVar[List[str]] = ["lock_period", "name", "startTime"]
