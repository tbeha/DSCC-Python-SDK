...
class EnclosuresList(BaseModel):
    """
    EnclosuresList
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": ENCSTATE.from_dict(obj["state"]) if obj.get("state") is not None else None,
