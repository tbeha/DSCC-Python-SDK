...
class DeviceType4NodesSummaryList(BaseModel):
    """
    DeviceType4NodesSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4nodesList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of nodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4nodesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
