...
class VolumeSetHostGroupList(BaseModel):
    """
    ...
    hosts: Optional[List[VolumeSetHostProximityInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hosts": [VolumeSetHostProximityInfo.from_dict(_item) for _item in obj["hosts"]] if obj.get("hosts") is not None else None,
