...
class UnExportInput(BaseModel):
    """
    Nimble volume  UnExport input.
    """ # noqa: E501
    host_groups: Optional[List[UnExportInputHostGroupsInner]] = Field(default=None, description="list of host_groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "host_groups": [UnExportInputHostGroupsInner.from_dict(_item) for _item in obj["host_groups"]] if obj.get("host_groups") is not None else None
        })
        return _obj
