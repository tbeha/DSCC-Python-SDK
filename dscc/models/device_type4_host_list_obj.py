...
class DeviceType4HostListObj(BaseModel):
    """
    ...
    hostpaths: Optional[List[Optional[DeviceType4HostPathDetailsForDeviceType4Host]]] = None
    ...
    sc_host_id: Optional[StrictStr] = Field(default=None, description="Host Service Host Id `Filter`", alias="sc_HostId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostpaths": [DeviceType4HostPathDetailsForDeviceType4Host.from_dict(_item) for _item in obj["hostpaths"]] if obj.get("hostpaths") is not None else None,
            "id": obj.get("id"),
