...
class DeviceType4HostList(BaseModel):
    """
    List of HPE Alletra Storage MP Host Paths
    """ # noqa: E501
    items: Optional[List[DeviceType4HostListObj]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of Hosts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4HostListObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
