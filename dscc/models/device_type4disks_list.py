...
class DeviceType4disksList(BaseModel):
    """
    ...
    capacity: Optional[DeviceType4filterDiskCapacity] = None
    ...
    position_now: Optional[DeviceType4filterDiskPositionNow] = Field(default=None, alias="positionNow")
    ...
    wwn: Optional[StrictStr] = Field(default=None, description="unique WWN of the disk. `Filter, Sort`")
    __properties: ClassVar[List[str]] = ["admitTime", "associatedLinks", "capacity", "commonResourceAttributes", "consumableSizeMiB", "customerId", "devType", "diskId", "displayname", "domain", "enclosureUid", "fwStatus", "fwVersion", "generation", "id", "insertTime", "lifeLeftPCT", "manufacturing", "mediaType", "mfgCapacityGB", "paths", "positionLast", "positionNow", "protocol", "rawSizeMiB", "readErrors", "resourceUri", "sedStatus", "state", "systemId", "type", "writeErrors", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capacity": DeviceType4filterDiskCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            ...
            "positionNow": DeviceType4filterDiskPositionNow.from_dict(obj["positionNow"]) if obj.get("positionNow") is not None else None,
