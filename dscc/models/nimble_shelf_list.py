...
class NimbleShelfList(BaseModel):
    """
    NimbleShelfList
    """ # noqa: E501
    items: Optional[List[NimbleShelfListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for shelf objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of shelves.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleShelfListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
