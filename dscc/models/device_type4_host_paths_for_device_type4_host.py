...
class DeviceType4HostPathsForDeviceType4Host(BaseModel):
    """
    DeviceType4HostPathsForDeviceType4Host
    """ # noqa: E501
    ip_addr: Optional[StrictStr] = Field(default=None, description="Ip Address", alias="IPAddr")
    address: Optional[StrictStr] = Field(default=None, description="WWN Address of the Host Path")
    ...
    id: Optional[StrictStr] = Field(default=None, description="HostPath Resource UID")
    model: Optional[StrictStr] = Field(default=None, description="Host Model")
    path_type: Optional[StrictStr] = Field(default=None, description="Path Type", alias="pathType")
    ...
    system_uid: Optional[StrictStr] = Field(default=None, description="System Uid", alias="systemUid")
    system_wwn: Optional[StrictStr] = Field(default=None, description="System serial Number   ", alias="systemWWN")
    uri: Optional[StrictStr] = Field(default=None, description="Uri ")
    vendor: Optional[StrictStr] = Field(default=None, description="Vendor")
    __properties: ClassVar[List[str]] = ["IPAddr", "address", "associatedLinks", "displayname", "domain", "driverVersion", "firmwareVersion", "generation", "hostId", "hostName", "hostSpeed", "id", "model", "pathType", "portPos", "resourceUri", "sc_HostInitiatorId", "switchPortWWN", "systemUid", "systemWWN", "uri", "vendor"]
