...
class DeviceType4CreateProtectionPolicyInputSchema(BaseModel):
    """
    ...
    schedules: Optional[List[DeviceType4ProtectionScheduleInputSchema]] = None
    __properties: ClassVar[List[str]] = ["policy", "protectionPolicyType", "schedules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedules": [DeviceType4ProtectionScheduleInputSchema.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None
        })
        return _obj
