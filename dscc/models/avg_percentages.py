...
class AvgPercentages(BaseModel):
    """
    Average percentage of performance histogram
    """ # noqa: E501
    read: Optional[List[Optional[PercentageBucketSetInner]]] = Field(default=None, description="List of histogram size buckets and respective average percentage of I/O throughout the interval")
    write: Optional[List[Optional[PercentageBucketSetInner]]] = Field(default=None, description="List of histogram size buckets and respective average percentage of I/O throughout the interval")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": [PercentageBucketSetInner.from_dict(_item) for _item in obj["read"]] if obj.get("read") is not None else None,
            "write": [PercentageBucketSetInner.from_dict(_item) for _item in obj["write"]] if obj.get("write") is not None else None
        })
        return _obj
