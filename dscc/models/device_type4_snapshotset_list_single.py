...
class DeviceType4SnapshotsetListSingle(BaseModel):
    """
    DeviceType4SnapshotsetListSingle
    """ # noqa: E501
    mode: Optional[StrictStr] = Field(default=None, description="Mode of the snapset.", alias="Mode")
    ...
    __properties: ClassVar[List[str]] = ["Mode", "appSetBusinessUnit", "appSetComments", "appSetImportance", "appSetName", "appSetType", "comment", "commonResourceAttributes", "creationTime", "customerId", "displayName", "domain", "exportStatus", "generation", "id", "kvPairsPresent", "members", "name", "requestUri", "serialNumber", "snapSetId", "snapSetParentId", "snapSetParentName", "systemId", "type", "vvSetType"]
