...
class NimbleFCConfigsListItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "array_list", "associated_links", "commonResourceAttributes", "consoleUri", "controller_name", "customerId", "generation", "group_leader_array", "resourceUri", "type"]
