...
class HostGroupObject(BaseModel):
    """
    HostGroupObject
    """ # noqa: E501
    ...
    associated_systems: Optional[List[StrictStr]] = Field(default=None, description="system IDs to which the host group belongs to.", alias="associatedSystems")
    ...
    hosts: Optional[List[HostSummaryForHSObject]] = Field(default=None, description="List of hosts. `Filter` by hostId.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for host group. `Filter`")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the host group. `Filter, Sort`")
    systems: Optional[List[StrictStr]] = Field(default=None, description="system IDs to which the host group belongs to. `Filter`")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hosts": [HostSummaryForHSObject.from_dict(_item) for _item in obj["hosts"]] if obj.get("hosts") is not None else None,
            "id": obj.get("id"),
