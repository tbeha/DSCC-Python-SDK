...
class NimbleFCSessionList(BaseModel):
    """
    NimbleFCSessionList
    """ # noqa: E501
    items: Optional[List[NimbleFCSessionListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for Fibre Channel Session objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Fibre Channel Sessions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleFCSessionListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
