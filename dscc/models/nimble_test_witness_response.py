...
class NimbleTestWitnessResponse(BaseModel):
    """
    NimbleTestWitnessResponse
    """ # noqa: E501
    response: List[Optional[WitnessTestResponse]] = Field(description="Test Witness Response.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [WitnessTestResponse.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
