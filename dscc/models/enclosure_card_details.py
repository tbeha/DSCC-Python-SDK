...
class EnclosureCardDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "dc4data", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "loopA", "loopB", "manufacturing", "name", "requestUri", "resourceUri", "safeToRemove", "systemId", "type"]
