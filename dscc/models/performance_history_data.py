...
class PerformanceHistoryData(BaseModel):
    """
    performance trends for given granularity and time range for a component
    """ # noqa: E501
    common_resource_attributes: Optional[CommonResourceAttributesPerfPrimera] = Field(default=None, alias="commonResourceAttributes")
    customer_id: Optional[StrictStr] = Field(default=None, description="customerId", alias="customerId")
    end_time: Optional[StrictInt] = Field(default=None, description="end time of history data", alias="endTime")
    history_data: Optional[PerformanceHistoryDataHistoryData] = Field(default=None, alias="historyData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commonResourceAttributes": CommonResourceAttributesPerfPrimera.from_dict(obj["commonResourceAttributes"]) if obj.get("commonResourceAttributes") is not None else None,
            "customerId": obj.get("customerId"),
            "endTime": obj.get("endTime"),
            "historyData": PerformanceHistoryDataHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
