...
class SnapshotFromVolume(BaseModel):
    """
    Snapshots as presented to volumes in volume-sets
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of snapshot.")
    ...
    snap_name: Optional[StrictStr] = Field(default=None, description="Snapshot name.")
    __properties: ClassVar[List[str]] = ["id", "name", "snap_id", "snap_name"]
