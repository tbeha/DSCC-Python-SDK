...
class NimbleUninitializedArrayResponse(BaseModel):
    """
    NimbleUninitializedArrayResponse
    """ # noqa: E501
    items: Optional[List[Optional[UninitializedArrayResponse]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of Uninitialized array.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [UninitializedArrayResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
