...
class DeviceType4ReplicationPartnersList(BaseModel):
    """
    DeviceType4ReplicationPartnersList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4ReplicationPartners]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for replication partner objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of replication partners.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4ReplicationPartners.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
