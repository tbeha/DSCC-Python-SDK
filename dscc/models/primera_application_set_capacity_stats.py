...
class PrimeraApplicationSetCapacityStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "capacitySummary", "customerId", "id", "members", "name", "requestUri", "systemId"]
