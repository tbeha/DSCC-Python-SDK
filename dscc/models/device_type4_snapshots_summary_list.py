...
class DeviceType4SnapshotsSummaryList(BaseModel):
    """
    DeviceType4SnapshotsSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4snapshotsList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4snapshotsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
