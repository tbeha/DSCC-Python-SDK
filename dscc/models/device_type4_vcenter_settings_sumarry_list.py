...
class DeviceType4VcenterSettingsSumarryList(BaseModel):
    """
    DeviceType4VcenterSettingsSumarryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4vcenterSettingDetailList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for vcenter settings per system", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of vcenters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4vcenterSettingDetailList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
