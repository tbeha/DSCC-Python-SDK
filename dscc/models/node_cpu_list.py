...
class NodeCpuList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "busSpeed", "commonResourceAttributes", "customerId", "displayname", "domain", "family", "generation", "id", "manufacturing", "name", "nodeCpuId", "nodeDeviceId", "nodeId", "resourceUri", "speed", "stepping", "systemId", "type"]
