...
class DeviceType4ApplicationSetCapacityStatsCapacitySummary(BaseModel):
    """
    Capacity of the applicationSet
    """ # noqa: E501
    free_size_mi_b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Free Size in MiB", alias="freeSizeMiB")
    size_mi_b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total size in MiB", alias="sizeMiB")
    used_size_mi_b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Used Size in MiB.", alias="usedSizeMiB")
    __properties: ClassVar[List[str]] = ["freeSizeMiB", "sizeMiB", "usedSizeMiB"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if free_size_mi_b (nullable) is None
        # and model_fields_set contains the field
        if self.free_size_mi_b is None and "free_size_mi_b" in self.model_fields_set:
            _dict['freeSizeMiB'] = None
