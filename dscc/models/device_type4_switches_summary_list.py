...
class DeviceType4SwitchesSummaryList(BaseModel):
    """
    DeviceType4SwitchesSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4SwitchList]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4SwitchList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
