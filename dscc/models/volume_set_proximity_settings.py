...
class VolumeSetProximitySettings(BaseModel):
    """
    VolumeSetProximitySettings
    """ # noqa: E501
    items: Optional[List[VolumeSetHostGroupList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [VolumeSetHostGroupList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
