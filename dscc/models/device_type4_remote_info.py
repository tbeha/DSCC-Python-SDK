...
class DeviceType4RemoteInfo(BaseModel):
    """
    ...
    replication_type: Optional[StrictStr] = Field(default=None, description="Mode of replication. Can be sync or periodic", alias="replicationType")
    ...
    __properties: ClassVar[List[str]] = ["customerId", "isRemoteArraySupportReplication", "overPeriodAlert", "partnerId", "partnerName", "replicationPartnerSnapshotCpg", "replicationPartnerUserCpg", "replicationType", "resourceUri"]
