...
class NimbleAlarmsDetails(BaseModel):
    """
    NimbleAlarmsDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["activity", "alarm_type", "associated_links", "commonResourceAttributes", "consoleUri", "customerId", "generation", "resourceUri", "summary", "type"]
