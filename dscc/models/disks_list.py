...
class DisksList(BaseModel):
    ...
    capacity: Optional[FilterDiskCapacity] = None
    ...
    position_now: Optional[FilterDiskPositionNow] = Field(default=None, alias="positionNow")
    ...
    __properties: ClassVar[List[str]] = ["admitTime", "associatedLinks", "capacity", "commonResourceAttributes", "consumableSizeMiB", "customerId", "devType", "diskId", "displayname", "domain", "fwStatus", "fwVersion", "generation", "id", "lifeLeftPCT", "loopA0", "loopA1", "loopB0", "loopB1", "manufacturing", "mediaType", "mfgCapacityGB", "positionLast", "positionNow", "protocol", "rawSizeMiB", "readErrors", "resourceUri", "sedStatus", "speed", "state", "systemId", "tempMax", "tempMin", "tempNow", "type", "writeErrors", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capacity": FilterDiskCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            ...
            "positionNow": FilterDiskPositionNow.from_dict(obj["positionNow"]) if obj.get("positionNow") is not None else None,
