...
class HostAgent(BaseModel):
    ...
    last_updated: Optional[HostAgentLastUpdated] = Field(default=None, alias="lastUpdated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastUpdated": HostAgentLastUpdated.from_dict(obj["lastUpdated"]) if obj.get("lastUpdated") is not None else None,
