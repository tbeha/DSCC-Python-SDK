...
class CreateVolumeInput(BaseModel):
    ...
    size_mib: StrictInt = Field(description="Size in MB", alias="sizeMib")
    snap_cpg: Optional[StrictStr] = Field(default=None, description="Snap CPG", alias="snapCpg")
    ...
    user_cpg: StrictStr = Field(description="User CPG of the volume to be created", alias="userCpg")
    __properties: ClassVar[List[str]] = ["comments", "count", "dataReduction", "name", "sizeMib", "snapCpg", "snapshotAllocWarning", "userAllocWarning", "userCpg"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if snap_cpg (nullable) is None
        # and model_fields_set contains the field
        if self.snap_cpg is None and "snap_cpg" in self.model_fields_set:
            _dict['snapCpg'] = None
