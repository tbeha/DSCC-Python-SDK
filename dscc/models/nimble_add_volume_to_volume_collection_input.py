...
class NimbleAddVolumeToVolumeCollectionInput(BaseModel):
    """
    Add volume to volume collection input.
    """ # noqa: E501
    volume_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Volume ids that need to be added to volume collections.")
