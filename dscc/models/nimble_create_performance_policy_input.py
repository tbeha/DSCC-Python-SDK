...
class NimbleCreatePerformancePolicyInput(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the Performance Policy. String of up to 64 alphanumeric characters, - and . and : and space are allowed after first character.")
    ...
    __properties: ClassVar[List[str]] = ["app_category", "block_size", "cache", "cache_policy", "compress", "dedupe_enabled", "description", "name", "space_policy"]
