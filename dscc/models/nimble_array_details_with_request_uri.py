...
class NimbleArrayDetailsWithRequestUri(BaseModel):
    """
    ...
    brand: Optional[StrictStr] = Field(default=None, description="Brand of the array. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    ...
    oem: Optional[StrictStr] = Field(default=None, description="OEM brand of the array. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if oem (nullable) is None
        # and model_fields_set contains the field
        if self.oem is None and "oem" in self.model_fields_set:
            _dict['oem'] = None
