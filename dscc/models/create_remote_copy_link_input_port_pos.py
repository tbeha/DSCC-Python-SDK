...
class CreateRemoteCopyLinkInputPortPos(BaseModel):
    """
    ...
    """ # noqa: E501
    node: StrictInt = Field(description="Port position node number")
    port: Optional[StrictInt] = Field(description="Port position port number")
    slot: Optional[StrictInt] = Field(description="Port position slot number")
