...
class NimbleKpiMetrics(BaseModel):
    """
    kpi metrics with read, write and total average values
    """ # noqa: E501
    read: Optional[NimbleperfData] = None
    total: Optional[NimbleperfData] = None
    write: Optional[NimbleperfData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": NimbleperfData.from_dict(obj["read"]) if obj.get("read") is not None else None,
            "total": NimbleperfData.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "write": NimbleperfData.from_dict(obj["write"]) if obj.get("write") is not None else None
        })
        return _obj
