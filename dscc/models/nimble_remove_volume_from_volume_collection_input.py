...
class NimbleRemoveVolumeFromVolumeCollectionInput(BaseModel):
    """
    Remove volume from volume collection input.
    """ # noqa: E501
    volume_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Volume ids that need to be remove from volume collections.")
