...
class DeviceType4NodeDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "enclosureCardId", "enclosureCardUid", "enclosureId", "enclosureUid", "generation", "id", "inCluster", "kernelVersion", "master", "memoryMiB", "name", "online", "requestUri", "resourceUri", "safeToRemove", "state", "systemId", "type", "uptime"]
