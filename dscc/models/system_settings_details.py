...
class SystemSettingsDetails(BaseModel):
    """
    ...
    srinfo: Optional[SystemSettingsDetailsSrinfo] = None
    supportcontact: Optional[ContactsDetails] = None
    ...
    system_parameters: Optional[SystemSettingsDetailsSystemParameters] = Field(default=None, alias="systemParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "srinfo": SystemSettingsDetailsSrinfo.from_dict(obj["srinfo"]) if obj.get("srinfo") is not None else None,
            "supportcontact": ContactsDetails.from_dict(obj["supportcontact"]) if obj.get("supportcontact") is not None else None,
            "systemDate": obj.get("systemDate"),
            "systemId": obj.get("systemId"),
            "systemParameters": SystemSettingsDetailsSystemParameters.from_dict(obj["systemParameters"]) if obj.get("systemParameters") is not None else None,
