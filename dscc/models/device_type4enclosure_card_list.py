...
class DeviceType4enclosureCardList(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "isNodeCard", "locateEnabled", "locateSevenSegDisplay", "loopA", "loopB", "manufacturing", "name", "resourceUri", "safeToRemove", "sevenSegDisplay", "state", "systemId", "type"]
