...
class DeviceType4PortDetails(BaseModel):
    """
    ...
    enclosure_card_pcid: Optional[StrictInt] = Field(default=None, description="ID of the enclosure card PCI card", alias="enclosureCardPCId")
    ...
    partner: Optional[DeviceType4partnerPort] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "cardType", "class", "class2", "commonResourceAttributes", "config", "configMode", "connectionType", "consoleUri", "customerId", "devices", "displayname", "domain", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardPCId", "enclosureCardUid", "enclosureId", "enclosureUid", "failoverStatus", "fcData", "fwVersion", "generation", "id", "initiatorPorts", "interruptCoalesce", "ipData", "iscsiData", "label", "manufacturing", "mode", "modeChange", "name", "nodeCardId", "nodeId", "nvmeData", "partner", "portSfp", "portType", "position", "protocol", "requestUri", "resourceUri", "revision", "smartSAN", "speedActual", "speedConfigured", "speedMax", "speedMin", "state", "stateDescription", "systemId", "tgtModeWriteOpt", "type", "uniqueWWN", "virtualPorts", "vlans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partner": DeviceType4partnerPort.from_dict(obj["partner"]) if obj.get("partner") is not None else None,
