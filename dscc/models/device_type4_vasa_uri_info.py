...
class DeviceType4VasaUriInfo(BaseModel):
    """
    List of VASA Service URLs
    """ # noqa: E501
    is_valid: Optional[StrictInt] = Field(default=None, description="Specifies whether VASA Service URL is valid or not", alias="isValid")
    uri: Optional[StrictStr] = Field(default=None, description="VASA Service URL")
    __properties: ClassVar[List[str]] = ["isValid", "uri"]
