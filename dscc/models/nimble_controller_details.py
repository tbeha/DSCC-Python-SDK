...
class NimbleControllerDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associated_links", "asup_time", "commonResourceAttributes", "consoleUri", "ctrlr_side", "customerId", "fan_status", "fans", "generation", "hostname", "nvme_cards", "nvme_cards_enabled", "partial_response_ok", "partition_status", "power_status", "power_supplies", "resourceUri", "state", "support_address", "support_netmask", "support_nic", "temperature_sensors", "temperature_status", "type", "update_end_time", "update_error_code", "update_progress_msg", "update_start_time", "update_state", "version_current", "version_rollback", "version_target"]
