...
class DeviceType4EnclosuresDetailedFields(BaseModel):
    """
    ...
    dcsdata: Optional[DeviceType4encDcsdata] = None
    detailed_state: Optional[StrictStr] = Field(default=None, alias="detailedState")
    disks: Optional[DeviceType4EnclosuresDetailedFieldsDisks] = None
    ...
    enclosure_cards: Optional[DeviceType4EnclosuresDetailedFieldsEnclosureCards] = Field(default=None, alias="enclosureCards")
    enclosure_cdms: Optional[DeviceType4EnclosuresDetailedFieldsEnclosureCdms] = Field(default=None, alias="enclosureCdms")
    enclosure_disks: Optional[DeviceType4EnclosuresDetailedFieldsEnclosureDisks] = Field(default=None, alias="enclosureDisks")
    enclosure_id: Optional[StrictInt] = Field(default=None, description="Numeric ID of the resource", alias="enclosureId")
    enclosure_power_supplies: Optional[DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies] = Field(default=None, alias="enclosurePowerSupplies")
    enclosure_sleds: Optional[DeviceType4EnclosuresDetailedFieldsEnclosureSleds] = Field(default=None, alias="enclosureSleds")
    ...
    nodes: Optional[DeviceType4EnclosuresDetailedFieldsNodes] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "chainPosLoopA", "chainPosLoopB", "commonResourceAttributes", "consoleUri", "customerId", "dcsdata", "detailedState", "disks", "displayname", "domain", "enclosureCards", "enclosureCdms", "enclosureDisks", "enclosureId", "enclosurePowerSupplies", "enclosureSleds", "enclosureType", "errors", "failIndicator", "failRequested", "formFactor", "generation", "id", "locateEnabled", "location", "loopSplit", "manufacturing", "name", "nodeWwn", "nodes", "requestUri", "resourceUri", "state", "subType", "systemId", "type", "warnIndicator", "warnRequested"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of enclosure_cards
        if self.enclosure_cards:
            _dict['enclosureCards'] = self.enclosure_cards.to_dict()
        # override the default output from pydantic by calling `to_dict()` of enclosure_cdms
        if self.enclosure_cdms:
            _dict['enclosureCdms'] = self.enclosure_cdms.to_dict()
        # override the default output from pydantic by calling `to_dict()` of enclosure_disks
        if self.enclosure_disks:
            _dict['enclosureDisks'] = self.enclosure_disks.to_dict()
        # override the default output from pydantic by calling `to_dict()` of enclosure_power_supplies
        if self.enclosure_power_supplies:
            _dict['enclosurePowerSupplies'] = self.enclosure_power_supplies.to_dict()
        # override the default output from pydantic by calling `to_dict()` of enclosure_sleds
        if self.enclosure_sleds:
            _dict['enclosureSleds'] = self.enclosure_sleds.to_dict()
        ...
        # set to None if enclosure_cards (nullable) is None
        # and model_fields_set contains the field
        if self.enclosure_cards is None and "enclosure_cards" in self.model_fields_set:
            _dict['enclosureCards'] = None

        # set to None if enclosure_cdms (nullable) is None
        # and model_fields_set contains the field
        if self.enclosure_cdms is None and "enclosure_cdms" in self.model_fields_set:
            _dict['enclosureCdms'] = None

        # set to None if enclosure_disks (nullable) is None
        # and model_fields_set contains the field
        if self.enclosure_disks is None and "enclosure_disks" in self.model_fields_set:
            _dict['enclosureDisks'] = None
        ...
        # set to None if enclosure_power_supplies (nullable) is None
        # and model_fields_set contains the field
        if self.enclosure_power_supplies is None and "enclosure_power_supplies" in self.model_fields_set:
            _dict['enclosurePowerSupplies'] = None

        # set to None if enclosure_sleds (nullable) is None
        # and model_fields_set contains the field
        if self.enclosure_sleds is None and "enclosure_sleds" in self.model_fields_set:
            _dict['enclosureSleds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dcsdata": DeviceType4encDcsdata.from_dict(obj["dcsdata"]) if obj.get("dcsdata") is not None else None,
            "detailedState": obj.get("detailedState"),
            "disks": DeviceType4EnclosuresDetailedFieldsDisks.from_dict(obj["disks"]) if obj.get("disks") is not None else None,
            "displayname": obj.get("displayname"),
            "domain": obj.get("domain"),
            "enclosureCards": DeviceType4EnclosuresDetailedFieldsEnclosureCards.from_dict(obj["enclosureCards"]) if obj.get("enclosureCards") is not None else None,
            "enclosureCdms": DeviceType4EnclosuresDetailedFieldsEnclosureCdms.from_dict(obj["enclosureCdms"]) if obj.get("enclosureCdms") is not None else None,
            "enclosureDisks": DeviceType4EnclosuresDetailedFieldsEnclosureDisks.from_dict(obj["enclosureDisks"]) if obj.get("enclosureDisks") is not None else None,
            "enclosureId": obj.get("enclosureId"),
            "enclosurePowerSupplies": DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies.from_dict(obj["enclosurePowerSupplies"]) if obj.get("enclosurePowerSupplies") is not None else None,
            "enclosureSleds": DeviceType4EnclosuresDetailedFieldsEnclosureSleds.from_dict(obj["enclosureSleds"]) if obj.get("enclosureSleds") is not None else None,
            ...
            "nodes": DeviceType4EnclosuresDetailedFieldsNodes.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
