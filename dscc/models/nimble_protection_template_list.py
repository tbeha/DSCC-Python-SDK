...
class NimbleProtectionTemplateList(BaseModel):
    """
    NimbleProtectionTemplateList
    """ # noqa: E501
    items: Optional[List[NimbleProtectionTemplateListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for Protection Template objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Protection Templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleProtectionTemplateListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
