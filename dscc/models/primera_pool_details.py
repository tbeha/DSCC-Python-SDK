...
class PrimeraPoolDetails(BaseModel):
    """
    PrimeraPoolDetails
    """ # noqa: E501
    alert: Optional[CpgAlert] = None
    allocation_settings: Optional[Allocation] = Field(default=None, alias="allocationSettings")
    ...
    base_size_mi_b: Optional[StrictInt] = Field(default=None, description="Number of LD MiB used in base virtual volumes", alias="baseSizeMiB")
    ...
    dedup_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ratio between the amount of data written to Dedup Volumes and the amount that is not duplicated. Updated in Cloud Data Store at most once per 30 minutes.", alias="dedupRatio")
    ...
    free_size_mi_b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of LD MiB allocated and available in the CPG. Updated in Cloud Data Store at most once per 30 minutes.", alias="freeSizeMiB")
    ...
    sa_grow: Optional[CpgGrow] = Field(default=None, alias="saGrow")
    sd_grow: Optional[CpgGrow] = Field(default=None, alias="sdGrow")
    ...
    snap_space_admin: Optional[SnapSpace] = Field(default=None, alias="snapSpaceAdmin")
    snap_space_data: Optional[SnapSpace] = Field(default=None, alias="snapSpaceData")
    state: Optional[State] = None
    storage_pool_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Numeric ID of the resource", alias="storagePoolId")
    ...
    total_size_mi_b: Optional[StrictInt] = Field(default=None, description="Total logical capacity in the user/snapshot space (MiB)", alias="totalSizeMiB")
    ...
    user_space: Optional[SnapSpace] = Field(default=None, alias="userSpace")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alert": CpgAlert.from_dict(obj["alert"]) if obj.get("alert") is not None else None,
            "allocationSettings": Allocation.from_dict(obj["allocationSettings"]) if obj.get("allocationSettings") is not None else None,
            ...
            "saGrow": CpgGrow.from_dict(obj["saGrow"]) if obj.get("saGrow") is not None else None,
            "sdGrow": CpgGrow.from_dict(obj["sdGrow"]) if obj.get("sdGrow") is not None else None,
            "sharedSizeMiB": obj.get("sharedSizeMiB"),
            "snapSizePrivateMiB": obj.get("snapSizePrivateMiB"),
            "snapSizeRawMiB": obj.get("snapSizeRawMiB"),
            "snapSpaceAdmin": SnapSpace.from_dict(obj["snapSpaceAdmin"]) if obj.get("snapSpaceAdmin") is not None else None,
            "snapSpaceData": SnapSpace.from_dict(obj["snapSpaceData"]) if obj.get("snapSpaceData") is not None else None,
            ...
            "type": obj.get("type"),
            "userSpace": SnapSpace.from_dict(obj["userSpace"]) if obj.get("userSpace") is not None else None,
