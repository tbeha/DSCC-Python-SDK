...
class EditTargetPartner(BaseModel):
    """
    Target partner.
    """ # noqa: E501
    hostname: Optional[StrictStr] = Field(default=None, description="IP address or hostname of partner interface. This must be the partner's Group Management IP address. String of up to 64 alphanumeric characters, - and . and colon are allowed after first character.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the replication partner. String of up to 63 alphanumeric and can include hyphens characters but cannot start with hyphen.")
