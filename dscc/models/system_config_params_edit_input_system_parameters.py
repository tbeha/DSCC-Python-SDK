...
class SystemConfigParamsEditInputSystemParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allowWrtbackSingleNode", "enableAIQoS", "hostDIF", "hostDIFTemplate", "overprovRatioLimit", "overprovRatioWarning"]
