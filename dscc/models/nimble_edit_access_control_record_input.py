...
class NimbleEditAccessControlRecordInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["apply_to"]
    ...
    def apply_to_validate_enum(cls, value):
        ...
        if value not in set(['volume', 'pe', 'vvol_volume', 'vvol_snapshot', 'snapshot', 'both']):
            raise ValueError("must be one of enum values ('volume', 'pe', 'vvol_volume', 'vvol_snapshot', 'snapshot', 'both')")
        return value
