...
class NodesPowerSummaryList(BaseModel):
    """
    NodesPowerSummaryList
    """ # noqa: E501
    items: Optional[List[NodePowerSuppliesList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of node power supplies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NodePowerSuppliesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
