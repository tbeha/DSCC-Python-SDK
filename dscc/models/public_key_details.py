...
class PublicKeyDetails(BaseModel):
    ...
    key_name: Optional[StrictStr] = Field(default=None, description="The user that owns the key.")
    key_type: Optional[StrictStr] = Field(default=None, description="The key type.")
    __properties: ClassVar[List[str]] = ["key", "key_name", "key_type"]
