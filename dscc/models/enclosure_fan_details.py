...
class EnclosureFanDetails(BaseModel):
    """
    EnclosureFanDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "elementStatusCode", "enclosureCoolingFanId", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "partNumber", "protocol", "psId", "requestUri", "resourceUri", "safeToRemove", "speed", "speedRpm", "state", "systemId", "type", "wwn"]
