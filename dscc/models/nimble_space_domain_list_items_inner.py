...
class NimbleSpaceDomainListItemsInner(BaseModel):
    """
    NimbleSpaceDomainListItemsInner
    """ # noqa: E501
    app_category_id: Optional[StrictStr] = Field(default=None, description="Identifier of the application category associated with the space domain. `Filter`")
    app_category_name: Optional[StrictStr] = Field(default=None, description="Name of the application category associated with the space domain. `Filter`")
    block_size: Optional[StrictInt] = Field(default=None, description="Block size in bytes of volumes belonging to the space domain. `Sort`")
    clone_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Clone savings for the space domain expressed as ratio. `Sort`")
    compressed_usage_bytes: Optional[StrictInt] = Field(default=None, description="Compressed usage of volumes and snapshots in the space domain. `Sort`")
    compression_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Compression savings for the space domain expressed as ratio. `Sort`")
    dedupe_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Deduplication savings for the space domain expressed as ratio. `Sort`")
    deduped: Optional[StrictBool] = Field(default=None, description="Volumes in space domain are deduplicated by default. `Filter, Sort`")
    encrypted: Optional[StrictBool] = Field(default=None, description="Volumes in space domain are encrypted. `Filter, Sort`")
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the application summery. `Filter`")
    logical_dedupe_usage: Optional[StrictInt] = Field(default=None, description="Logical space usage of volumes when deduped. `Sort`")
    physical_dedupe_usage: Optional[StrictInt] = Field(default=None, description="Physical space usage of volumes including snapshots when deduped. `Sort`")
    pool_id: Optional[StrictStr] = Field(default=None, description="Identifier associated with the pool in the storage pool table. `Filter`")
    pool_name: Optional[StrictStr] = Field(default=None, description="Name of the pool containing the space domain. `Filter`")
    savings_clone: Optional[StrictInt] = Field(default=None, description="Space usage savings in the space domain due to cloning of volumes. `Sort`")
    savings_compression: Optional[StrictInt] = Field(default=None, description="Space usage savings in the space domain due to compression. `Sort`")
    savings_dedupe: Optional[StrictInt] = Field(default=None, description="Space usage savings in the space domain due to deduplication. `Sort`")
    snap_logical_usage: Optional[StrictInt] = Field(default=None, description="Logical usage of snapshots in the space domain. `Sort`")
    uncompressed_usage_bytes: Optional[StrictInt] = Field(default=None, description="Uncompressed usage of volumes and snapshots in the space domain. `Sort`")
    usage: Optional[StrictInt] = Field(default=None, description="Physical space usage of volumes in the space domain. `Sort`")
    vol_logical_usage: Optional[StrictInt] = Field(default=None, description="Logical usage of volumes in the space domain. `Sort`")
    vol_mapped_usage: Optional[StrictInt] = Field(default=None, description="Mapped usage of volumes in the space domain, useful for computing clone savings. `Sort`")
