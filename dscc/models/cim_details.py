...
class CimDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cim": Cim.from_dict(obj["cim"]) if obj.get("cim") is not None else None,
