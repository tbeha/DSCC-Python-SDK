...
class DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies
    """ # noqa: E501
    items: Optional[List[DeviceType4enclosurePowersLists]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosurePowerSupplies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosurePowersLists.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
