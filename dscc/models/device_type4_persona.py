...
class DeviceType4Persona(BaseModel):
    """
    Host Persona
    """ # noqa: E501
    capabilities: Optional[List[Optional[StrictStr]]] = None
    id: Optional[StrictInt] = Field(default=None, description="Numeric ID of the resource")
    name: Optional[StrictStr] = Field(default=None, description="Host Name")
    __properties: ClassVar[List[str]] = ["capabilities", "id", "name"]
