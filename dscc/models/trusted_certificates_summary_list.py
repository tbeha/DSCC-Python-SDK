...
class TrustedCertificatesSummaryList(BaseModel):
    """
    TrustedCertificatesSummaryList
    """ # noqa: E501
    items: Optional[List[TrustedCertificatesList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of trusted certificates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [TrustedCertificatesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
