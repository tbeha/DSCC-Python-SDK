...
class DeviceType4EncryptionBackupRekeyRestoreParams(BaseModel):
    """
    DeviceType4EncryptionBackupRekeyRestoreParams
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="Password for the encryption Backup/Rekey/Restore operation.")
