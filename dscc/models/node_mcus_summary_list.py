...
class NodeMcusSummaryList(BaseModel):
    """
    NodeMcusSummaryList
    """ # noqa: E501
    items: Optional[List[NodeMcuList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of node Mcus.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NodeMcuList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
