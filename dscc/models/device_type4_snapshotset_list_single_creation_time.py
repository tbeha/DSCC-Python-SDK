...
class DeviceType4SnapshotsetListSingleCreationTime(BaseModel):
    """
    Creation Time
    """ # noqa: E501
    ms: Optional[StrictInt] = Field(default=None, alias="Ms")
    tz: Optional[StrictStr] = Field(default=None, alias="Tz")
