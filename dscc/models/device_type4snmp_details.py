...
class DeviceType4snmpDetails(BaseModel):
    """
    Snmp Details for a device
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4snmp]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of snmp managers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4snmp.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
