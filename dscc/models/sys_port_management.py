...
class SysPortManagement(BaseModel):
    """
    ...
    ip_v4_data: Optional[Address] = Field(default=None, alias="ipV4Data")
    ip_v6_data: Optional[Address] = Field(default=None, alias="ipV6Data")
    ...
    new_ip_v4_data: Optional[Address] = Field(default=None, alias="newIpV4Data")
    new_ipv6_data: Optional[Address] = Field(default=None, alias="newIpv6Data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "ipV4Data": Address.from_dict(obj["ipV4Data"]) if obj.get("ipV4Data") is not None else None,
            "ipV6Data": Address.from_dict(obj["ipV6Data"]) if obj.get("ipV6Data") is not None else None,
            "newDefaultRouteIPv4": obj.get("newDefaultRouteIPv4"),
            "newDefaultRouteIPv6": obj.get("newDefaultRouteIPv6"),
            "newIpV4Data": Address.from_dict(obj["newIpV4Data"]) if obj.get("newIpV4Data") is not None else None,
            "newIpv6Data": Address.from_dict(obj["newIpv6Data"]) if obj.get("newIpv6Data") is not None else None,
