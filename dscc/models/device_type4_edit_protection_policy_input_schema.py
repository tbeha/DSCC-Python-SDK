...
class DeviceType4EditProtectionPolicyInputSchema(BaseModel):
    """
    Request body for edit protection policy
    """ # noqa: E501
    create_schedules: Optional[List[DeviceType4ProtectionScheduleInputSchema]] = Field(default=None, alias="createSchedules")
    modify_schedules: Optional[List[DeviceType4ModifyProtectionScheduleInputSchema]] = Field(default=None, alias="modifySchedules")
    policy: Optional[DeviceType4ProtectionPolicyInputSchema] = None
    ...
    remove_schedules: Optional[List[DeviceType4RemoveProtectionScheduleInputSchema]] = Field(default=None, alias="removeSchedules")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createSchedules": [DeviceType4ProtectionScheduleInputSchema.from_dict(_item) for _item in obj["createSchedules"]] if obj.get("createSchedules") is not None else None,
            "modifySchedules": [DeviceType4ModifyProtectionScheduleInputSchema.from_dict(_item) for _item in obj["modifySchedules"]] if obj.get("modifySchedules") is not None else None,
            "policy": DeviceType4ProtectionPolicyInputSchema.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
