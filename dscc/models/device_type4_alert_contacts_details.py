...
class DeviceType4AlertContactsDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["company", "companyCode", "consoleUri", "country", "customerId", "fax", "firstName", "generation", "id", "includeSvcAlerts", "lastName", "notificationSeverities", "preferredLanguage", "primaryEmail", "primaryPhone", "receiveEmail", "receiveGrouped", "secondaryEmail", "secondaryPhone", "systemId", "systemSupportContact", "type"]
