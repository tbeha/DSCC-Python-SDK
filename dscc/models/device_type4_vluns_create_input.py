...
class DeviceType4VlunsCreateInput(BaseModel):
    """
    DeviceType4VlunsCreateInput
    """ # noqa: E501
    lun: Optional[List[DeviceType4VlunsCreateInputLUNInner]] = Field(default=None, description="Custom LUN Id for multiple host groups", alias="LUN")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LUN": [DeviceType4VlunsCreateInputLUNInner.from_dict(_item) for _item in obj["LUN"]] if obj.get("LUN") is not None else None,
