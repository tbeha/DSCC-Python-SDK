...
class DeviceType4SetEKMConfigInput(BaseModel):
    """
    DeviceType4SetEKMConfigInput
    """ # noqa: E501
    parameters: Optional[DeviceType4SetEKMConfigParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": DeviceType4SetEKMConfigParams.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
