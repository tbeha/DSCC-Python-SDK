...
class NimbleSnapshot(BaseModel):
    """
    NimbleSnapshot
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the snapshot. A 42 digit hexadecimal number. `Filter`")
    ...
    online: Optional[StrictBool] = Field(default=None, description="Online state for a snapshot means it could be mounted for data restore. `Filter, Sort`")
    pool_name: Optional[StrictStr] = Field(default=None, description="Name of the pool in which the parent volume belongs to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`")
    replication_status: Optional[StrictStr] = Field(default=None, description="Replication status. Possible values: 'complete', 'in_progress', 'pending', 'fail'. `Filter, Sort`")
    ...
    schedule_name: Optional[StrictStr] = Field(default=None, description="Name of protection schedule. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`")
    serial_number: Optional[StrictStr] = Field(default=None, description="Identifier for the SCSI protocol. A 32 digit hexadecimal number. `Filter, Sort`")
    size: Optional[StrictInt] = Field(default=None, description="Size of volume at time of snapshot (in bytes). `Filter, Sort`")
    snap_collection_id: Optional[StrictStr] = Field(default=None, description="Identifier of snapshot collection. A 42 digit hexadecimal number. `Filter, Sort`")
    ...
    target_name: Optional[StrictStr] = Field(default=None, description="The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target snapshot. The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target. `Filter, Sort`")
    writable: Optional[StrictBool] = Field(default=None, description="Whether snapshot is writable or not. Mandatory and must be set to 'true' for VSS application synchronized snapshots. `Filter, Sort`")
