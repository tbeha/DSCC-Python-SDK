...
class DeviceType4EnclosuresDetailedFieldsEnclosureCards(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsEnclosureCards
    """ # noqa: E501
    items: Optional[List[DeviceType4enclosureCardDetails]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosureCards")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureCardDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
