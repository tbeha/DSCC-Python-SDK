...
class DeviceType4vcenterStatus(BaseModel):
    """
    Status of the vcenter setting
    """ # noqa: E501
    default: Optional[StrictStr] = Field(default=None, description="Default status value")
    key: Optional[StrictStr] = Field(default=None, description="Status key of vcenter")
