...
class DeviceType4RecoverParams(BaseModel):
    """
    DeviceType4RecoverParams
    """ # noqa: E501
    skip_start: Optional[StrictBool] = Field(default=None, description="Specifies that protection is not started after recover action is completed.", alias="skipStart")
    skip_sync: Optional[StrictBool] = Field(default=None, description="Specifies that protection is not synced after recover action is completed.", alias="skipSync")
    target_name: Optional[StrictStr] = Field(default=None, description="Replication partner name (target name) on which the recover action to be performed.", alias="targetName")
    __properties: ClassVar[List[str]] = ["skipStart", "skipSync", "targetName"]
