...
class DeviceType4VasaConfig(BaseModel):
    """
    DeviceType4VasaConfig
    """ # noqa: E501
    action: Optional[StrictStr] = Field(default=None, description="Specify the action on vasa service. Either START, STOP or RESET")
