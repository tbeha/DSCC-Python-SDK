...
class ApplicationServerDetails(BaseModel):
    """
    ApplicationServerDetails
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed application server objects", alias="requestUri")
    hostname: Optional[StrictStr] = Field(default=None, description="Application server hostname. String of alphanumeric characters, valid range is from 2 to 255; Each label must be between 1 and 63 characters long; Hypen and  colon are allowed after the first and before the last character.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the application server. A 42 digit hexadecimal number.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the volume. String of up to 64 alphanumeric, hyphenated, colon, or period-separated characters; but cannot begin with hyphen, colon or period.")
    server_type: Optional[StrictStr] = Field(default=None, description="Application server type. Possible values: 'vss', 'vmware'.")
