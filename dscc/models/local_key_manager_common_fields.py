...
class LocalKeyManagerCommonFields(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["active", "commonResourceAttributes", "consoleUri", "customerId", "generation", "purgeAge", "resourceUri", "type"]
