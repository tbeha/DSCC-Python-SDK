...
class DeprecatedDeviceType4userAllocationSettingsSingle(BaseModel):
    """
    ...
    device_speed: Optional[DeviceType4deviceSpeed] = Field(default=None, alias="deviceSpeed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceSpeed": DeviceType4deviceSpeed.from_dict(obj["deviceSpeed"]) if obj.get("deviceSpeed") is not None else None,
