...
class PrimeraStorageSystemDetailList(BaseModel):
    """
    ...
    manufacturing: Optional[ManufacturingSys] = None
    ...
    overall_state: Optional[StrictStr] = Field(default=None, description="overallState state derived from enclosure, disk and node state For deviceType1 State derived from ports, enclosure, disk and node state for deviceType2 state is state reported by deviceType2 array", alias="overallState")
    ...
    software_versions: Optional[SoftwareVersions] = Field(default=None, alias="softwareVersions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manufacturing": ManufacturingSys.from_dict(obj["manufacturing"]) if obj.get("manufacturing") is not None else None,
            ...
            "softwareVersions": SoftwareVersions.from_dict(obj["softwareVersions"]) if obj.get("softwareVersions") is not None else None,
