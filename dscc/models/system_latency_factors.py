...
class SystemLatencyFactors(BaseModel):
    """
    ...
    system_factors_metrics: Optional[List[Optional[FactorData]]] = Field(default=None, alias="systemFactorsMetrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "systemFactorsMetrics": [FactorData.from_dict(_item) for _item in obj["systemFactorsMetrics"]] if obj.get("systemFactorsMetrics") is not None else None,
