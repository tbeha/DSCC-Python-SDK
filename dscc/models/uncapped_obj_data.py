...
class UncappedObjData(BaseModel):
    """
    QoS policy uncap details
    """ # noqa: E501
    items: Optional[List[Optional[ObjData]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="total number of uncapped data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ObjData.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
