...
class DeviceType4EnclosureCardDetailedFieldsEnclosureCardBootDrives(BaseModel):
    """
    DeviceType4EnclosureCardDetailedFieldsEnclosureCardBootDrives
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4enclosureCardBootDriveDetails]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of disks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureCardBootDriveDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
