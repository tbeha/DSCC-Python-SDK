...
class DeviceType4EnclosureDiskDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "requestUri", "resourceUri", "systemId", "temperature", "type", "wwn"]
