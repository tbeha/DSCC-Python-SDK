...
class DeviceType4ApplicationSummary(BaseModel):
    """
    Application summary
    """ # noqa: E501
    ...
    items: Optional[List[Optional[DeviceType4applications]]] = None
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed storage object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of node Cards.")
    __properties: ClassVar[List[str]] = ["commonResourceAttributes", "customerId", "items", "requestUri", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DeviceType4applications.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
