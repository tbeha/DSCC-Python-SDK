...
class DeviceType4VlunsSummaryList(BaseModel):
    """
    DeviceType4VlunsSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4vlunsList]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of Vluns.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4vlunsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
