...
class HostMetricSeriesData(BaseModel):
    """
    HostMetricSeriesData
    """ # noqa: E501
    timestamp_ms: Optional[StrictInt] = Field(default=None, description="epoch timestamp", alias="timestampMs")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="average metric value at particular timestamp")
