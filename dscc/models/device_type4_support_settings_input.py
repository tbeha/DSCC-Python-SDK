...
class DeviceType4SupportSettingsInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connectToHPE", "deviceId", "enterpriseServerURL", "miniInsploreEnabled", "remoteAccess"]
