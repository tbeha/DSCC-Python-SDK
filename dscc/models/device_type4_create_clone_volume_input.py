...
class DeviceType4CreateCloneVolumeInput(BaseModel):
    """
    ...
    offline_clone: Optional[DeviceType4offlineClone] = Field(default=None, alias="offlineClone")
    online: Optional[StrictBool] = Field(default=None, description="Create an online or offline clone of a volume.")
    online_clone: Optional[DeviceType4onlineClone] = Field(default=None, alias="onlineClone")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offlineClone": DeviceType4offlineClone.from_dict(obj["offlineClone"]) if obj.get("offlineClone") is not None else None,
            "online": obj.get("online"),
            "onlineClone": DeviceType4onlineClone.from_dict(obj["onlineClone"]) if obj.get("onlineClone") is not None else None,
