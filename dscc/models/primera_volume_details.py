...
class PrimeraVolumeDetails(BaseModel):
    """
    ...
    creation_time: Optional[Calendar] = Field(default=None, alias="creationTime")
    ...
    volume_performance: Optional[VolumePerformance] = Field(default=None, alias="volumePerformance")
    ...
    __properties: ClassVar[List[str]] = ["adminAllocationSettings", "adminSpace", "associatedLinks", "baseId", "comment", "commonResourceAttributes", "compactEfficiency", "compressionEfficiency", "compressionPolicy", "consoleUri", "conversionType", "copiedMB", "copiedPerc", "copyOfID", "creationTime", "customerId", "dataReduction", "ddcSize", "ddsSize", "dedup", "dedupSavingsSize", "dedupWrittenSize", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "hostWrittenMiB", "hostWrittenToVirtualPercent", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "requestUri", "resourceUri", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "sizeMiB", "snapShotTier", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCpgID", "snapshotCpgName", "snapshotSpace", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "spaceCalculationTime", "started", "state", "storageTier", "systemId", "thinProvisioned", "thinSavings", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "type", "unrefSpaceFreedTime", "usedCapacity", "usedSizeMiB", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent", "vlunSectorSize", "volumeId", "volumePerformance", "volumeType", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creationTime": Calendar.from_dict(obj["creationTime"]) if obj.get("creationTime") is not None else None,
            ...
            "volumePerformance": VolumePerformance.from_dict(obj["volumePerformance"]) if obj.get("volumePerformance") is not None else None,
