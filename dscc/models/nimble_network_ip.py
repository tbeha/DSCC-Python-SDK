...
class NimbleNetworkIP(BaseModel):
    """
    NimbleNetworkIP
    """ # noqa: E501
    ip: Optional[StrictStr] = Field(default=None, description="Associated ip address.")
    vlan_id: Optional[StrictInt] = Field(default=None, description="vlan id.")
    __properties: ClassVar[List[str]] = ["ip", "vlan_id"]
