...
class DeviceType4EnclosureConnectorDetailsNodePort(BaseModel):
    """
    It includes node number, slot number, and port number
    """ # noqa: E501
    node: Optional[StrictInt] = Field(default=None, description="`Filter, Sort`")
    port: Optional[StrictInt] = Field(default=None, description="`Filter, Sort`")
    slot: Optional[StrictInt] = Field(default=None, description="`Filter, Sort`")
