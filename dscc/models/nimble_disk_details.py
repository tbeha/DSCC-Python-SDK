...
class NimbleDiskDetails(BaseModel):
    """
    NimbleDiskDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["array_id", "array_name", "disk_type", "id", "model", "serial", "shelf_id", "shelf_serial", "state", "associated_links", "bank", "block_type", "commonResourceAttributes", "consoleUri", "customerId", "disk_internal_stat1", "disk_op", "firmware_version", "force", "generation", "hba", "is_dfc", "partial_response_ok", "path", "port", "raid_id", "raid_resync_average_speed", "raid_resync_current_speed", "raid_resync_percent", "raid_state", "resourceUri", "shelf_location", "shelf_location_id", "size", "slot", "smart_attribute_list", "type", "vendor", "vshelf_id"]
