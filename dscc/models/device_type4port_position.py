...
class DeviceType4portPosition(BaseModel):
    """
    DeviceType4portPosition
    """ # noqa: E501
    node: Optional[StrictInt] = Field(default=None, description="Port position node number `Filter, Sort`")
    port: Optional[StrictInt] = Field(default=None, description="Port position port number `Filter, Sort`")
    slot: Optional[StrictInt] = Field(default=None, description="Port position slot number `Filter, Sort`")
