...
class CommonResourceProperties(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="An identifier for the resource, usually a UUID.")
    name: Optional[StrictStr] = Field(default=None, description="A system specified name for the resource.")
    resource_uri: Optional[StrictStr] = Field(default=None, description="The 'self' reference for this resource.", alias="resourceUri")
    type: Optional[StrictStr] = Field(default=None, description="The type of resource.")
    __properties: ClassVar[List[str]] = ["customerId", "generation", "id", "name", "resourceUri", "type"]
