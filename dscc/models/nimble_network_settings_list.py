...
class NimbleNetworkSettingsList(BaseModel):
    """
    NimbleNetworkSettingsList
    """ # noqa: E501
    items: Optional[List[NimbleNetworkSettingsListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for network setting objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of network settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleNetworkSettingsListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
