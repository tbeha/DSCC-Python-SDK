...
class NodeDrivesSummaryList(BaseModel):
    """
    NodeDrivesSummaryList
    """ # noqa: E501
    items: Optional[List[NodeDrivesList]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed node Drive object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of node Drives.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NodeDrivesList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
