...
class ReplicationPartnerObj(BaseModel):
    """
    ...
    target_system_id: StrictStr = Field(description="Target system ID", alias="targetSystemId")
    ...
    __properties: ClassVar[List[str]] = ["control_port", "data_port", "description", "repl_hostname", "source", "subnet_label", "subnet_type", "target", "targetSystemId", "throttles"]
