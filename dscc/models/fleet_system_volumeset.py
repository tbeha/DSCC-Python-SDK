...
class FleetSystemVolumeset(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appType", "associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "generation", "id", "name", "productFamily", "requestUri", "resourceUri", "systemId", "type", "volumesCount"]
