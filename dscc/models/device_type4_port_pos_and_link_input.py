...
class DeviceType4PortPosAndLinkInput(BaseModel):
    """
    ...
    port_position: DeviceType4PortPositionInput = Field(alias="portPosition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "portPosition": DeviceType4PortPositionInput.from_dict(obj["portPosition"]) if obj.get("portPosition") is not None else None
        })
        return _obj
