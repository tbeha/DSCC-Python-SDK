...
class NimbleNetworkInterfaceList(BaseModel):
    """
    NimbleNetworkInterfaceList
    """ # noqa: E501
    items: Optional[List[NimbleNetworkInterfaceListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for  Network Interfaces", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Network Interfaces.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleNetworkInterfaceListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
