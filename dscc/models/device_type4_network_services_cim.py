...
class DeviceType4NetworkServicesCim(BaseModel):
    """
    DeviceType4NetworkServicesCim
    """ # noqa: E501
    items: Optional[DeviceType4cimDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": DeviceType4cimDetails.from_dict(obj["items"]) if obj.get("items") is not None else None,
