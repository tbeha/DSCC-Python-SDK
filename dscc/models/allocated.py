...
class Allocated(BaseModel):
    ...
    cpgs_private_base: Optional[Private] = Field(default=None, alias="cpgsPrivateBase")
    cpgs_private_snap: Optional[Private] = Field(default=None, alias="cpgsPrivateSnap")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cpgsPrivateBase": Private.from_dict(obj["cpgsPrivateBase"]) if obj.get("cpgsPrivateBase") is not None else None,
            "cpgsPrivateSnap": Private.from_dict(obj["cpgsPrivateSnap"]) if obj.get("cpgsPrivateSnap") is not None else None,
