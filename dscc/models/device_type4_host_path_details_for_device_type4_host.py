...
class DeviceType4HostPathDetailsForDeviceType4Host(BaseModel):
    """
    DeviceType4HostPathDetailsForDeviceType4Host
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4HostPathsForDeviceType4Host]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4HostPathsForDeviceType4Host.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
