...
class HostGroupsList(BaseModel):
    """
    HostGroupsList
    """ # noqa: E501
    items: Optional[List[HostGroupObject]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [HostGroupObject.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
