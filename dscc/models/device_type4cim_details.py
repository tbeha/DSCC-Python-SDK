...
class DeviceType4cimDetails(BaseModel):
    """
    ...
    cim: Optional[DeviceType4cim] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "cim", "commonResourceAttributes", "systemId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cim
        if self.cim:
            _dict['cim'] = self.cim.to_dict()
        ...
        # set to None if cim (nullable) is None
        # and model_fields_set contains the field
        if self.cim is None and "cim" in self.model_fields_set:
            _dict['cim'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cim": DeviceType4cim.from_dict(obj["cim"]) if obj.get("cim") is not None else None,
