...
class RcLinkPerformanceHistoryData(BaseModel):
    """
    ...
    history_data: Optional[RcLinkPerformanceHistoryDataHistoryData] = Field(default=None, alias="historyData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "historyData": RcLinkPerformanceHistoryDataHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
