...
class HostGroupSummaryObjectDetails(BaseModel):
    """
    ...
    systems: Optional[List[Optional[StrictStr]]] = Field(default=None, description="system IDs to which the host group belongs to. (This field is deprecated)")
    type: Optional[StrictStr] = Field(default=None, description="The type of resource.")
    user_created: Optional[StrictBool] = Field(default=None, description="Idicates whether user created host group or discovered host group. (This field is deprecated)", alias="userCreated")
    __properties: ClassVar[List[str]] = ["associatedSystems", "consoleUri", "customerId", "generation", "id", "isMergable", "markedForDelete", "name", "systems", "type", "userCreated"]
