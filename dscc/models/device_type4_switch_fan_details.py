...
class DeviceType4SwitchFanDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "generation", "id", "manufacturing", "name", "requestUri", "resourceUri", "speedA", "speedB", "state", "stateA", "stateB", "switchFanId", "switchName", "switchUid", "systemId", "type"]
