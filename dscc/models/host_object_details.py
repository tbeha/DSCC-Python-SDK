...
class HostObjectDetails(BaseModel):
    """
    HostObjectDetails
    """ # noqa: E501
    ...
    host_groups: Optional[List[Optional[HostGroupSummaryObjectDetails]]] = Field(default=None, description="Host group to which the host belongs to.", alias="hostGroups")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for host.")
    initiators: Optional[List[Optional[InitiatorObjectDetails]]] = Field(default=None, description="Host initiator list this host is associated with.")
    ...
    operating_system: Optional[StrictStr] = Field(default=None, description="Host operating system.", alias="operatingSystem")
    ...
    systems: Optional[List[Optional[StrictStr]]] = Field(default=None, description="system IDs to which the host belongs to.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostGroups": [HostGroupSummaryObjectDetails.from_dict(_item) for _item in obj["hostGroups"]] if obj.get("hostGroups") is not None else None,
            "id": obj.get("id"),
