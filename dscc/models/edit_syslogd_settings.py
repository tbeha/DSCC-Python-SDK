...
class EditSyslogdSettings(BaseModel):
    """
    EditSyslogdSettings
    """ # noqa: E501
    syslogd_enabled: Optional[StrictBool] = Field(default=None, description="Enable or disable syslogd in system")
    ...
    __properties: ClassVar[List[str]] = ["syslogd_enabled", "syslogd_port", "syslogd_server", "syslogd_servers"]
