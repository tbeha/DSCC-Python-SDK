...
class RemoveProtectionPoliciesInputSchema(BaseModel):
    """
    Request body to remove protection policies
    """ # noqa: E501
    policies: List[RemoveProtectionPolicyInputSchema] = Field(description="List of protection policies to be removed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [RemoveProtectionPolicyInputSchema.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
