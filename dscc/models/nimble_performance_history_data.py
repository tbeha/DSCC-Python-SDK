...
class NimblePerformanceHistoryData(BaseModel):
    """
    ...
    history_data: Optional[NimblePerformanceHistoryDataHistoryData] = Field(default=None, alias="historyData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "historyData": NimblePerformanceHistoryDataHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
