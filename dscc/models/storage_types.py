...
class StorageTypes(BaseModel):
    ...
    StorageTypes
    """ # noqa: E501
    items: Optional[List[DeviceTypes]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of type of systems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceTypes.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
