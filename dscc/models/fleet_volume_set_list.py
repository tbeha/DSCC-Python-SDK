...
class FleetVolumeSetList(BaseModel):
    """
    FleetVolumeSetList
    """ # noqa: E501
    items: Optional[List[Optional[FleetVolumeset]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total Number of volume sets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FleetVolumeset.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
