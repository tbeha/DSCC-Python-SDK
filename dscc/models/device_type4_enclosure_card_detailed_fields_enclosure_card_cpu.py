...
class DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu(BaseModel):
    """
    DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4enclosureCardCpuDetails]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureCardCpuDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
