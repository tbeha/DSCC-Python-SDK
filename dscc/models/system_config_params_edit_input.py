...
class SystemConfigParamsEditInput(BaseModel):
    """
    ...
    date_time: Optional[StrictStr] = Field(default=None, description="system date time", alias="dateTime")
    ...
    ntp_addresses: Optional[List[Optional[StrictStr]]] = Field(default=None, description="system ntp addresses", alias="ntpAddresses")
    ...
    support_contact: Optional[ContactsEditDetails] = Field(default=None, alias="supportContact")
    system_parameters: Optional[SystemConfigParamsEditInputSystemParameters] = Field(default=None, alias="systemParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportContact": ContactsEditDetails.from_dict(obj["supportContact"]) if obj.get("supportContact") is not None else None,
            "systemParameters": SystemConfigParamsEditInputSystemParameters.from_dict(obj["systemParameters"]) if obj.get("systemParameters") is not None else None,
