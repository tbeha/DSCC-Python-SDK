...
class DeviceType4NetworkServicesVasa(BaseModel):
    """
    DeviceType4NetworkServicesVasa
    """ # noqa: E501
    items: Optional[DeviceType4VasaDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": DeviceType4VasaDetails.from_dict(obj["items"]) if obj.get("items") is not None else None,
