...
class NimbleShelfListItemsInner(BaseModel):
    """
    NimbleShelfListItemsInner
    """ # noqa: E501
    array_id: Optional[StrictStr] = Field(default=None, description="ID of array the shelf belongs to. `Filter, Sort`")
    array_name: Optional[StrictStr] = Field(default=None, description="Name of array the shelf belongs to. `Filter, Sort`")
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the shelf. `Filter`")
    model: Optional[StrictStr] = Field(default=None, description="Model of the shelf or head unit. `Filter, Sort`")
    serial: Optional[StrictStr] = Field(default=None, description="The serial number of the chassis. `Filter, Sort`")
