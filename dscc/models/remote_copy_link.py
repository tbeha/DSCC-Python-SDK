...
class RemoteCopyLink(BaseModel):
    """
    RemoteCopyLink
    """ # noqa: E501
    ...
    port_pos: Optional[RemoteCopyLinkPortPosition] = Field(default=None, description="Port position of the link", alias="portPos")
    ...
    remote_port_pos: Optional[RemoteCopyLinkPortPosition] = Field(default=None, description="Port position of the remote link", alias="remotePortPos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "port": obj.get("port"),
            "portPos": RemoteCopyLinkPortPosition.from_dict(obj["portPos"]) if obj.get("portPos") is not None else None,
            "rcLinkId": obj.get("rcLinkId"),
            "remoteAddress": obj.get("remoteAddress"),
            "remoteId": obj.get("remoteId"),
            "remotePortPos": RemoteCopyLinkPortPosition.from_dict(obj["remotePortPos"]) if obj.get("remotePortPos") is not None else None,
