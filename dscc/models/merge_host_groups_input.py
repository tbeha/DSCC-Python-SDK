...
class MergeHostGroupsInput(BaseModel):
    """
    MergeHostGroupsInput
    """ # noqa: E501
    host_group_ids: Optional[List[StrictStr]] = Field(description="Array of host group ids         ", alias="hostGroupIds")
    name: Optional[StrictStr] = Field(description="Name of the host Group.")
    __properties: ClassVar[List[str]] = ["hostGroupIds", "name"]
