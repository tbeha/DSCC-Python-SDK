...
class DeviceType4VasaDetails(BaseModel):
    """
    ...
    vasa: Optional[DeviceType4Vasa] = None
    __properties: ClassVar[List[str]] = ["associatedLinks", "systemId", "vasa"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vasa
        if self.vasa:
            _dict['vasa'] = self.vasa.to_dict()
        ...
        # set to None if vasa (nullable) is None
        # and model_fields_set contains the field
        if self.vasa is None and "vasa" in self.model_fields_set:
            _dict['vasa'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vasa": DeviceType4Vasa.from_dict(obj["vasa"]) if obj.get("vasa") is not None else None
        })
        return _obj
