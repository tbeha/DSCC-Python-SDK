...
class NimbleEventsDetails(BaseModel):
    """
    NimbleEventsDetails
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["activity", "associated_links", "commonResourceAttributes", "consoleUri", "customerId", "generation", "resourceUri", "summary", "type"]
