...
class ReplicationPartnerVolumeList(BaseModel):
    """
    ...
    remote_volume: Optional[ReplicationPartnerVolumeListRemoteVolume] = Field(default=None, alias="remoteVolume")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remoteVolume": ReplicationPartnerVolumeListRemoteVolume.from_dict(obj["remoteVolume"]) if obj.get("remoteVolume") is not None else None,
