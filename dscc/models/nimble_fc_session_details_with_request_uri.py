...
class NimbleFCSessionDetailsWithRequestUri(BaseModel):
    """
    NimbleFCSessionDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed Fibre Channel Session object", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["id", "associated_links", "commonResourceAttributes", "consoleUri", "customerId", "generation", "initiator_info", "resourceUri", "sc_HostInitiatorId", "target_info", "type"]
