...
class DeviceType4enclosurePowersList(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["acStatus", "associatedLinks", "commonResourceAttributes", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosurePowerId", "enclosurePowerSupplyId", "enclosureType", "enclosureUid", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "resourceUri", "safeToRemove", "state", "systemId", "type"]
