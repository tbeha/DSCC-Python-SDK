...
class SnapshotsetListSingle(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appSetBusinessUnit", "appSetComments", "appSetImportance", "appSetName", "appSetType", "comment", "commonResourceAttributes", "creationTime", "customerId", "displayName", "domain", "exportStatus", "generation", "id", "kvPairsPresent", "members", "name", "requestUri", "serialNumber", "snapSetId", "snapSetParentId", "snapSetParentName", "systemId", "type", "vvSetType"]
