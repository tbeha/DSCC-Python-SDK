...
class SupportSetting(BaseModel):
    ...
    rap_forwarding: Optional[StrictStr] = Field(default=None, description="Enable/Disable RAP forwarding. Allowed values: enabled or disabled.", alias="rapForwarding")
    ...
    rts_enabled: Optional[StrictStr] = Field(default=None, description="Enable/Disable Real time data scrubbing. Allowed values: enabled or disabled.", alias="rtsEnabled")
    type: Optional[StrictStr] = Field(default=None, description="The type of resource.")
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "connectToHPE", "consoleUri", "customerId", "emailNotifications", "enterpriseServerURL", "generation", "id", "miniInsploreEnabled", "rapForwarding", "remoteAccess", "requestUri", "resourceUri", "rtsEnabled", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if rap_forwarding (nullable) is None
        # and model_fields_set contains the field
        if self.rap_forwarding is None and "rap_forwarding" in self.model_fields_set:
            _dict['rapForwarding'] = None
        ...
        # set to None if rts_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.rts_enabled is None and "rts_enabled" in self.model_fields_set:
            _dict['rtsEnabled'] = None
