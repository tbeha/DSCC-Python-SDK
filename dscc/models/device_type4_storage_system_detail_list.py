...
class DeviceType4StorageSystemDetailList(BaseModel):
    """
    ...
    descriptors: Optional[DeviceType4descriptors] = None
    device_id: Optional[StrictInt] = Field(default=None, description="Numeric ID of the resource `Filter`", alias="deviceId")
    ...
    id: Optional[StrictStr] = Field(default=None, description="SystemWWN/UUID string uniquely identifying the storage system object. `Filter`")
    ...
    manufacturing: Optional[DeviceType4manufacturingSys] = None
    ...
    network_master_node: Optional[StrictInt] = Field(default=None, description="The Node ID of the current network master `Filter, Sort`", alias="networkMasterNode")
    ...
    overall_state: Optional[StrictStr] = Field(default=None, description="overallState state derived from enclosure, disk and node state For deviceType1 State derived from ports, enclosure, disk and node state. For deviceType2 state is state reported by deviceType2 array. For deviceType4 state is derived from ports,enclosures,disks,nodes and enclosure-cards.", alias="overallState")
    overall_state_description: Optional[StrictStr] = Field(default=None, description="Information of hardware resources that are in degraded state.", alias="overallStateDescription")
    parameters: Optional[DeviceType4parameters] = None
    ...
    software_versions: Optional[DeviceType4softwareVersions] = Field(default=None, alias="softwareVersions")
    state: Optional[DeviceType4systemState] = None
    sys_log_status: Optional[DeviceType4sysLogStatus] = Field(default=None, alias="sysLogStatus")
    ...
    system_wwn: Optional[StrictStr] = Field(default=None, description="WWN of the array `Filter, Sort`", alias="systemWWN")
    ...
    def overall_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cluster_led (nullable) is None
        # and model_fields_set contains the field
        if self.cluster_led is None and "cluster_led" in self.model_fields_set:
            _dict['clusterLED'] = None
        ...
        # set to None if overall_state_description (nullable) is None
        # and model_fields_set contains the field
        if self.overall_state_description is None and "overall_state_description" in self.model_fields_set:
            _dict['overallStateDescription'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "descriptors": DeviceType4descriptors.from_dict(obj["descriptors"]) if obj.get("descriptors") is not None else None,
            ...
            "manufacturing": DeviceType4manufacturingSys.from_dict(obj["manufacturing"]) if obj.get("manufacturing") is not None else None,
            ...
            "overallStateDescription": obj.get("overallStateDescription"),
            "parameters": DeviceType4parameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
            "resourceUri": obj.get("resourceUri"),
            "safeToRemove": obj.get("safeToRemove"),
            "softwareVersions": DeviceType4softwareVersions.from_dict(obj["softwareVersions"]) if obj.get("softwareVersions") is not None else None,
            "state": DeviceType4systemState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "sysLogStatus": DeviceType4sysLogStatus.from_dict(obj["sysLogStatus"]) if obj.get("sysLogStatus") is not None else None,
            ...
            "version": DeviceType4version.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
