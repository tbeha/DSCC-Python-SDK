...
class LocalKeyManagerDetails(BaseModel):
    """
    LocalKeyManagerDetails
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed local key manager objects", alias="requestUri")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the local key manager. A 42 digit hexadecimal number.")
    name: Optional[StrictStr] = Field(default='default', description="Name of local key manager.")
    active: Optional[StrictBool] = Field(default=None, description="Indicates if the local key manager is active or not")
    ...
    purge_age: Optional[StrictInt] = Field(default=None, description="Default minimum age (in hours) of inactive encryption keys to be purged. '0' indicates to purge keys immediately. Signed 64-bit integer.", alias="purgeAge")
    resource_uri: Optional[StrictStr] = Field(default=None, description="Link to the object URI", alias="resourceUri")
    type: Optional[StrictStr] = Field(default=None, description="type")
    __properties: ClassVar[List[str]] = ["id", "name", "active", "commonResourceAttributes", "consoleUri", "customerId", "generation", "purgeAge", "resourceUri", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if purge_age (nullable) is None
        # and model_fields_set contains the field
        if self.purge_age is None and "purge_age" in self.model_fields_set:
            _dict['purgeAge'] = None
