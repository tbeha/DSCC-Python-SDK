...
class DeviceType4SnmpUsersList(BaseModel):
    """
    DeviceType4SnmpUsersList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4SnmpUsersDetails]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed nodes object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of Snmp Users")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4SnmpUsersDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
