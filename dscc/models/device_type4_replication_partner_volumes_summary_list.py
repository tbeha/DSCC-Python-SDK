...
class DeviceType4ReplicationPartnerVolumesSummaryList(BaseModel):
    """
    DeviceType4ReplicationPartnerVolumesSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4ReplicationPartnerVolumeList]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for source and remote volume list as part of remote protected volume set", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of replication partner volumes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4ReplicationPartnerVolumeList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
