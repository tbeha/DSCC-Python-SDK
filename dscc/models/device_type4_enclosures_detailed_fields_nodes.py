...
class DeviceType4EnclosuresDetailedFieldsNodes(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsNodes
    """ # noqa: E501
    items: Optional[List[DeviceType4nodesLists]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4nodesLists.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
