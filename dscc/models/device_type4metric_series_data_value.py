...
class DeviceType4metricSeriesDataValue(BaseModel):
    """
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="value at particular timestamp")
    __properties: ClassVar[List[str]] = ["name", "timestampms", "value"]
