...
class DeviceType4VolumeDetailsList(BaseModel):
    """
    DeviceType4VolumeDetailsList
    """ # noqa: E501
    admin_allocation_settings: Optional[DeviceType4userAllocationSettings] = Field(default=None, alias="adminAllocationSettings")
    ...
    nguid: Optional[StrictStr] = Field(default=None, description="Namespace Globally Unique Identifier. This data is available only for NVMe enabled storage system. `Filter`")
    ...
    user_allocation_settings: Optional[DeviceType4userAllocationSettings] = Field(default=None, alias="userAllocationSettings")
    ...
    volume_performance: Optional[DeviceType4volumePerformanceDetails] = Field(default=None, alias="volumePerformance")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adminAllocationSettings": DeviceType4userAllocationSettings.from_dict(obj["adminAllocationSettings"]) if obj.get("adminAllocationSettings") is not None else None,
            ...
            "userAllocationSettings": DeviceType4userAllocationSettings.from_dict(obj["userAllocationSettings"]) if obj.get("userAllocationSettings") is not None else None,
            ...
            "volumePerformance": DeviceType4volumePerformanceDetails.from_dict(obj["volumePerformance"]) if obj.get("volumePerformance") is not None else None,
