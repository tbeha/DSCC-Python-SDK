...
class DeviceType4SysPowerSustainabilityMerticData(BaseModel):
    """
    ...
    history_data: Optional[DeviceType4SysPowerSustainabilityMerticDataHistoryData] = Field(default=None, alias="historyData")
    ...
    __properties: ClassVar[List[str]] = ["customerId", "endTime", "historyData", "requestUri", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "historyData": DeviceType4SysPowerSustainabilityMerticDataHistoryData.from_dict(obj["historyData"]) if obj.get("historyData") is not None else None,
