...
class PrimeraVolumeDetailsList(BaseModel):
    """
    PrimeraVolumeDetailsList
    """ # noqa: E501
    admin_allocation_settings: Optional[UserAllocationSettings] = Field(default=None, alias="adminAllocationSettings")
    ...
    creation_time: Optional[DeviceType4VolumeDetailsListCreationTime] = Field(default=None, alias="creationTime")
    ...
    dedup: Optional[StrictStr] = Field(default=None, description="Field to indicate Dedup status")
    ...
    dev_type: Optional[StrictStr] = Field(default=None, description="Device Type `Filter`", alias="devType")
    ...
    health_state: Optional[StrictInt] = Field(default=None, description="Health status of the Volume. `Filter, Sort`", alias="healthState")
    ...
    parent_id: Optional[StrictInt] = Field(default=None, description="Parent Id `Filter`", alias="parentID")
    ...
    prov_type: Optional[StrictStr] = Field(default=None, alias="provType")
    ...
    snapshot_allocation_settings: Optional[UserAllocationSettings] = Field(default=None, alias="snapshotAllocationSettings")
    ...
    thin_provisioned: Optional[StrictBool] = Field(default=None, alias="thinProvisioned")
    thin_savings: Optional[StrictStr] = Field(default=None, description="Thin savings for the detailed volume object", alias="thinSavings")
    ...
    used_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Used volume capacity. `Filter, Sort`", alias="usedCapacity")
    ...
    user_allocation_settings: Optional[UserAllocationSettings] = Field(default=None, alias="userAllocationSettings")
    user_cpg_id: Optional[StrictInt] = Field(default=None, description="User CPG Id `Filter`", alias="userCpgID")
    ...
    volume_performance: Optional[VolumePerformanceDetails] = Field(default=None, alias="volumePerformance")
    volume_type: Optional[StrictStr] = Field(default=None, description="VV Type", alias="volumeType")
    wwn: Optional[StrictStr] = Field(default=None, description="Volume wwn. `Filter`")
    __properties: ClassVar[List[str]] = ["adminAllocationSettings", "adminSpace", "associatedLinks", "baseId", "comment", "commonResourceAttributes", "compactEfficiency", "compressionEfficiency", "compressionPolicy", "consoleUri", "conversionType", "copiedMB", "copiedPerc", "copyOfID", "creationTime", "customerId", "dataReduction", "ddcSize", "ddsSize", "dedup", "dedupSavingsSize", "dedupWrittenSize", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "hostWrittenMiB", "hostWrittenToVirtualPercent", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "resourceUri", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "sizeMiB", "snapShotTier", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCpgID", "snapshotCpgName", "snapshotSpace", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "spaceCalculationTime", "started", "state", "storageTier", "systemId", "thinProvisioned", "thinSavings", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "type", "unrefSpaceFreedTime", "usedCapacity", "usedSizeMiB", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent", "vlunSectorSize", "volumeId", "volumePerformance", "volumeType", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adminAllocationSettings": UserAllocationSettings.from_dict(obj["adminAllocationSettings"]) if obj.get("adminAllocationSettings") is not None else None,
            ...
            "creationTime": DeviceType4VolumeDetailsListCreationTime.from_dict(obj["creationTime"]) if obj.get("creationTime") is not None else None,
            ...
            "snapshotAllocationSettings": UserAllocationSettings.from_dict(obj["snapshotAllocationSettings"]) if obj.get("snapshotAllocationSettings") is not None else None,
            ...
            "userAllocationSettings": UserAllocationSettings.from_dict(obj["userAllocationSettings"]) if obj.get("userAllocationSettings") is not None else None,
            ...
            "volumePerformance": VolumePerformanceDetails.from_dict(obj["volumePerformance"]) if obj.get("volumePerformance") is not None else None,
