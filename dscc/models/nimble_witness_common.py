...
class NimbleWitnessCommon(BaseModel):
    """
    NimbleWitnessCommon
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["associated_links", "auto_switchover_messages", "commonResourceAttributes", "consoleUri", "customerId", "generation", "resourceUri", "type"]
