...
class KpiMetrics(BaseModel):
    ...
    """ # noqa: E501
    read: Optional[PmPerfData] = None
    total: Optional[PmPerfData] = None
    write: Optional[PmPerfData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read": PmPerfData.from_dict(obj["read"]) if obj.get("read") is not None else None,
            "total": PmPerfData.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "write": PmPerfData.from_dict(obj["write"]) if obj.get("write") is not None else None
        })
        return _obj
