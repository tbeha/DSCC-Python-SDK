...
class QosMetricsData(BaseModel):
    ...
    items: Optional[List[Optional[QosMetricSeriesData]]] = None
    ...
    __properties: ClassVar[List[str]] = ["customerId", "items", "pageLimit", "pageOffset", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [QosMetricSeriesData.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
