...
class DeviceType4AlertContactsDetailsList(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="Unique Identifier of the contact")
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for alert contact details", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["company", "companyCode", "consoleUri", "country", "customerId", "fax", "firstName", "generation", "id", "includeSvcAlerts", "lastName", "notificationSeverities", "preferredLanguage", "primaryEmail", "primaryPhone", "receiveEmail", "receiveGrouped", "requestUri", "secondaryEmail", "secondaryPhone", "systemId", "systemSupportContact", "type"]
