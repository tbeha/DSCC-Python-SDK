...
class NimbleInitiatorGroupList(BaseModel):
    """
    NimbleInitiatorGroupList
    """ # noqa: E501
    items: Optional[List[Optional[NimbleInitiatorGroup]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of initiator groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleInitiatorGroup.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
