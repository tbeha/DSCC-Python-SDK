...
class Mailsettings(BaseModel):
    ...
    friendly_cert: Optional[FriendlyCertificate] = Field(default=None, alias="friendlyCert")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "authenticationRequired", "consoleUri", "customerId", "friendlyCert", "generation", "mailHostDomain", "mailHostServer", "port", "requestUri", "senderEmailId", "type", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "friendlyCert": FriendlyCertificate.from_dict(obj["friendlyCert"]) if obj.get("friendlyCert") is not None else None,
