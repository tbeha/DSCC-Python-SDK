...
class NimbleHealthStatusList(BaseModel):
    """
    NimbleHealthStatusList
    """ # noqa: E501
    items: Optional[List[NimbleHealthStatusListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for health status objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number ofhealth checks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleHealthStatusListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
