...
class InitiatorGroupFilterableFields(BaseModel):
    """
    InitiatorGroupFilterableFields
    """ # noqa: E501
    access_protocol: Optional[StrictStr] = Field(default=None, description="Initiator group access protocol. Possible values: 'iscsi', 'fc'.`Filter, Sort`")
    app_uuid: Optional[StrictStr] = Field(default=None, description="Application identifier of initiator group. String of up to 255 alphanumeric characters, hyphen, colon, dot and underscore are allowed.`Filter, Sort`")
    ...
    id: Optional[StrictStr] = Field(default=None, description="Identifier for initiator group. A 42 digit hexadecimal number. `Filter`")
    name: Optional[StrictStr] = Field(default=None, description="Name of initiator group. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.`Filter, Sort`")
