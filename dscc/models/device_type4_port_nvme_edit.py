...
class DeviceType4PortNVMeEdit(BaseModel):
    """
    ...
    vlans: Optional[List[Optional[DeviceType4PortNVMeEditVlansInner]]] = Field(default=None, description="Port VLANs information. Specifying VLAN id is mandatory to configure VLAN.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "mtu": obj.get("mtu"),
            "vlans": [DeviceType4PortNVMeEditVlansInner.from_dict(_item) for _item in obj["vlans"]] if obj.get("vlans") is not None else None
        })
        return _obj
