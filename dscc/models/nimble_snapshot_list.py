...
class NimbleSnapshotList(BaseModel):
    """
    NimbleSnapshotList
    """ # noqa: E501
    items: Optional[List[Optional[NimbleSnapshot]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for volume snapshot objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of snapshots associated with a volume.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleSnapshot.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
