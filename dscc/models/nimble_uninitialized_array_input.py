...
class NimbleUninitializedArrayInput(BaseModel):
    """
    get uninitialized array input.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(description="Identifier for the uninitialized array. A 42 digit hexadecimal number")
