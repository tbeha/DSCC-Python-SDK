...
class NimbleDiskCommon(BaseModel):
    """
    NimbleDiskCommon
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["associated_links", "bank", "block_type", "commonResourceAttributes", "consoleUri", "customerId", "disk_internal_stat1", "disk_op", "disk_type", "firmware_version", "force", "generation", "hba", "is_dfc", "partial_response_ok", "path", "port", "raid_id", "raid_resync_average_speed", "raid_resync_current_speed", "raid_resync_percent", "raid_state", "resourceUri", "shelf_location", "shelf_location_id", "size", "slot", "smart_attribute_list", "type", "vendor", "vshelf_id"]
