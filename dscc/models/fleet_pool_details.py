...
class FleetPoolDetails(BaseModel):
    """
    FleetPoolDetails
    """ # noqa: E501
    associated_links: Optional[List[FleetAssociatedLinksInner]] = Field(default=None, description="Associated Links Details", alias="associatedLinks")
    capacity_used: Optional[StrictInt] = Field(default=None, description="Capacity Used", alias="capacityUsed")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "capacityUsed", "customerId", "generation", "id", "name", "resourceUri", "systemId", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associatedLinks": [FleetAssociatedLinksInner.from_dict(_item) for _item in obj["associatedLinks"]] if obj.get("associatedLinks") is not None else None,
            "capacityUsed": obj.get("capacityUsed"),
