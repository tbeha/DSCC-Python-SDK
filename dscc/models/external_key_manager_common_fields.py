...
class ExternalKeyManagerCommonFields(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["active", "commonResourceAttributes", "consoleUri", "description", "hostname", "port", "protocol", "resourceUri", "status", "username"]
