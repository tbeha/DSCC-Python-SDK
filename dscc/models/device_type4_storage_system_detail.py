...
class DeviceType4StorageSystemDetail(BaseModel):
    """
    ...
    software_versions: Optional[DeviceType4softwareVersionsSolo] = Field(default=None, alias="softwareVersions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "softwareVersions": DeviceType4softwareVersionsSolo.from_dict(obj["softwareVersions"]) if obj.get("softwareVersions") is not None else None,
