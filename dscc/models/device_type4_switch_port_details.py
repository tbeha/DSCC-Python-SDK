...
class DeviceType4SwitchPortDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "device", "devicePort", "displayname", "domain", "enclosure", "generation", "id", "ipAddress", "macAddress", "portDescription", "requestUri", "resourceUri", "state", "switchName", "switchPortId", "switchUid", "systemId", "type"]
