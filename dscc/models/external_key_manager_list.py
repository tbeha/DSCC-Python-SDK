...
class ExternalKeyManagerList(BaseModel):
    """
    ExternalKeyManagerList
    """ # noqa: E501
    items: Optional[List[Optional[ExternalKeyManager]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for external key manager", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of external key managers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExternalKeyManager.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
