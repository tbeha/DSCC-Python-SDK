...
class InitiatorList(BaseModel):
    """
    InitiatorList
    """ # noqa: E501
    items: Optional[List[Optional[Initiator]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of host initiators")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Initiator.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
