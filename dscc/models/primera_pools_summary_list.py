...
class PrimeraPoolsSummaryList(BaseModel):
    """
    PrimeraPoolsSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[PrimeraPoolList]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PrimeraPoolList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
