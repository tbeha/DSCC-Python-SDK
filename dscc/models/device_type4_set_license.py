...
class DeviceType4SetLicense(BaseModel):
    """
    DeviceType4SetLicense
    """ # noqa: E501
    parameters: Optional[DeviceType4SetLicenseParameters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": DeviceType4SetLicenseParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
