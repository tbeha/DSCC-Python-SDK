...
class DeviceType4InventoryUpdateChange(BaseModel):
    """
    HPE Alletra Storage MP InventoryUpdate details
    """ # noqa: E501
    change: Optional[StrictStr] = Field(default=None, description="Added or Removed")
    index: Optional[StrictInt] = Field(default=None, description="index of the update")
    log_time: Optional[StrictInt] = Field(default=None, description="log time", alias="logTime")
    manufacturing: Optional[DeviceType4ManufacturingSingle] = None
    __properties: ClassVar[List[str]] = ["change", "index", "logTime", "manufacturing"]
