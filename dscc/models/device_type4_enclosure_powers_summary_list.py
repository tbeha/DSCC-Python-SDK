...
class DeviceType4EnclosurePowersSummaryList(BaseModel):
    """
    DeviceType4EnclosurePowersSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4enclosurePowersList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure powers object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosure cards")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosurePowersList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
