...
class DeviceType4enclosureDiskLoop(BaseModel):
    """
    DeviceType4enclosureDiskLoop
    """ # noqa: E501
    alpa: Optional[StrictInt] = None
    state: Optional[DeviceType4State] = None
    __properties: ClassVar[List[str]] = ["alpa", "state"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if alpa (nullable) is None
        # and model_fields_set contains the field
        if self.alpa is None and "alpa" in self.model_fields_set:
            _dict['alpa'] = None
