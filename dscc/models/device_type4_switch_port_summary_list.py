...
class DeviceType4SwitchPortSummaryList(BaseModel):
    """
    DeviceType4SwitchPortSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4SwitchPortList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed switch port object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of switch Ports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4SwitchPortList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
