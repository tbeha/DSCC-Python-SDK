...
class DeviceType4VlunsListSingle(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="uid of the vlun")
    initiators: Optional[DeviceType4VlunsListSingleInitiators] = None
    lun: Optional[StrictInt] = Field(default=None, description="Exported LUN ID")
    ...
    port_pos: Optional[DeviceType4VlunsListSinglePortPos] = Field(default=None, alias="portPos")
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed vlun object", alias="requestUri")
    ...
    system_id: Optional[StrictStr] = Field(default=None, description="SED state", alias="systemId")
    tpg_id: Optional[StrictInt] = Field(default=None, description="SED state", alias="tpgId")
    type: Optional[StrictStr] = Field(default=None, description="VLUN type")
    ...
    volume_name: Optional[StrictStr] = Field(default=None, description="Name of exported virtual volume or volume set name", alias="volumeName")
    volume_wwn: Optional[StrictStr] = Field(default=None, description="WWN of exported volume.If a volume set is exported, then this value is null.", alias="volumeWWN")
    ...
    __properties: ClassVar[List[str]] = ["active", "commonResourceAttributes", "consoleUri", "deviceWWNs", "diskPartition", "displayname", "domain", "failedPathInterval", "failedPathPolicy", "id", "initiators", "lun", "mountPoint", "mountPointFsau", "multiPathType", "portPos", "rawVolume", "remoteName", "requestUri", "resourceUri", "state", "status", "systemId", "tpgId", "type", "usedSpace", "volumeGroup", "volumeManager", "volumeName", "volumeWWN", "vvReservedUserSpace", "vvSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "portPos": DeviceType4VlunsListSinglePortPos.from_dict(obj["portPos"]) if obj.get("portPos") is not None else None,
