...
class NimbleSnapshotDetails(BaseModel):
    """
    NimbleSnapshotDetails
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed volume snapshot objects", alias="requestUri")
    ...
    snapshot_export_details: Optional[NimbleVolumeExportDetails] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of snapshot_export_details
        if self.snapshot_export_details:
            _dict['snapshot_export_details'] = self.snapshot_export_details.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshot_export_details": NimbleVolumeExportDetails.from_dict(obj["snapshot_export_details"]) if obj.get("snapshot_export_details") is not None else None
        })
        return _obj
