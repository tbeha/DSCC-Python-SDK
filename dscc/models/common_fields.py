...
class CommonFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associated_links", "commonResourceAttributes", "consoleUri", "creation_time", "customerId", "description", "generation", "last_modified", "metadata", "port", "resourceUri", "type", "username"]
