...
class ReplicationPartnerVolumeListRemoteVolume(BaseModel):
    """
    ...
    volume_last_sync_time: Optional[SyncTime] = Field(default=None, alias="volumeLastSyncTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumeLastSyncTime": SyncTime.from_dict(obj["volumeLastSyncTime"]) if obj.get("volumeLastSyncTime") is not None else None,
