...
class Initiator(BaseModel):
    ...
    Initiator
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Address of the initiator. `Filter`")
    ...
    hosts: Optional[List[Optional[HostSummaryForInitiatorObject]]] = Field(default=None, description="List of hosts.")
    ...
    __properties: ClassVar[List[str]] = ["address", "associatedLinks", "customerId", "driverVersion", "firmwareVersion", "generation", "hbaModel", "hostSpeed", "hosts", "id", "ipAddress", "name", "protocol", "systems", "type", "vendor"]
