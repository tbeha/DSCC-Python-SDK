...
class NimbleInitiator(BaseModel):
    """
    NimbleInitiator
    """ # noqa: E501
    access_protocol: Optional[StrictStr] = Field(default=None, description="Access protocol used by the initiator. Possible values: 'iscsi', 'fc'. `Filter, Sort`")
    ...
    chapuser_id: Optional[StrictStr] = Field(default=None, description="Identifier for the CHAP user.`Filter, Sort`")
    ...
    id: Optional[StrictStr] = Field(default=None, description="Identifier for initiator. A 42 digit hexadecimal number. `Filter`")
    initiator_group_id: Optional[StrictStr] = Field(default=None, description="Identifier of the initiator group that this initiator is assigned to. A 42 digit hexadecimal number. `Filter, Sort`")
    initiator_group_name: Optional[StrictStr] = Field(default=None, description="Name of the initiator group that this initiator is assigned to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character `Filter, Sort`")
    ...
    label: Optional[StrictStr] = Field(default=None, description="Unique Identifier of the iSCSI initiator. Label is required when creating iSCSI initiator. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`")
    ...
    __properties: ClassVar[List[str]] = ["access_protocol", "alias", "associated_links", "chapuser_id", "commonResourceAttributes", "consoleUri", "creation_time", "customerId", "generation", "id", "initiator_group_id", "initiator_group_name", "ip_address", "iqn", "label", "last_modified", "override_existing_alias", "resourceUri", "sc_HostInitiatorId", "type", "wwpn"]
