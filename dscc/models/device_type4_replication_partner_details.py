...
class DeviceType4ReplicationPartnerDetails(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="Unique id of the replication partner.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the replication partner.")
    replication_partner_type: Optional[StrictStr] = Field(default=None, description="Link protocol type.", alias="replicationPartnerType")
    status: Optional[StrictStr] = Field(default=None, description="Status of the partner. Possible values - New, Ready, Unsupported, Failing, Failed or Disabled.")
    ...
    replication_partner_links: Optional[DeviceType4RemoteCopyLinks] = Field(default=None, alias="replicationPartnerLinks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replicationPartnerLinks": DeviceType4RemoteCopyLinks.from_dict(obj["replicationPartnerLinks"]) if obj.get("replicationPartnerLinks") is not None else None,
