...
class SnapSummary(BaseModel):
    ...
    """ # noqa: E501
    snap_creation_time: Optional[StrictInt] = Field(default=None, description="Creation time of snapshot.")
    ...
    __properties: ClassVar[List[str]] = ["snap_creation_time", "snap_id", "snap_name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if snap_creation_time (nullable) is None
        # and model_fields_set contains the field
        if self.snap_creation_time is None and "snap_creation_time" in self.model_fields_set:
            _dict['snap_creation_time'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "snap_creation_time": obj.get("snap_creation_time"),
