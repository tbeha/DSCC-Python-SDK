...
class CreateAppSetInput(BaseModel):
    """
    ...
    app_set_type: Optional[VolumeSetApplicationType] = Field(alias="appSetType")
    create_app_set_qos_config_input: Optional[CreateAppSetQosConfigInput] = Field(default=None, alias="createAppSetQosConfigInput")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createAppSetQosConfigInput": CreateAppSetQosConfigInput.from_dict(obj["createAppSetQosConfigInput"]) if obj.get("createAppSetQosConfigInput") is not None else None,
