...
class DeviceType4ReplicationPartnerList(BaseModel):
    """
    ...
    group_last_sync_time: Optional[DeviceType4SyncTime] = Field(default=None, alias="groupLastSyncTime")
    ...
    __properties: ClassVar[List[str]] = ["commonResourceAttributes", "customerId", "displayName", "domain", "drState", "generation", "groupId", "groupLastSyncTime", "groupName", "groupObjectId", "id", "isProtectionPolicyConfigured", "isRemoteArraySupportReplication", "isSourceArraySupportReplication", "mode", "policies", "protectionType", "remoteRole", "remoteUsrCPG", "remoteVolumeSetName", "replicationTraffic", "resourceUri", "role", "roleReversed", "snapFrequencySecs", "state", "syncPeriod", "systemId", "systemName", "systemWWN", "targetName", "type", "volumeCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groupLastSyncTime": DeviceType4SyncTime.from_dict(obj["groupLastSyncTime"]) if obj.get("groupLastSyncTime") is not None else None,
