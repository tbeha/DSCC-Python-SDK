...
class DeviceType4VolumePerformanceHistoryHistoryData(BaseModel):
    """
    performance history data
    """ # noqa: E501
    iops_metrics_data: Optional[DeviceType4historicalMetricData] = Field(default=None, alias="iopsMetricsData")
    iosz_metrics_data_kbs: Optional[DeviceType4historicalMetricData] = Field(default=None, alias="ioszMetricsDataKbs")
    latency_metrics_data_ms: Optional[DeviceType4historicalMetricData] = Field(default=None, alias="latencyMetricsDataMs")
    qlen_metrics_data: Optional[DeviceType4QlenMetricDataValue] = Field(default=None, alias="qlenMetricsData")
    throughput_metrics_data_kbps: Optional[DeviceType4historicalMetricData] = Field(default=None, alias="throughputMetricsDataKbps")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iopsMetricsData": DeviceType4historicalMetricData.from_dict(obj["iopsMetricsData"]) if obj.get("iopsMetricsData") is not None else None,
            "ioszMetricsDataKbs": DeviceType4historicalMetricData.from_dict(obj["ioszMetricsDataKbs"]) if obj.get("ioszMetricsDataKbs") is not None else None,
            "latencyMetricsDataMs": DeviceType4historicalMetricData.from_dict(obj["latencyMetricsDataMs"]) if obj.get("latencyMetricsDataMs") is not None else None,
            "qlenMetricsData": DeviceType4QlenMetricDataValue.from_dict(obj["qlenMetricsData"]) if obj.get("qlenMetricsData") is not None else None,
            "throughputMetricsDataKbps": DeviceType4historicalMetricData.from_dict(obj["throughputMetricsDataKbps"]) if obj.get("throughputMetricsDataKbps") is not None else None
        })
        return _obj
