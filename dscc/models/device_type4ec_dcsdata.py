...
class DeviceType4ecDcsdata(BaseModel):
    """
    ...
    sas_status: Optional[StrictStr] = Field(default=None, alias="sasStatus")
    __properties: ClassVar[List[str]] = ["fwStatus", "fwVersion", "master", "sasStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sas_status (nullable) is None
        # and model_fields_set contains the field
        if self.sas_status is None and "sas_status" in self.model_fields_set:
            _dict['sasStatus'] = None
