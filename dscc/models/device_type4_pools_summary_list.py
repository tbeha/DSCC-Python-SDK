...
class DeviceType4PoolsSummaryList(BaseModel):
    """
    DeviceType4PoolsSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4PoolList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed storage-pool object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of storage-pools")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4PoolList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
