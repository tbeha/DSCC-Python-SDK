...
class NimblePortsListNetworkInterfaceItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["array_id", "controller_name", "id", "name", "array_name_or_serial", "controller_id", "ip_list", "is_present", "link_speed", "link_status", "mac", "max_link_speed", "mtu", "nic_type", "partial_response_ok", "port", "slot"]
