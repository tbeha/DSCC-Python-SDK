...
class DeviceType4enclosureSledList(BaseModel):
    """
    ...
    dc4data: Optional[DeviceType4esDc4data] = None
    ...
    enclosure_uid: Optional[StrictStr] = Field(default=None, description="Parent UID of the resource. `Filter`", alias="enclosureUid")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "dc4data", "diskCount", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "okIndicator", "portBypassA", "portBypassB", "power", "predFailIndicator", "protocol", "resourceUri", "safeToRemove", "sledId", "stateLoopA", "stateLoopB", "systemId", "temperature", "type", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dc4data": DeviceType4esDc4data.from_dict(obj["dc4data"]) if obj.get("dc4data") is not None else None,
