...
class VolumePerformanceDetails(BaseModel):
    """
    VolumePerformanceDetails
    """ # noqa: E501
    iops: Optional[KpiMetrics] = None
    latency_ms: Optional[KpiMetrics] = Field(default=None, alias="latencyMs")
    ...
    throughput_kbps: Optional[KpiMetrics] = Field(default=None, alias="throughputKbps")
    __properties: ClassVar[List[str]] = ["iops", "latencyMs", "requestUri", "resourceUri", "throughputKbps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iops": KpiMetrics.from_dict(obj["iops"]) if obj.get("iops") is not None else None,
            "latencyMs": KpiMetrics.from_dict(obj["latencyMs"]) if obj.get("latencyMs") is not None else None,
            "requestUri": obj.get("requestUri"),
            "resourceUri": obj.get("resourceUri"),
            "throughputKbps": KpiMetrics.from_dict(obj["throughputKbps"]) if obj.get("throughputKbps") is not None else None
        })
        return _obj
