...
class ExternalKeyManagerDetails(BaseModel):
    """
    ExternalKeyManagerDetails
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed external key manager objects", alias="requestUri")
    ...
    name: Optional[StrictStr] = Field(default='default', description="Name of External key manager.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "active", "commonResourceAttributes", "consoleUri", "description", "hostname", "port", "protocol", "resourceUri", "status", "username"]
