...
class DeviceType4enclosureDiskList(BaseModel):
    """
    ...
    enclosure_type: Optional[DeviceType4enclosureType] = Field(default=None, alias="enclosureType")
    ...
    manufacturing: Optional[DeviceType4EnclosureDiskDetailsManufacturing] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "resourceUri", "systemId", "temperature", "type", "wwn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manufacturing": DeviceType4EnclosureDiskDetailsManufacturing.from_dict(obj["manufacturing"]) if obj.get("manufacturing") is not None else None,
            "name": obj.get("name"),
