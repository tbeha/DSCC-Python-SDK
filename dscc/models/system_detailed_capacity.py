...
class SystemDetailedCapacity(BaseModel):
    """
    SystemDetailedCapacity
    """ # noqa: E501
    snap_space: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total snap capacity", alias="snapSpace")
    volume_space: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total volume capacity", alias="volumeSpace")
