...
class DeviceType4ContactsEditDetails(BaseModel):
    """
    ...
    system_id: Optional[StrictStr] = Field(default=None, description="SystemUid/serialNumber of the array and this can not be changed", alias="systemId")
