...
class DeviceType4DisksSummaryList(BaseModel):
    """
    DeviceType4DisksSummaryList
    """ # noqa: E501
    items: Optional[List[DeviceType4disksList]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed disks object", alias="requestUri")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4disksList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
