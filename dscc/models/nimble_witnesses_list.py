...
class NimbleWitnessesList(BaseModel):
    """
    NimbleWitnessesList
    """ # noqa: E501
    items: Optional[List[Optional[NimbleWitness]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="Request Uri for witness objects", alias="requestUri")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleWitness.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
