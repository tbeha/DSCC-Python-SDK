...
class DeviceType4HostAgentLastUpdated(BaseModel):
    """
    HPE Alletra Storage MP Host Agent
    """ # noqa: E501
    ms: Optional[StrictInt] = Field(default=None, description="Epoch Time")
    tz: Optional[StrictStr] = Field(default=None, description="String Time")
