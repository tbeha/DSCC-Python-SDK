...
class DeviceType4TelemetryStatusLastSuccessfulConnectivityTestTime(BaseModel):
    """
    Last successful connectivity time.
    """ # noqa: E501
    ms: Optional[StrictInt] = Field(default=None, description="Epoch time in milliseconds")
    tz: Optional[StrictStr] = Field(default=None, description="Time zone name")
    __properties: ClassVar[List[str]] = ["ms", "tz"]
