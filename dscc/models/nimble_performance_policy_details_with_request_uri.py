...
class NimblePerformancePolicyDetailsWithRequestUri(BaseModel):
    """
    NimblePerformancePolicyDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed performance-policy object", alias="requestUri")
