...
class DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm(BaseModel):
    """
    DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4enclosureCardTpmDetails]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureCardTpmDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
