...
class DeviceType4ApplicationSetsList(BaseModel):
    """
    DeviceType4ApplicationSetsList
    """ # noqa: E501
    items: Optional[List[DeviceType4ApplicationSets]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total Number of Application sets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4ApplicationSets.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
