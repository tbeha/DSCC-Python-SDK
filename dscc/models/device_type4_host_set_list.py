...
class DeviceType4HostSetList(BaseModel):
    """
    List of HPE Alletra Storage MP Host Paths
    """ # noqa: E501
    items: Optional[List[DeviceType4HostSetListObj]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of hostsets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4HostSetListObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
