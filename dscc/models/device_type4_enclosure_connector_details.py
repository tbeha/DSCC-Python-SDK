...
class DeviceType4EnclosureConnectorDetails(BaseModel):
    """
    ...
    node_port: Optional[DeviceType4EnclosureConnectorDetailsNodePort] = Field(default=None, alias="nodePort")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of connection")
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "connector", "consoleUri", "currentSpeed", "customerId", "disabled", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardUid", "enclosureId", "enclosureName", "enclosureUid", "generation", "id", "ipv4Address", "ipv6Address", "label", "linkSpeed", "locate", "macAddress", "nodePort", "requestUri", "resourceUri", "slot", "systemId", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodePort": DeviceType4EnclosureConnectorDetailsNodePort.from_dict(obj["nodePort"]) if obj.get("nodePort") is not None else None,
