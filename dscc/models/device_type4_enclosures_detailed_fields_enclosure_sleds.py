...
class DeviceType4EnclosuresDetailedFieldsEnclosureSleds(BaseModel):
    """
    DeviceType4EnclosuresDetailedFieldsEnclosureSleds
    """ # noqa: E501
    items: Optional[List[DeviceType4enclosureSledLists]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Number of enclosureSleds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4enclosureSledLists.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
