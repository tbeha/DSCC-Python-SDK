...
class FleetVolumeDetails(BaseModel):
    """
    FleetVolumeDetails
    """ # noqa: E501
    ...
    health_state: Optional[StrictStr] = Field(default=None, description="Health State of volume.`", alias="healthState")
    host_written_capacity_mi_b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Host written data size in MiB.", alias="hostWrittenCapacityMiB")
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed volume object", alias="requestUri")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "consoleUri", "customerId", "generation", "healthState", "hostWrittenCapacityMiB", "id", "initiators", "isInternal", "isSystemVolume", "name", "productFamily", "requestUri", "resourceUri", "sizeMiB", "spaceWarning", "subType", "systemId", "thinSavings", "type", "usedCapacityPercent", "usedSizeMiB", "volumeSetId", "volumeType", "wwn"]
