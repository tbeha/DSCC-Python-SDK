...
class DeviceType4EncryptionActionsInput(BaseModel):
    """
    DeviceType4EncryptionActionsInput
    """ # noqa: E501
    parameters: Optional[DeviceType4EncryptionParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parameters": DeviceType4EncryptionParams.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
