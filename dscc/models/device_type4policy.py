...
class DeviceType4policy(BaseModel):
    """
    DeviceType4policy
    """ # noqa: E501
    file_service: Optional[StrictBool] = Field(default=None, alias="fileService")
    host_dif3par: Optional[StrictBool] = Field(default=None, description="host Dif 3par. This field is deprecated.", alias="hostDif3par")
    host_dif_std: Optional[StrictBool] = Field(default=None, description="host Dif Std. This field is deprecated.", alias="hostDifStd")
