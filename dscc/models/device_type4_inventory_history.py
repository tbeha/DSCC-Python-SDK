...
class DeviceType4InventoryHistory(BaseModel):
    """
    List of HPE Alletra Storage MP Inventory Updates
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4InventoryUpdate]]] = None
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of Inventory Updates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4InventoryUpdate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
