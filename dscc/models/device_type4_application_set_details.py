...
class DeviceType4ApplicationSetDetails(BaseModel):
    """
    ...
    app_set_qo_s_config: Optional[DeviceType4AppSetQoSConfig] = Field(default=None, alias="appSetQoSConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appSetQoSConfig": DeviceType4AppSetQoSConfig.from_dict(obj["appSetQoSConfig"]) if obj.get("appSetQoSConfig") is not None else None,
