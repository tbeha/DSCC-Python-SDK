...
class NimbleWitness(BaseModel):
    """
    NimbleWitness
    """ # noqa: E501
    host: Optional[StrictStr] = Field(default=None, description="Hostname or ip addresses of witness. Comma separated strings of up to 63 characters of hostname and/or ip addresses. Total length cannot exceed 255 characters. `Filter, Sort`")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the witness configuration. A 42 digit hexadecimal number. `Filter`")
    port: Optional[StrictInt] = Field(default=None, description="Port of witness. Positive integer value up to 65535 representing TCP/IP port. `Filter, Sort`")
    username: Optional[StrictStr] = Field(default=None, description="Username of witness. This has to be a non-root that can login to the witness host. String of up to 32 characters, beginning with a letter or number or period (.) or an underscore (_). It can include underscore (_), dash (-), period (.) and end with dollar ($) sign. `Filter, Sort`")
