...
class NodeBatteriesList(BaseModel):
    """
    NodeBatteriesList
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "chargeLevel", "commonResourceAttributes", "customerId", "dischargeLED", "displayname", "domain", "expirationDate", "faultLED", "fullyCharged", "generation", "id", "life", "locateEnabled", "manufacturing", "maxLife", "name", "nodeBatteryId", "powerSupplyId", "primaryNodeId", "resourceUri", "safeToRemove", "secondaryNodeId", "serviceLED", "state", "statusLED", "systemId", "testInProgress", "timeToCharge", "type"]
