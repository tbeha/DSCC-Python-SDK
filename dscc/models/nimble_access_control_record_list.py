...
class NimbleAccessControlRecordList(BaseModel):
    """
    NimbleAccessControlRecordList
    """ # noqa: E501
    items: Optional[List[NimbleAccessControlRecordListItemsInner]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for Access Control Record objects", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of Access Control Records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleAccessControlRecordListItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
