...
class LocalKeyManager(BaseModel):
    """
    LocalKeyManager
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the local key manager. A 42 digit hexadecimal number. `Filter`")
    name: Optional[StrictStr] = Field(default='default', description="Name of local key manager. `Filter, Sort`")
