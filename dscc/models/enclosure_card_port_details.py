...
class EnclosureCardPortDetails(BaseModel):
    """
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure fan object", alias="requestUri")
    resource_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed enclosure fan object", alias="resourceUri")
    sfp: Optional[FcPortSfpSingle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sfp": FcPortSfpSingle.from_dict(obj["sfp"]) if obj.get("sfp") is not None else None,
