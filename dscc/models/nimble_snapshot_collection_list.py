...
class NimbleSnapshotCollectionList(BaseModel):
    """
    NimbleSnapshotCollectionList
    """ # noqa: E501
    items: Optional[List[Optional[NimbleSnapshotCollection]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for sanpshot collecion objects of a volume collection", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Total number of snapshot collections associated with a volume collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [NimbleSnapshotCollection.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
