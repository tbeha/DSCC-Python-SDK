...
class IscsiInitiatorList(BaseModel):
    """
    IscsiInitiatorList
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the ISCSI Initiator. A 42 digit hexadecimal number.")
