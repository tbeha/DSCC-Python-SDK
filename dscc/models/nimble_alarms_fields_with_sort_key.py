...
class NimbleAlarmsFieldsWithSortKey(BaseModel):
    """
    ...
    activity: Optional[StrictStr] = Field(default=None, description="Description of activity performed and recorded in alarm. String of 1-1476 printable characters. `Filter, Sort`")
    ...
    __properties: ClassVar[List[str]] = ["ack_time", "activity", "array", "category", "curr_onset_event_id", "id", "next_notification_time", "object_id", "object_name", "object_type", "onset_time", "remind_every", "remind_every_unit", "severity", "status", "user_full_name", "user_id", "user_name"]
