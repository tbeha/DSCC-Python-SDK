...
class DeviceType4ReplicationPartnerCommonFieldsAssociatedLinksInner(BaseModel):
    """
    DeviceType4ReplicationPartnerCommonFieldsAssociatedLinksInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["resourceUri", "type"]
