...
class DeviceType4SupportedProtectionTypes(BaseModel):
    """
    Response body for supported protection types on an application set
    """ # noqa: E501
    async_partners: Optional[List[Optional[DeviceType4ReplicationPartner]]] = Field(default=None, description="List of potential replication partners that can be part of asynchronous protection policy", alias="asyncPartners")
    ...
    sync_partners: Optional[List[Optional[DeviceType4ReplicationPartner]]] = Field(default=None, description="List of potential replication partners that can be part of synchronous protection policy", alias="syncPartners")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asyncPartners": [DeviceType4ReplicationPartner.from_dict(_item) for _item in obj["asyncPartners"]] if obj.get("asyncPartners") is not None else None,
            ...
            "syncPartners": [DeviceType4ReplicationPartner.from_dict(_item) for _item in obj["syncPartners"]] if obj.get("syncPartners") is not None else None
        })
        return _obj
