...
class AlertContactsDetailsList(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["commonResourceAttributes", "company", "companyCode", "consoleUri", "country", "customerId", "fax", "firstName", "generation", "id", "includeSvcAlerts", "lastName", "notificationSeverities", "preferredLanguage", "primaryEmail", "primaryPhone", "receiveEmail", "receiveGrouped", "requestUri", "secondaryEmail", "secondaryPhone", "systemId", "systemSupportContact", "type"]
