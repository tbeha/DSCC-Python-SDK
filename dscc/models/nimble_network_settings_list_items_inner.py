...
class NimbleNetworkSettingsListItemsInner(BaseModel):
    """
    NimbleNetworkSettingsListItemsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for network settings. `Filter`")
    name: Optional[StrictStr] = Field(default=None, description="Name of the network configuration. Possible values: 'active', 'backup', 'draft'. `Filter, Sort`")
    role: Optional[StrictStr] = Field(default=None, description="Role of network configuration. Possible values: 'active', 'backup', 'draft'.  `Filter, Sort`")
