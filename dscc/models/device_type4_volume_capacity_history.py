...
class DeviceType4VolumeCapacityHistory(BaseModel):
    """
    volume capacity trends for given granularity
    """ # noqa: E501
    capacity_data: Optional[DeviceType4VolumeCapacityHistoryCapacityData] = Field(default=None, alias="capacityData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacityData": DeviceType4VolumeCapacityHistoryCapacityData.from_dict(obj["capacityData"]) if obj.get("capacityData") is not None else None,
