...
class NodeMemoryDetails(BaseModel):
    """
    NodeMemoryDetails
    """ # noqa: E501
    ...
    id: Optional[StrictStr] = Field(default=None, description="UUID string uniquely identifying the node object.")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "cacheType", "casLatency", "commonResourceAttributes", "consoleUri", "customerId", "displayname", "domain", "generation", "id", "jedecId", "manufacturing", "name", "nodeDeviceId", "nodeId", "nodeMemoryType", "partNumber", "requestUri", "resourceUri", "revision", "riser", "sizeMiB", "slot", "slotId", "systemId", "type"]
