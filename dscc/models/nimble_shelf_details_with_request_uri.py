...
class NimbleShelfDetailsWithRequestUri(BaseModel):
    """
    NimbleShelfDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed shelf object", alias="requestUri")
    array_id: Optional[StrictStr] = Field(default=None, description="ID of array the shelf belongs to.")
    array_name: Optional[StrictStr] = Field(default=None, description="Name of array the shelf belongs to.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the shelf.")
    model: Optional[StrictStr] = Field(default=None, description="Model of the shelf or head unit.")
    serial: Optional[StrictStr] = Field(default=None, description="The serial number of the chassis.")
    ...
    __properties: ClassVar[List[str]] = ["array_id", "array_name", "id", "model", "serial", "associated_links", "chassis_sensors", "chassis_type", "commonResourceAttributes", "consoleUri", "ctrlrs", "customerId", "disk_sets", "fan_overall_status", "generation", "model_ext", "psu_overall_status", "resourceUri", "temp_overall_status", "type"]
