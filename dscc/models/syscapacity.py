...
class Syscapacity(BaseModel):
    ...
    capacity_by_tier: Optional[CapacityByTier] = Field(default=None, alias="capacityByTier")
    capacity_detail: Optional[SystemDetailedCapacity] = Field(default=None, alias="capacityDetail")
    capacity_summary: Optional[SystemCapacitySummary] = Field(default=None, alias="capacitySummary")
    ...
    fc_capacity_summary: Optional[SystemCapacitySummary] = Field(default=None, alias="fcCapacitySummary")
    id: Optional[StrictStr] = Field(default=None, description="ID string uniquely identifying the object.")
    nl_capacity_summary: Optional[SystemCapacitySummary] = Field(default=None, alias="nlCapacitySummary")
    ...
    ssd_capacity_summary: Optional[SystemCapacitySummary] = Field(default=None, alias="ssdCapacitySummary")
    system_id: Optional[StrictStr] = Field(default=None, description="SystemId/serialNumber of the array.", alias="systemId")
    utilization_summary: Optional[UtilizationSummary] = Field(default=None, alias="utilizationSummary")
    __properties: ClassVar[List[str]] = ["associatedLinks", "capacityByTier", "capacityDetail", "capacitySummary", "commonResourceAttributes", "customerId", "fcCapacitySummary", "id", "nlCapacitySummary", "requestUri", "resourceUri", "ssdCapacitySummary", "systemId", "utilizationSummary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "capacityByTier": CapacityByTier.from_dict(obj["capacityByTier"]) if obj.get("capacityByTier") is not None else None,
            "capacityDetail": SystemDetailedCapacity.from_dict(obj["capacityDetail"]) if obj.get("capacityDetail") is not None else None,
            "capacitySummary": SystemCapacitySummary.from_dict(obj["capacitySummary"]) if obj.get("capacitySummary") is not None else None,
            ...
            "fcCapacitySummary": SystemCapacitySummary.from_dict(obj["fcCapacitySummary"]) if obj.get("fcCapacitySummary") is not None else None,
            "id": obj.get("id"),
            "nlCapacitySummary": SystemCapacitySummary.from_dict(obj["nlCapacitySummary"]) if obj.get("nlCapacitySummary") is not None else None,
            "requestUri": obj.get("requestUri"),
            "resourceUri": obj.get("resourceUri"),
            "ssdCapacitySummary": SystemCapacitySummary.from_dict(obj["ssdCapacitySummary"]) if obj.get("ssdCapacitySummary") is not None else None,
            "systemId": obj.get("systemId"),
            "utilizationSummary": UtilizationSummary.from_dict(obj["utilizationSummary"]) if obj.get("utilizationSummary") is not None else None
        })
        return _obj
