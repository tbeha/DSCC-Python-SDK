...
class NimbleVCollectionDetailsWithRequestUri(BaseModel):
    """
    NimbleVCollectionDetailsWithRequestUri
    """ # noqa: E501
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed folder object", alias="requestUri")
