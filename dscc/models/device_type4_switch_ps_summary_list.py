...
class DeviceType4SwitchPSSummaryList(BaseModel):
    """
    DeviceType4SwitchPSSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4SwitchPSList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="resourceUri for detailed switch object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of switch powersupplies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4SwitchPSList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
