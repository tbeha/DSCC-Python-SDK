...
class DeviceType4certificatesList(BaseModel):
    """
    ...
    service: Optional[StrictStr] = Field(default=None, description="Service name of the resource. `Filter`")
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of resource. `Filter`")
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "certType", "commonResourceAttributes", "commonname", "consoleUri", "customerId", "displayname", "domain", "enddate", "fingerprint", "generation", "id", "issuer", "pem", "serial", "service", "signaturetype", "startdate", "subject", "subjectaltname", "systemId", "text", "type", "uri", "vcGuid"]
