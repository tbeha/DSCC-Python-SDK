...
class DeviceType4esDc4data(BaseModel):
    """
    DeviceType4esDc4data
    """ # noqa: E501
    hpl_led: Optional[DeviceType4LED] = Field(default=None, alias="hplLED")
    left: Optional[StrictBool] = None
    right: Optional[StrictBool] = None
    system_led: Optional[DeviceType4LED] = Field(default=None, alias="systemLED")
