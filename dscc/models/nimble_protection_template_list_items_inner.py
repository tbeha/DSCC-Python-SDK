...
class NimbleProtectionTemplateListItemsInner(BaseModel):
    """
    NimbleProtectionTemplateListItemsInner
    """ # noqa: E501
    agent_hostname: Optional[StrictStr] = Field(default=None, description="Generic Backup agent hostname. Custom port number can be specified with agent hostname using \\\\\":\\\\\". `Filter, Sort`")
    app_cluster_name: Optional[StrictStr] = Field(default=None, description="If the application is running within a Windows cluster environment then this is the cluster name. `Filter, Sort`")
    app_id: Optional[StrictStr] = Field(default=None, description="Application ID running on the server. Application ID can only be specified if application synchronization is VSS.  Possible values:'exchange_dag', 'sql2012', 'sql2014', 'inval', 'sql2005', 'sql2016', 'exchange', 'sql2017', 'sql2018', 'hyperv'. `Filter, Sort`")
    ...
    app_sync: Optional[StrictStr] = Field(default=None, description="Application synchronization ({none|vss|vmware|generic}). Possible values:'vss', 'vmware', 'none', 'generic'. `Filter, Sort`")
    creation_time: Optional[StrictInt] = Field(default=None, description="Time when this protection template was created. `Filter, Sort`")
    id: Optional[StrictStr] = Field(default=None, description="Identifier for protection template. `Filter`")
    last_modified: Optional[StrictInt] = Field(default=None, description="Time when this protection template was last modified. `Filter, Sort`")
    name: Optional[StrictStr] = Field(default=None, description="Fully qualified name of protection template. `Filter, Sort`")
    vcenter_hostname: Optional[StrictStr] = Field(default=None, description="VMware vCenter hostname. Custom port number can be specified with vCenter hostname. `Filter, Sort`")
