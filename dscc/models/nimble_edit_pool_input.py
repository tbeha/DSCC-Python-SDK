...
class NimbleEditPoolInput(BaseModel):
    """
    Update pool attributes
    """ # noqa: E501
    array_list: Optional[List[Optional[EditPoolNimbleArrayDetail]]] = Field(default=None, description="List of arrays identified by their IDs, in the pool.")
    ...
    force: Optional[StrictBool] = Field(default=None, description="Forcibly delete the specified pool even if it contains deleted volumes whose space is being reclaimed. Forcibly remove an array from array_list via an update operation even if the array is not reachable. There should no volumes currently in the pool for the forced update operation to succeed.")
    is_default: Optional[StrictBool] = Field(default=None, description="Indicates if this is the default pool.")
    name: Optional[StrictStr] = Field(description="Name of pool. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.")
    __properties: ClassVar[List[str]] = ["array_list", "dedupe_all_volumes", "dedupe_capable", "description", "force", "is_default", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "array_list": [EditPoolNimbleArrayDetail.from_dict(_item) for _item in obj["array_list"]] if obj.get("array_list") is not None else None,
