...
class DeviceType4VolumePost(BaseModel):
    """
    DeviceType4VolumePost
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="Comment if any")
    custom_name: Optional[StrictStr] = Field(default=None, description="Name for snapshot", alias="customName")
    expire_secs: Optional[StrictInt] = Field(default=None, description="Expiration time in seconds", alias="expireSecs")
    name_pattern: Optional[DeviceType4NamePattern] = Field(alias="namePattern")
    ...
    __properties: ClassVar[List[str]] = ["comment", "customName", "expireSecs", "namePattern", "readOnly", "retainSecs"]
