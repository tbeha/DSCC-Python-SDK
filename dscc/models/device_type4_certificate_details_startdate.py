...
class DeviceType4CertificateDetailsStartdate(BaseModel):
    """
    Start date of the array certificate
    """ # noqa: E501
    ms: Optional[StrictInt] = Field(default=None, description="time in millisecond")
    tz: Optional[StrictStr] = Field(default=None, description="timezone")
