...
class DeviceType4SnapshotSetsSummaryList(BaseModel):
    """
    DeviceType4SnapshotSetsSummaryList
    """ # noqa: E501
    items: Optional[List[Optional[DeviceType4snapshotsetsList]]] = None
    ...
    request_uri: Optional[StrictStr] = Field(default=None, description="requestUri for detailed snapshots object", alias="requestUri")
    total: Optional[StrictInt] = Field(default=None, description="Number of snapshots")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceType4snapshotsetsList.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
