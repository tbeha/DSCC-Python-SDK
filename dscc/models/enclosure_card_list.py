...
class EnclosureCardList(BaseModel):
    """
    EnclosureCardList
    """ # noqa: E501
    ...
    dc4data: Optional[EcDc4data] = None
    dcsdata: Optional[EcDcsdata] = None
    ...
    __properties: ClassVar[List[str]] = ["associatedLinks", "commonResourceAttributes", "customerId", "dc4data", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "loopA", "loopB", "manufacturing", "name", "resourceUri", "safeToRemove", "systemId", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dc4data": EcDc4data.from_dict(obj["dc4data"]) if obj.get("dc4data") is not None else None,
            "dcsdata": EcDcsdata.from_dict(obj["dcsdata"]) if obj.get("dcsdata") is not None else None,
