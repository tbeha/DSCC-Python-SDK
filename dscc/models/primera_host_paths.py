...
class PrimeraHostPaths(BaseModel):
    """
    PrimeraHostPaths
    """ # noqa: E501
    ...
    common_resource_attributes: Optional[CommonResourceAttributesPrimeraHost] = Field(default=None, alias="commonResourceAttributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "commonResourceAttributes": CommonResourceAttributesPrimeraHost.from_dict(obj["commonResourceAttributes"]) if obj.get("commonResourceAttributes") is not None else None,
