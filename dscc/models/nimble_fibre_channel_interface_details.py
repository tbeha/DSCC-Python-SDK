...
class NimbleFibreChannelInterfaceDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["array_name_or_serial", "bus_location", "commonResourceAttributes", "consoleUri", "customerId", "fabric_info", "fc_port_name", "firmware_version", "generation", "link_info", "logical_port_number", "online", "orientation", "partial_response_ok", "peerzone", "port", "slot", "type"]
