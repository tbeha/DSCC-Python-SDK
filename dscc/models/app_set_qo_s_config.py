...
class AppSetQoSConfig(BaseModel):
    """
    AppSetQoSConfig
    """ # noqa: E501
    ...
    iops_max_limit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="iops Maximum Limit", alias="iopsMaxLimit")
    ...
    __properties: ClassVar[List[str]] = ["bandwidthMaxLimitKiB", "displayname", "domain", "enable", "generation", "id", "iopsMaxLimit", "lastModifiedEpoch", "systemUid", "systemWWN", "targetName", "targetType", "uid", "volumes"]
