...
**protection_policy_schedules** | [**List[NimbleCreateVolumesWorkflowInputProtectionPolicySchedulesInner]**](NimbleCreateVolumesWorkflowInputProtectionPolicySchedulesInner.md) | Protection Policy Schedule | [optional] 
