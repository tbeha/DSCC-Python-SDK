...
json = "{}"
# create an instance of PrimeraVolumeDetails from a JSON string
primera_volume_details_instance = PrimeraVolumeDetails.from_json(json)
# print the JSON string representation of the object
print(PrimeraVolumeDetails.to_json())

# convert the object into a dict
primera_volume_details_dict = primera_volume_details_instance.to_dict()
# create an instance of PrimeraVolumeDetails from a dict
primera_volume_details_from_dict = PrimeraVolumeDetails.from_dict(primera_volume_details_dict)
```
