...
device_type4_snapshot_capacity_instance = DeviceType4SnapshotCapacity.from_json(json)
# print the JSON string representation of the object
print(DeviceType4SnapshotCapacity.to_json())

# convert the object into a dict
device_type4_snapshot_capacity_dict = device_type4_snapshot_capacity_instance.to_dict()
# create an instance of DeviceType4SnapshotCapacity from a dict
device_type4_snapshot_capacity_from_dict = DeviceType4SnapshotCapacity.from_dict(device_type4_snapshot_capacity_dict)
```
