...
json = "{}"
# create an instance of ReplicationPartnerCommonFields from a JSON string
replication_partner_common_fields_instance = ReplicationPartnerCommonFields.from_json(json)
# print the JSON string representation of the object
print(ReplicationPartnerCommonFields.to_json())

# convert the object into a dict
replication_partner_common_fields_dict = replication_partner_common_fields_instance.to_dict()
# create an instance of ReplicationPartnerCommonFields from a dict
replication_partner_common_fields_from_dict = ReplicationPartnerCommonFields.from_dict(replication_partner_common_fields_dict)
```
