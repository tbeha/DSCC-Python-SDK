...
class TestDeviceType4enclosureSledLists(unittest.TestCase):
    """DeviceType4enclosureSledLists unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosureSledLists:
        """Test DeviceType4enclosureSledLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosureSledLists`
        """
        model = DeviceType4enclosureSledLists()
        if include_optional:
            return DeviceType4enclosureSledLists(
                customer_id = 'string',
    ...
    def testDeviceType4enclosureSledLists(self):
        """Test DeviceType4enclosureSledLists"""
