...
class TestNimbleDiskCommon(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleDiskCommon:
        """Test NimbleDiskCommon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleDiskCommon`
        """
        model = NimbleDiskCommon()
        if include_optional:
            return NimbleDiskCommon(
