...
class TestDeviceType4enclosureDiskList(unittest.TestCase):
    """DeviceType4enclosureDiskList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosureDiskList:
        """Test DeviceType4enclosureDiskList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosureDiskList`
        """
        model = DeviceType4enclosureDiskList()
        if include_optional:
            return DeviceType4enclosureDiskList(
    ...
    def testDeviceType4enclosureDiskList(self):
        """Test DeviceType4enclosureDiskList"""
