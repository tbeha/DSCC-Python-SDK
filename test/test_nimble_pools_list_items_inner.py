...
class TestNimblePoolsListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimblePoolsListItemsInner:
        """Test NimblePoolsListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimblePoolsListItemsInner`
        """
        model = NimblePoolsListItemsInner()
        if include_optional:
            return NimblePoolsListItemsInner(
