...
class TestDeviceType4Witness(unittest.TestCase):
    """DeviceType4Witness unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4Witness:
        """Test DeviceType4Witness
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4Witness`
        """
        model = DeviceType4Witness()
        if include_optional:
            return DeviceType4Witness(
    ...
    def testDeviceType4Witness(self):
        """Test DeviceType4Witness"""
