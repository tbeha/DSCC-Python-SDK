...
class TestDeviceType4SwitchPortSummaryList(unittest.TestCase):
    """DeviceType4SwitchPortSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SwitchPortSummaryList:
        """Test DeviceType4SwitchPortSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SwitchPortSummaryList`
        """
        model = DeviceType4SwitchPortSummaryList()
        if include_optional:
            return DeviceType4SwitchPortSummaryList(
                items = [
                    dscc.models.device_type4_switch_port_list.DeviceType4SwitchPortList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/switch-port',
                total = 1
            )
        else:
            return DeviceType4SwitchPortSummaryList(
    ...
    def testDeviceType4SwitchPortSummaryList(self):
        """Test DeviceType4SwitchPortSummaryList"""
