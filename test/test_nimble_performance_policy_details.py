...
class TestNimblePerformancePolicyDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimblePerformancePolicyDetails:
        """Test NimblePerformancePolicyDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimblePerformancePolicyDetails`
        """
        model = NimblePerformancePolicyDetails()
        if include_optional:
            return NimblePerformancePolicyDetails(
