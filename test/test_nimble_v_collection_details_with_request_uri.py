...
class TestNimbleVCollectionDetailsWithRequestUri(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleVCollectionDetailsWithRequestUri:
        """Test NimbleVCollectionDetailsWithRequestUri
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleVCollectionDetailsWithRequestUri`
        """
        model = NimbleVCollectionDetailsWithRequestUri()
        if include_optional:
            return NimbleVCollectionDetailsWithRequestUri(
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/volume-collections/2a0df0fe6f7dc7bb16000000000000000000004007',
