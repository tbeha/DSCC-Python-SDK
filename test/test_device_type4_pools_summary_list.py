...
class TestDeviceType4PoolsSummaryList(unittest.TestCase):
    """DeviceType4PoolsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4PoolsSummaryList:
        """Test DeviceType4PoolsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4PoolsSummaryList`
        """
        model = DeviceType4PoolsSummaryList()
        if include_optional:
            return DeviceType4PoolsSummaryList(
                items = [
                    dscc.models.device_type4_pool_list.DeviceType4PoolList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/api/v1/storage-systems/device-type4/7CE809P009/storage-pools',
                total = 1
            )
        else:
            return DeviceType4PoolsSummaryList(
    ...
    def testDeviceType4PoolsSummaryList(self):
        """Test DeviceType4PoolsSummaryList"""
