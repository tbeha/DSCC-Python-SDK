...
class TestWitnessCommon(unittest.TestCase):
    """WitnessCommon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WitnessCommon:
        """Test WitnessCommon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WitnessCommon`
        """
        model = WitnessCommon()
        if include_optional:
            return WitnessCommon(
