...
class TestEnclosureSledDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosureSledDetails:
        """Test EnclosureSledDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosureSledDetails`
        """
        model = EnclosureSledDetails()
        if include_optional:
            return EnclosureSledDetails(
                ...
                console_uri = 'data-ops-manager/storage-systems/device-type1/SGH014XGSP/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-sleds/8621946048c1cb24bdfc57e9b3b460ac',
                customer_id = 'string',
                dc4data = dscc.models.dc4data_single.dc4dataSingle(
                    hpl_led = 'LED_UNKNOWN', 
                    left = True, 
                    right = True, 
                ...
                protocol = 'SAS',
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-sleds/8621946048c1cb24bdfc57e9b3b460ac',
