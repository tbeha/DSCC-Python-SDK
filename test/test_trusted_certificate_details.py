...
class TestTrustedCertificateDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrustedCertificateDetails:
        """Test TrustedCertificateDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustedCertificateDetails`
        """
        model = TrustedCertificateDetails()
        if include_optional:
