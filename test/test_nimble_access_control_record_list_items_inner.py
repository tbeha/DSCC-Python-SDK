...
class TestNimbleAccessControlRecordListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleAccessControlRecordListItemsInner:
        """Test NimbleAccessControlRecordListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleAccessControlRecordListItemsInner`
        """
        model = NimbleAccessControlRecordListItemsInner()
        if include_optional:
            return NimbleAccessControlRecordListItemsInner(
                access_protocol = 'fc',
