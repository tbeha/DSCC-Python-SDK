...
class TestSystemSettingsDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemSettingsDetails:
        """Test SystemSettingsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSettingsDetails`
        """
        model = SystemSettingsDetails()
        if include_optional:
            return SystemSettingsDetails(
