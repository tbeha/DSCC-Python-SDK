...
class TestVolumePerformanceDetails(unittest.TestCase):
    """VolumePerformanceDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VolumePerformanceDetails:
        """Test VolumePerformanceDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VolumePerformanceDetails`
        """
        model = VolumePerformanceDetails()
        if include_optional:
            return VolumePerformanceDetails(
    ...
    def testVolumePerformanceDetails(self):
        """Test VolumePerformanceDetails"""
