...
class TestDeviceType4EnclosuresDetailedFieldsEnclosureDisks(unittest.TestCase):
    """DeviceType4EnclosuresDetailedFieldsEnclosureDisks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosuresDetailedFieldsEnclosureDisks:
        """Test DeviceType4EnclosuresDetailedFieldsEnclosureDisks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosuresDetailedFieldsEnclosureDisks`
        """
        model = DeviceType4EnclosuresDetailedFieldsEnclosureDisks()
        if include_optional:
            return DeviceType4EnclosuresDetailedFieldsEnclosureDisks(
                items = [
    ...
    def testDeviceType4EnclosuresDetailedFieldsEnclosureDisks(self):
        """Test DeviceType4EnclosuresDetailedFieldsEnclosureDisks"""
