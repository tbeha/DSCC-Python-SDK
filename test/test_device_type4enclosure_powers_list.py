...
class TestDeviceType4enclosurePowersList(unittest.TestCase):
    """DeviceType4enclosurePowersList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosurePowersList:
        """Test DeviceType4enclosurePowersList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosurePowersList`
        """
        model = DeviceType4enclosurePowersList()
        if include_optional:
            return DeviceType4enclosurePowersList(
                ac_status = '',
    ...
    def testDeviceType4enclosurePowersList(self):
        """Test DeviceType4enclosurePowersList"""
