...
class TestDeviceType4EnclosuresDetailedFieldsEnclosureSleds(unittest.TestCase):
    """DeviceType4EnclosuresDetailedFieldsEnclosureSleds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosuresDetailedFieldsEnclosureSleds:
        """Test DeviceType4EnclosuresDetailedFieldsEnclosureSleds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosuresDetailedFieldsEnclosureSleds`
        """
        model = DeviceType4EnclosuresDetailedFieldsEnclosureSleds()
        if include_optional:
            return DeviceType4EnclosuresDetailedFieldsEnclosureSleds(
                items = [
    ...
    def testDeviceType4EnclosuresDetailedFieldsEnclosureSleds(self):
        """Test DeviceType4EnclosuresDetailedFieldsEnclosureSleds"""
