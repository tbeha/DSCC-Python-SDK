...
class TestDeviceType4EnclosuresSummaryList(unittest.TestCase):
    """DeviceType4EnclosuresSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosuresSummaryList:
        """Test DeviceType4EnclosuresSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosuresSummaryList`
        """
        model = DeviceType4EnclosuresSummaryList()
        if include_optional:
            return DeviceType4EnclosuresSummaryList(
                items = [
                    dscc.models.device_type4enclosures_list.DeviceType4enclosuresList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/7CE751P312/enclosures',
                total = 1
            )
        else:
            return DeviceType4EnclosuresSummaryList(
    ...
    def testDeviceType4EnclosuresSummaryList(self):
        """Test DeviceType4EnclosuresSummaryList"""
