...
class TestNodeCpusSummaryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeCpusSummaryList:
        """Test NodeCpusSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeCpusSummaryList`
        """
        model = NodeCpusSummaryList()
        if include_optional:
            return NodeCpusSummaryList(
                items = [
                    dscc.models.node_cpu_list.nodeCpuList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC01F0FF/nodes/e9d353bf98fc1a6bdb90b824e3ca14b5/node-cpus',
                total = 2
            )
        else:
            return NodeCpusSummaryList(
