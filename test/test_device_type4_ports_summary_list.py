...
class TestDeviceType4PortsSummaryList(unittest.TestCase):
    """DeviceType4PortsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4PortsSummaryList:
        """Test DeviceType4PortsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4PortsSummaryList`
        """
        model = DeviceType4PortsSummaryList()
        if include_optional:
            return DeviceType4PortsSummaryList(
                items = [
                    dscc.models.device_type4ports_list.DeviceType4portsList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/7CE751P312/ports',
                total = 1
            )
        else:
            return DeviceType4PortsSummaryList(
    ...
    def testDeviceType4PortsSummaryList(self):
        """Test DeviceType4PortsSummaryList"""
