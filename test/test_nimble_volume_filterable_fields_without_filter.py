...
class TestNimbleVolumeFilterableFieldsWithoutFilter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleVolumeFilterableFieldsWithoutFilter:
        """Test NimbleVolumeFilterableFieldsWithoutFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleVolumeFilterableFieldsWithoutFilter`
        """
        model = NimbleVolumeFilterableFieldsWithoutFilter()
        if include_optional:
            return NimbleVolumeFilterableFieldsWithoutFilter(
