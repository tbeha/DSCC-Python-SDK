...
class TestSysPortManagement(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SysPortManagement:
        """Test SysPortManagement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SysPortManagement`
        """
        model = SysPortManagement()
        if include_optional:
            return SysPortManagement(
                ...
                new_ip_v4_data = dscc.models.address.Address(
                    active_node = 1, 
                    auto_sense = True, 
                    full_duplex = True, 
                    ip_address = '15.12.123.234', 
                    ...
                    state = dscc.models.state.State(
                        ...
                        overall = 'STATE_NORMAL', ), 
                    status = 'Active', ),
                new_ipv6_data = dscc.models.address.Address(
                    active_node = 1, 
                    auto_sense = True, 
                    full_duplex = True, 
                    ip_address = '15.12.123.234', 
