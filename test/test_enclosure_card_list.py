...
class TestEnclosureCardList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosureCardList:
        """Test EnclosureCardList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosureCardList`
        """
        model = EnclosureCardList()
        if include_optional:
            return EnclosureCardList(
