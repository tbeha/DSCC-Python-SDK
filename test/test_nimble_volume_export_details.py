...
class TestNimbleVolumeExportDetails(unittest.TestCase):
    """NimbleVolumeExportDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleVolumeExportDetails:
        """Test NimbleVolumeExportDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleVolumeExportDetails`
        """
        model = NimbleVolumeExportDetails()
        if include_optional:
            return NimbleVolumeExportDetails(
                host_groups = [
    ...
    def testNimbleVolumeExportDetails(self):
        """Test NimbleVolumeExportDetails"""
