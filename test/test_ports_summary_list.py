...
class TestPortsSummaryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PortsSummaryList:
        """Test PortsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortsSummaryList`
        """
        model = PortsSummaryList()
        if include_optional:
            return PortsSummaryList(
                items = [
                    dscc.models.ports_list.portsList(
                        ...
                        partner = dscc.models.partner.partner(
                            node_wwn_or_name = '', 
                            port_wwn_or_ip = '', 
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/7CE751P312/ports',
                total = 1
            )
        else:
            return PortsSummaryList(
