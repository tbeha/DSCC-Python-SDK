...
class TestDeviceType4SnapshotSetsSummaryList(unittest.TestCase):
    """DeviceType4SnapshotSetsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SnapshotSetsSummaryList:
        """Test DeviceType4SnapshotSetsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SnapshotSetsSummaryList`
        """
        model = DeviceType4SnapshotSetsSummaryList()
        if include_optional:
            return DeviceType4SnapshotSetsSummaryList(
                items = [
                    dscc.models.device_type4snapshotsets_list.DeviceType4snapshotsetsList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/snapshots',
                total = 1
            )
        else:
            return DeviceType4SnapshotSetsSummaryList(
    ...
    def testDeviceType4SnapshotSetsSummaryList(self):
        """Test DeviceType4SnapshotSetsSummaryList"""
