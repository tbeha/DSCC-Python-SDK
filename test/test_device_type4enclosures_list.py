...
class TestDeviceType4enclosuresList(unittest.TestCase):
    """DeviceType4enclosuresList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosuresList:
        """Test DeviceType4enclosuresList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosuresList`
        """
        model = DeviceType4enclosuresList()
        if include_optional:
            return DeviceType4enclosuresList(
    ...
    def testDeviceType4enclosuresList(self):
        """Test DeviceType4enclosuresList"""
