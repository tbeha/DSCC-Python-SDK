...
class TestDeviceType4VolumeDetails(unittest.TestCase):
    """DeviceType4VolumeDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4VolumeDetails:
        """Test DeviceType4VolumeDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4VolumeDetails`
        """
        model = DeviceType4VolumeDetails()
        if include_optional:
            return DeviceType4VolumeDetails(
                ...
                compression_policy = '',
                console_uri = 'data-ops-manager/storage-systems/device-type4/SGH014XGSP/volumes/{uid}',
                conversion_type = 'CONVERSIONTYPE_THIN',
                copy_of_id = 56,
                creation_time = dscc.models.device_type4calendar.DeviceType4calendar(
                    ms = 56, 
                    tz = '', ),
                ...
                rcopy_status = '',
                read_only = True,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/volumes/{uid}',
                resource_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/volumes/{uid}',
                retention_time = dscc.models.deprecated_device_type4calendar.DeprecatedDeviceType4calendar(
                    ms = 56, 
                    tz = '', ),
                ro_child_id = 56,
                rw_child_id = 56,
                ...
                snapshot_allocation_settings = dscc.models.deprecated_device_type4user_allocation_settings_single.DeprecatedDeviceType4userAllocationSettingsSingle(
                    ...
                    set_size = '', 
                    step_size = 56, ),
                space_calculation_time = dscc.models.deprecated_device_type4calendar.DeprecatedDeviceType4calendar(
                    ms = 56, 
                    tz = '', ),
                started = True,
                ...
                type = 'string',
                unref_space_freed_time = dscc.models.deprecated_device_type4calendar.DeprecatedDeviceType4calendar(
                    ms = 56, 
                    tz = '', ),
                user_alloc_limit = 56,
                ...
                volume_id = 56,
                volume_performance = dscc.models.device_type4_volume_performance.DeviceType4VolumePerformance(
                    common_resource_attributes = dscc.models.common_resource_attributes.commonResourceAttributes(
                        cloud_state = 'CONNECTED', ), 
    ...
    def testDeviceType4VolumeDetails(self):
        """Test DeviceType4VolumeDetails"""
