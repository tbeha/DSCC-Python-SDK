...
class TestNodePowerSuppliesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodePowerSuppliesList:
        """Test NodePowerSuppliesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodePowerSuppliesList`
        """
        model = NodePowerSuppliesList()
        if include_optional:
            return NodePowerSuppliesList(
