...
class TestSystemConfigParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemConfigParams:
        """Test SystemConfigParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemConfigParams`
        """
        model = SystemConfigParams()
        if include_optional:
            return SystemConfigParams(
                items = dscc.models.system_settings_details.systemSettingsDetails(
                    associated_links = [{"resourceUri":"/api/v1/storage-systems/device-type1/{id}","type":"systems"}], 
                    ...
                    encryption = dscc.models.encryption.encryption(
                        backup_saved = False, 
                        dar_state = 'normal', 
                        enabled = False, 
                        failed_disks = 2, 
                    ...
                    srinfo = dscc.models.system_settings_details_srinfo.systemSettingsDetails_srinfo(
                        percent_used = 2, 
                        total_capacity_mi_b = 90714, 
                        used_capacity_mi_b = 1559, ), 
                    supportcontact = dscc.models.contacts_details.ContactsDetails(
                        company = 'HPE', 
                        company_code = 'HPE', 
                        country = 'US', 
                        fax = 'fax_id', 
                    ...
                    system_id = '7CE751P312', 
                    system_parameters = dscc.models.system_settings_details_system_parameters.systemSettingsDetails_systemParameters(
                ...
                request_uri = '/api/v1/storage-systems/device-type1/7CE809P009/system-settings'
            )
        else:
            return SystemConfigParams(
        )
