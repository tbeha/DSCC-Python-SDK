...
class TestNimbleSnapshotCollectionCommon(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleSnapshotCollectionCommon:
        """Test NimbleSnapshotCollectionCommon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleSnapshotCollectionCommon`
        """
        model = NimbleSnapshotCollectionCommon()
        if include_optional:
            return NimbleSnapshotCollectionCommon(
                allow_writes = False,
