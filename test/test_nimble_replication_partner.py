...
class TestNimbleReplicationPartner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleReplicationPartner:
        """Test NimbleReplicationPartner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleReplicationPartner`
        """
        model = NimbleReplicationPartner()
        if include_optional:
            return NimbleReplicationPartner(
                array_serial = '',
                cfg_sync_status = '',
                creation_time = 3400,
