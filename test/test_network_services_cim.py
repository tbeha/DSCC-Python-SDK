...
class TestNetworkServicesCim(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetworkServicesCim:
        """Test NetworkServicesCim
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkServicesCim`
        """
        model = NetworkServicesCim()
        if include_optional:
            return NetworkServicesCim(
                items = dscc.models.cim_details.cimDetails(
                    associated_links = [{"resourceUri":"/api/v1/storage-systems/device-type1/{uid}","type":"systems"}], 
                    cim = dscc.models.cim.cim(
                        ...
                        type = 'cim-settings', ), 
                    system_id = '4UW0001540', ),
                request_uri = '/api/v1/storage-systems/device-type1/7CE751P312/network-services/cim'
            )
        else:
            return NetworkServicesCim(
        )
