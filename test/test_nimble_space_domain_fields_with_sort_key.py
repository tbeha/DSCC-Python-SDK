...
class TestNimbleSpaceDomainFieldsWithSortKey(unittest.TestCase):
    """NimbleSpaceDomainFieldsWithSortKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleSpaceDomainFieldsWithSortKey:
        """Test NimbleSpaceDomainFieldsWithSortKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleSpaceDomainFieldsWithSortKey`
        """
        model = NimbleSpaceDomainFieldsWithSortKey()
        if include_optional:
            return NimbleSpaceDomainFieldsWithSortKey(
    ...
    def testNimbleSpaceDomainFieldsWithSortKey(self):
        """Test NimbleSpaceDomainFieldsWithSortKey"""
