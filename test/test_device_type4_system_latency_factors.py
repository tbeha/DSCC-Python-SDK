...
class TestDeviceType4SystemLatencyFactors(unittest.TestCase):
    """DeviceType4SystemLatencyFactors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SystemLatencyFactors:
        """Test DeviceType4SystemLatencyFactors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SystemLatencyFactors`
        """
        model = DeviceType4SystemLatencyFactors()
        if include_optional:
            return DeviceType4SystemLatencyFactors(
                customer_id = '',
                end_time = 1669880791,
                ...
                system_factors_metrics = [
                    dscc.models.device_type4_factor_data.DeviceType4FactorData(
                        cpu_busy = 2.47, 
                        dack_ssd = 2.47, 
    ...
    def testDeviceType4SystemLatencyFactors(self):
        """Test DeviceType4SystemLatencyFactors"""
