...
class TestContactsEditDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContactsEditDetails:
        """Test ContactsEditDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactsEditDetails`
        """
        model = ContactsEditDetails()
        if include_optional:
            return ContactsEditDetails(
                company = 'HPE',
                company_code = 'HPE',
                country = 'US',
                fax = 'fax_id',
