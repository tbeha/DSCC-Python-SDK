...
class TestNimbleControllerDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleControllerDetails:
        """Test NimbleControllerDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleControllerDetails`
        """
        model = NimbleControllerDetails()
        if include_optional:
            return NimbleControllerDetails(
