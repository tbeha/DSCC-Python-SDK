...
class TestSystemConfigParamsEditInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemConfigParamsEditInput:
        """Test SystemConfigParamsEditInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemConfigParamsEditInput`
        """
        model = SystemConfigParamsEditInput()
        if include_optional:
            return SystemConfigParamsEditInput(
                ...
                support_contact = dscc.models.contacts_edit_details.ContactsEditDetails(
                    company = 'HPE', 
                    company_code = 'HPE', 
                    country = 'US', 
                    fax = 'fax_id', 
                ...
                system_parameters = dscc.models.system_config_params_edit_input_system_parameters.systemConfigParamsEditInput_systemParameters(
