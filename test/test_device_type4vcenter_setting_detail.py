...
class TestDeviceType4vcenterSettingDetail(unittest.TestCase):
    """DeviceType4vcenterSettingDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4vcenterSettingDetail:
        """Test DeviceType4vcenterSettingDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4vcenterSettingDetail`
        """
        model = DeviceType4vcenterSettingDetail()
        if include_optional:
            return DeviceType4vcenterSettingDetail(
                ...
                name = 'sample_vc_name',
                port = 162,
                request_uri = '/api/v1/storage-systems/device-type4/7CE809P009/vm-manager-settings/centerid123',
    ...
    def testDeviceType4vcenterSettingDetail(self):
        """Test DeviceType4vcenterSettingDetail"""
