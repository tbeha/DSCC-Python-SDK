...
class TestDeviceType4systemCapacitySummary(unittest.TestCase):
    """DeviceType4systemCapacitySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4systemCapacitySummary:
        """Test DeviceType4systemCapacitySummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4systemCapacitySummary`
        """
        model = DeviceType4systemCapacitySummary()
        if include_optional:
            return DeviceType4systemCapacitySummary(
    ...
    def testDeviceType4systemCapacitySummary(self):
        """Test DeviceType4systemCapacitySummary"""
