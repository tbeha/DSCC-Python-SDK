...
class TestNimblePoolDetailsWithRequestUri(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimblePoolDetailsWithRequestUri:
        """Test NimblePoolDetailsWithRequestUri
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimblePoolDetailsWithRequestUri`
        """
        model = NimblePoolDetailsWithRequestUri()
        if include_optional:
            return NimblePoolDetailsWithRequestUri(
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/storage-pools/2a0df0fe6f7dc7bb16000000000000000000004007',
