...
class TestNimbleVolumeCollectionListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleVolumeCollectionListItemsInner:
        """Test NimbleVolumeCollectionListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleVolumeCollectionListItemsInner`
        """
        model = NimbleVolumeCollectionListItemsInner()
        if include_optional:
            return NimbleVolumeCollectionListItemsInner(
