...
class TestEnclosuresSummaryList(unittest.TestCase):
    """EnclosuresSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnclosuresSummaryList:
        """Test EnclosuresSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosuresSummaryList`
        """
        model = EnclosuresSummaryList()
        if include_optional:
            return EnclosuresSummaryList(
                items = [
                    dscc.models.enclosures_list.enclosuresList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/7CE751P312/enclosures',
                total = 1
            )
        else:
            return EnclosuresSummaryList(
    ...
    def testEnclosuresSummaryList(self):
        """Test EnclosuresSummaryList"""
