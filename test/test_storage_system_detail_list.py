...
class TestStorageSystemDetailList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StorageSystemDetailList:
        """Test StorageSystemDetailList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageSystemDetailList`
        """
        model = StorageSystemDetailList()
        if include_optional:
            return StorageSystemDetailList(
                array_list = [
