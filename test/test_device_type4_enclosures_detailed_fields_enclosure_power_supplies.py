...
class TestDeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies(unittest.TestCase):
    """DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies:
        """Test DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies`
        """
        model = DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies()
        if include_optional:
            return DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies(
                items = [
    ...
    def testDeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies(self):
        """Test DeviceType4EnclosuresDetailedFieldsEnclosurePowerSupplies"""
