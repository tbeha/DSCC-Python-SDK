...
class TestPrimeraPoolList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrimeraPoolList:
        """Test PrimeraPoolList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraPoolList`
        """
        model = PrimeraPoolList()
        if include_optional:
            return PrimeraPoolList(
