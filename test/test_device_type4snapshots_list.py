...
class TestDeviceType4snapshotsList(unittest.TestCase):
    """DeviceType4snapshotsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4snapshotsList:
        """Test DeviceType4snapshotsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4snapshotsList`
        """
        model = DeviceType4snapshotsList()
        if include_optional:
            return DeviceType4snapshotsList(
    ...
    def testDeviceType4snapshotsList(self):
        """Test DeviceType4snapshotsList"""
