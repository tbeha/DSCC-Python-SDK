...
class TestDeviceType4cimDetails(unittest.TestCase):
    """DeviceType4cimDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4cimDetails:
        """Test DeviceType4cimDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4cimDetails`
        """
        model = DeviceType4cimDetails()
        if include_optional:
            return DeviceType4cimDetails(
    ...
    def testDeviceType4cimDetails(self):
        """Test DeviceType4cimDetails"""
