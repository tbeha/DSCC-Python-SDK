...
class TestNimbleNetworkSettingDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleNetworkSettingDetails:
        """Test NimbleNetworkSettingDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleNetworkSettingDetails`
        """
        model = NimbleNetworkSettingDetails()
        if include_optional:
            return NimbleNetworkSettingDetails(
