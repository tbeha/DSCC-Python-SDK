...
class TestDeviceType4enclosureCardDetails(unittest.TestCase):
    """DeviceType4enclosureCardDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosureCardDetails:
        """Test DeviceType4enclosureCardDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosureCardDetails`
        """
        model = DeviceType4enclosureCardDetails()
        if include_optional:
            return DeviceType4enclosureCardDetails(
                customer_id = 'string',
    ...
    def testDeviceType4enclosureCardDetails(self):
        """Test DeviceType4enclosureCardDetails"""
