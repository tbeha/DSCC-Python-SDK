...
class TestNimbleShelfDetailsWithRequestUri(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleShelfDetailsWithRequestUri:
        """Test NimbleShelfDetailsWithRequestUri
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleShelfDetailsWithRequestUri`
        """
        model = NimbleShelfDetailsWithRequestUri()
        if include_optional:
            return NimbleShelfDetailsWithRequestUri(
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/shelves/2a0df0fe6f7dc7bb16000000000000000000004007',
