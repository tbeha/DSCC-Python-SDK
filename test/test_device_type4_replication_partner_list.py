...
class TestDeviceType4ReplicationPartnerList(unittest.TestCase):
    """DeviceType4ReplicationPartnerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4ReplicationPartnerList:
        """Test DeviceType4ReplicationPartnerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4ReplicationPartnerList`
        """
        model = DeviceType4ReplicationPartnerList()
        if include_optional:
            return DeviceType4ReplicationPartnerList(
    ...
    def testDeviceType4ReplicationPartnerList(self):
        """Test DeviceType4ReplicationPartnerList"""
