...
class TestDeviceType4enclosureCdmDetails(unittest.TestCase):
    """DeviceType4enclosureCdmDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4enclosureCdmDetails:
        """Test DeviceType4enclosureCdmDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4enclosureCdmDetails`
        """
        model = DeviceType4enclosureCdmDetails()
        if include_optional:
            return DeviceType4enclosureCdmDetails(
    ...
    def testDeviceType4enclosureCdmDetails(self):
        """Test DeviceType4enclosureCdmDetails"""
