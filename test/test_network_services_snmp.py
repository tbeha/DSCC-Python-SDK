...
class TestNetworkServicesSnmp(unittest.TestCase):
    """NetworkServicesSnmp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkServicesSnmp:
        """Test NetworkServicesSnmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkServicesSnmp`
        """
        model = NetworkServicesSnmp()
        if include_optional:
            return NetworkServicesSnmp(
                items = dscc.models.snmp_mgr_details.snmpMgrDetails(
                    associated_links = [{"resourceUri":"/api/v1/storage-systems/device-type1/{uid}","type":"systems"}], 
                    snmp = dscc.models.snmp_details.snmpDetails(
                        items = [
                        ...
                        total = 1, ), 
                    system_id = '4UW0001540', ),
                request_uri = '/api/v1/storage-systems/device-type1/7CE751P312/network-services/snmp-mgr'
            )
        else:
            return NetworkServicesSnmp(
        )
    ...
    def testNetworkServicesSnmp(self):
        """Test NetworkServicesSnmp"""
