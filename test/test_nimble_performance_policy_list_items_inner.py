...
class TestNimblePerformancePolicyListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimblePerformancePolicyListItemsInner:
        """Test NimblePerformancePolicyListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimblePerformancePolicyListItemsInner`
        """
        model = NimblePerformancePolicyListItemsInner()
        if include_optional:
            return NimblePerformancePolicyListItemsInner(
                app_category = 'Backup',
                cache = False,
                cache_policy = 'normal',
                compress = True,
