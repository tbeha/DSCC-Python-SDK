...
class TestDeviceType4systemSettingsDetails(unittest.TestCase):
    """DeviceType4systemSettingsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4systemSettingsDetails:
        """Test DeviceType4systemSettingsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4systemSettingsDetails`
        """
        model = DeviceType4systemSettingsDetails()
        if include_optional:
            return DeviceType4systemSettingsDetails(
    ...
    def testDeviceType4systemSettingsDetails(self):
        """Test DeviceType4systemSettingsDetails"""
