...
class TestDeviceType4VlunsSummaryList(unittest.TestCase):
    """DeviceType4VlunsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4VlunsSummaryList:
        """Test DeviceType4VlunsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4VlunsSummaryList`
        """
        model = DeviceType4VlunsSummaryList()
        if include_optional:
            return DeviceType4VlunsSummaryList(
                items = [
                    dscc.models.device_type4vluns_list.DeviceType4vlunsList(
                        active = True, 
    ...
    def testDeviceType4VlunsSummaryList(self):
        """Test DeviceType4VlunsSummaryList"""
