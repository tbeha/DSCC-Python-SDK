...
class TestPrimeraApplicationSets(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrimeraApplicationSets:
        """Test PrimeraApplicationSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraApplicationSets`
        """
        model = PrimeraApplicationSets()
        if include_optional:
            return PrimeraApplicationSets(
