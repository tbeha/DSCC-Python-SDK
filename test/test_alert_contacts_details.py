...
class TestAlertContactsDetails(unittest.TestCase):
    """AlertContactsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertContactsDetails:
        """Test AlertContactsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertContactsDetails`
        """
        model = AlertContactsDetails()
        if include_optional:
            return AlertContactsDetails(
    ...
    def testAlertContactsDetails(self):
        """Test AlertContactsDetails"""
