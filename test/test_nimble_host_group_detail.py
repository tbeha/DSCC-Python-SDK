...
class TestNimbleHostGroupDetail(unittest.TestCase):
    """NimbleHostGroupDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleHostGroupDetail:
        """Test NimbleHostGroupDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleHostGroupDetail`
        """
        model = NimbleHostGroupDetail()
        if include_optional:
            return NimbleHostGroupDetail(
                hosts = [
    ...
    def testNimbleHostGroupDetail(self):
        """Test NimbleHostGroupDetail"""
