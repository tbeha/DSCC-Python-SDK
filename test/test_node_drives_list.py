...
class TestNodeDrivesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeDrivesList:
        """Test NodeDrivesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeDrivesList`
        """
        model = NodeDrivesList()
        if include_optional:
            return NodeDrivesList(
