...
class TestNimbleInitiatorsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleInitiatorsList:
        """Test NimbleInitiatorsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleInitiatorsList`
        """
        model = NimbleInitiatorsList()
        if include_optional:
            return NimbleInitiatorsList(
                items = [
                    dscc.models.nimble_initiator.NimbleInitiator(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/host-initiators',
                total = 1
            )
        else:
            return NimbleInitiatorsList(
