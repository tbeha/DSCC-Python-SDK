...
class TestNimbleEventsDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleEventsDetails:
        """Test NimbleEventsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleEventsDetails`
        """
        model = NimbleEventsDetails()
        if include_optional:
            return NimbleEventsDetails(
