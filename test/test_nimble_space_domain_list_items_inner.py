...
class TestNimbleSpaceDomainListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleSpaceDomainListItemsInner:
        """Test NimbleSpaceDomainListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleSpaceDomainListItemsInner`
        """
        model = NimbleSpaceDomainListItemsInner()
        if include_optional:
            return NimbleSpaceDomainListItemsInner(
