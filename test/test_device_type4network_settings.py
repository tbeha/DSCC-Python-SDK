...
class TestDeviceType4networkSettings(unittest.TestCase):
    """DeviceType4networkSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4networkSettings:
        """Test DeviceType4networkSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4networkSettings`
        """
        model = DeviceType4networkSettings()
        if include_optional:
            return DeviceType4networkSettings(
                port_management = dscc.models.device_type4sys_port_management.DeviceType4sysPortManagement(
                ...
                request_uri = '/api/v1/storage-systems/device-type4/7CE809P009/network-settings'
            )
        else:
            return DeviceType4networkSettings(
        )
    ...
    def testDeviceType4networkSettings(self):
        """Test DeviceType4networkSettings"""
