...
class TestDeviceType4PoolList(unittest.TestCase):
    """DeviceType4PoolList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4PoolList:
        """Test DeviceType4PoolList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4PoolList`
        """
        model = DeviceType4PoolList()
        if include_optional:
            return DeviceType4PoolList(
    ...
    def testDeviceType4PoolList(self):
        """Test DeviceType4PoolList"""
