...
class TestDeviceType4HostPathListObj(unittest.TestCase):
    """DeviceType4HostPathListObj unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4HostPathListObj:
        """Test DeviceType4HostPathListObj
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4HostPathListObj`
        """
        model = DeviceType4HostPathListObj()
        if include_optional:
            return DeviceType4HostPathListObj(
                ip_addr = '1.1.1.1',
    ...
    def testDeviceType4HostPathListObj(self):
        """Test DeviceType4HostPathListObj"""
