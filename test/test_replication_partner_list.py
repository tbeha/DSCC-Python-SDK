...
class TestReplicationPartnerList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReplicationPartnerList:
        """Test ReplicationPartnerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplicationPartnerList`
        """
        model = ReplicationPartnerList()
        if include_optional:
            return ReplicationPartnerList(
