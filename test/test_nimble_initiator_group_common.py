...
class TestNimbleInitiatorGroupCommon(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleInitiatorGroupCommon:
        """Test NimbleInitiatorGroupCommon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleInitiatorGroupCommon`
        """
        model = NimbleInitiatorGroupCommon()
        if include_optional:
            return NimbleInitiatorGroupCommon(
