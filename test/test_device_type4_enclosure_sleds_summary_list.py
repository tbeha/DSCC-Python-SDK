...
class TestDeviceType4EnclosureSledsSummaryList(unittest.TestCase):
    """DeviceType4EnclosureSledsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosureSledsSummaryList:
        """Test DeviceType4EnclosureSledsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosureSledsSummaryList`
        """
        model = DeviceType4EnclosureSledsSummaryList()
        if include_optional:
            return DeviceType4EnclosureSledsSummaryList(
                items = [
                    dscc.models.device_type4enclosure_sled_list.DeviceType4enclosureSledList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-sleds',
                total = 1
            )
        else:
            return DeviceType4EnclosureSledsSummaryList(
    ...
    def testDeviceType4EnclosureSledsSummaryList(self):
        """Test DeviceType4EnclosureSledsSummaryList"""
