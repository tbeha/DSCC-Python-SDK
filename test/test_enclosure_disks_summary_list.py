...
class TestEnclosureDisksSummaryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosureDisksSummaryList:
        """Test EnclosureDisksSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosureDisksSummaryList`
        """
        model = EnclosureDisksSummaryList()
        if include_optional:
            return EnclosureDisksSummaryList(
                items = [
                    dscc.models.enclosure_disk_list.enclosureDiskList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-disks',
                total = 1
            )
        else:
            return EnclosureDisksSummaryList(
