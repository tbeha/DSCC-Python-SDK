...
class TestDeviceType4snmpMgrDetails(unittest.TestCase):
    """DeviceType4snmpMgrDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4snmpMgrDetails:
        """Test DeviceType4snmpMgrDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4snmpMgrDetails`
        """
        model = DeviceType4snmpMgrDetails()
        if include_optional:
            return DeviceType4snmpMgrDetails(
    ...
    def testDeviceType4snmpMgrDetails(self):
        """Test DeviceType4snmpMgrDetails"""
