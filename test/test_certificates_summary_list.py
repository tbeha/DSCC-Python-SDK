...
class TestCertificatesSummaryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CertificatesSummaryList:
        """Test CertificatesSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificatesSummaryList`
        """
        model = CertificatesSummaryList()
        if include_optional:
            return CertificatesSummaryList(
                items = [
                    dscc.models.certificates_list.certificatesList(
                ...
                page_limit = 1,
                page_offset = 0,
                request_uri = '/api/v1/storage-systems/device-type1/7CE809P009/certificates',
                total = 1
            )
        else:
            return CertificatesSummaryList(
