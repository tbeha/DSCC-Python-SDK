...
class TestDeviceType4Vvolscs(unittest.TestCase):
    """DeviceType4Vvolscs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4Vvolscs:
        """Test DeviceType4Vvolscs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4Vvolscs`
        """
        model = DeviceType4Vvolscs()
        if include_optional:
            return DeviceType4Vvolscs(
                items = [
                    dscc.models.device_type4v_volsc_details.DeviceType4vVolscDetails(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/api/v1/storage-systems/device-type4/7CE751P312/network-services/vvolscs',
                total = 1
            )
        else:
            return DeviceType4Vvolscs(
    ...
    def testDeviceType4Vvolscs(self):
        """Test DeviceType4Vvolscs"""
