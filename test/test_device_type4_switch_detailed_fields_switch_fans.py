...
class TestDeviceType4SwitchDetailedFieldsSwitchFans(unittest.TestCase):
    """DeviceType4SwitchDetailedFieldsSwitchFans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SwitchDetailedFieldsSwitchFans:
        """Test DeviceType4SwitchDetailedFieldsSwitchFans
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SwitchDetailedFieldsSwitchFans`
        """
        model = DeviceType4SwitchDetailedFieldsSwitchFans()
        if include_optional:
            return DeviceType4SwitchDetailedFieldsSwitchFans(
                items = [
    ...
    def testDeviceType4SwitchDetailedFieldsSwitchFans(self):
        """Test DeviceType4SwitchDetailedFieldsSwitchFans"""
