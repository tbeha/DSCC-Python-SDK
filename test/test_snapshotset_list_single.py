...
class TestSnapshotsetListSingle(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnapshotsetListSingle:
        """Test SnapshotsetListSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotsetListSingle`
        """
        model = SnapshotsetListSingle()
        if include_optional:
