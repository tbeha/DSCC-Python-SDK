...
class TestDeviceType4SnapshotsetListSingle(unittest.TestCase):
    """DeviceType4SnapshotsetListSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SnapshotsetListSingle:
        """Test DeviceType4SnapshotsetListSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SnapshotsetListSingle`
        """
        model = DeviceType4SnapshotsetListSingle()
        if include_optional:
            return DeviceType4SnapshotsetListSingle(
                mode = 'RO',
    ...
    def testDeviceType4SnapshotsetListSingle(self):
        """Test DeviceType4SnapshotsetListSingle"""
