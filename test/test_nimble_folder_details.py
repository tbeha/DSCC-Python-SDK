...
class TestNimbleFolderDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleFolderDetails:
        """Test NimbleFolderDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleFolderDetails`
        """
        model = NimbleFolderDetails()
        if include_optional:
            return NimbleFolderDetails(
