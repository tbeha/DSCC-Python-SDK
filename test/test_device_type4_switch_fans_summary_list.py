...
class TestDeviceType4SwitchFansSummaryList(unittest.TestCase):
    """DeviceType4SwitchFansSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SwitchFansSummaryList:
        """Test DeviceType4SwitchFansSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SwitchFansSummaryList`
        """
        model = DeviceType4SwitchFansSummaryList()
        if include_optional:
            return DeviceType4SwitchFansSummaryList(
                items = [
                    dscc.models.device_type4_switch_fan_list.DeviceType4SwitchFanList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/switches/8621946048c1cb24bdfc57e9b3b460ac/switch-fans',
                total = 1
            )
        else:
            return DeviceType4SwitchFansSummaryList(
    ...
    def testDeviceType4SwitchFansSummaryList(self):
        """Test DeviceType4SwitchFansSummaryList"""
