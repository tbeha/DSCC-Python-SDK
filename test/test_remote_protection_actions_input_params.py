...
class TestRemoteProtectionActionsInputParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoteProtectionActionsInputParams:
        """Test RemoteProtectionActionsInputParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteProtectionActionsInputParams`
        """
        model = RemoteProtectionActionsInputParams()
        if include_optional:
            return RemoteProtectionActionsInputParams(
