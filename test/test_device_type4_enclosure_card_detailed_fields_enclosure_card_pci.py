...
class TestDeviceType4EnclosureCardDetailedFieldsEnclosureCardPci(unittest.TestCase):
    """DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci:
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci`
        """
        model = DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci()
        if include_optional:
            return DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci(
                items = [
    ...
    def testDeviceType4EnclosureCardDetailedFieldsEnclosureCardPci(self):
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardPci"""
