...
class TestDeviceType4VcenterSettingsSumarryList(unittest.TestCase):
    """DeviceType4VcenterSettingsSumarryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4VcenterSettingsSumarryList:
        """Test DeviceType4VcenterSettingsSumarryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4VcenterSettingsSumarryList`
        """
        model = DeviceType4VcenterSettingsSumarryList()
        if include_optional:
            return DeviceType4VcenterSettingsSumarryList(
                items = [
                    dscc.models.device_type4vcenter_setting_detail_list.DeviceType4vcenterSettingDetailList(
                ...
                page_limit = 1,
                page_offset = 0,
                request_uri = '/api/v1/storage-systems/device-type4/7CE809P009/vm-manager-settings',
                total = 1
            )
        else:
            return DeviceType4VcenterSettingsSumarryList(
    ...
    def testDeviceType4VcenterSettingsSumarryList(self):
        """Test DeviceType4VcenterSettingsSumarryList"""
