...
class TestDeviceType4HostPaths(unittest.TestCase):
    """DeviceType4HostPaths unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4HostPaths:
        """Test DeviceType4HostPaths
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4HostPaths`
        """
        model = DeviceType4HostPaths()
        if include_optional:
            return DeviceType4HostPaths(
                ip_addr = '1.1.1.1',
    ...
    def testDeviceType4HostPaths(self):
        """Test DeviceType4HostPaths"""
