...
class TestDeviceType4HostPathsForDeviceType4Host(unittest.TestCase):
    """DeviceType4HostPathsForDeviceType4Host unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4HostPathsForDeviceType4Host:
        """Test DeviceType4HostPathsForDeviceType4Host
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4HostPathsForDeviceType4Host`
        """
        model = DeviceType4HostPathsForDeviceType4Host()
        if include_optional:
            return DeviceType4HostPathsForDeviceType4Host(
                ip_addr = '1.1.1.1',
    ...
    def testDeviceType4HostPathsForDeviceType4Host(self):
        """Test DeviceType4HostPathsForDeviceType4Host"""
