...
class TestDeviceType4HostList(unittest.TestCase):
    """DeviceType4HostList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4HostList:
        """Test DeviceType4HostList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4HostList`
        """
        model = DeviceType4HostList()
        if include_optional:
            return DeviceType4HostList(
                items = [
                    dscc.models.device_type4_host_list_obj.DeviceType4HostListObj(
                        agent = dscc.models.device_type4_host_agent.DeviceType4HostAgent(
                        ...
                        common_resource_attributes = dscc.models.common_resource_attributes_device_type4_host.commonResourceAttributesDeviceType4Host(
                            cloud_state = 'CONNECTED', ), 
                        descriptors = dscc.models.device_type4_host_descriptors.DeviceType4HostDescriptors(
                            ip_addr = '1.1.1.1', 
                            comment = 'Comments', 
                            contact = '1234567788e', 
                            location = 'US', 
                        ...
                        host_id = 101780, 
                        hostpaths = [
                            dscc.models.device_type4_host_path_details_for_device_type4_host.DeviceType4HostPathDetailsForDeviceType4Host(
                                items = [
                        ...
                        min_lun_id = 10, 
                        name = 'test-host', 
                        persona = dscc.models.device_type4_persona.DeviceType4Persona(
                            capabilities = [
                                ''
                                ], 
                            id = 101780, 
                        ...
                        state = dscc.models.device_type4_host_state.DeviceType4HostState(
    ...
    def testDeviceType4HostList(self):
        """Test DeviceType4HostList"""
