...
class TestNimbleArrayDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleArrayDetails:
        """Test NimbleArrayDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleArrayDetails`
        """
        model = NimbleArrayDetails()
        if include_optional:
            return NimbleArrayDetails(
                all_flash = False,
