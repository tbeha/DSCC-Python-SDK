...
class TestDeviceType4HostPathList(unittest.TestCase):
    """DeviceType4HostPathList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4HostPathList:
        """Test DeviceType4HostPathList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4HostPathList`
        """
        model = DeviceType4HostPathList()
        if include_optional:
            return DeviceType4HostPathList(
                items = [
                    dscc.models.device_type4_host_path_list_obj.DeviceType4HostPathListObj(
                        ip_addr = '1.1.1.1', 
                        ...
                        common_resource_attributes = dscc.models.common_resource_attributes_device_type4_host_path.commonResourceAttributesDeviceType4HostPath(
    ...
    def testDeviceType4HostPathList(self):
        """Test DeviceType4HostPathList"""
