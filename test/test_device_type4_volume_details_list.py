...
class TestDeviceType4VolumeDetailsList(unittest.TestCase):
    """DeviceType4VolumeDetailsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4VolumeDetailsList:
        """Test DeviceType4VolumeDetailsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4VolumeDetailsList`
        """
        model = DeviceType4VolumeDetailsList()
        if include_optional:
            return DeviceType4VolumeDetailsList(
    ...
    def testDeviceType4VolumeDetailsList(self):
        """Test DeviceType4VolumeDetailsList"""
