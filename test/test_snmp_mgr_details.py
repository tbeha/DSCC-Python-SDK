...
class TestSnmpMgrDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnmpMgrDetails:
        """Test SnmpMgrDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnmpMgrDetails`
        """
        model = SnmpMgrDetails()
        if include_optional:
            return SnmpMgrDetails(
