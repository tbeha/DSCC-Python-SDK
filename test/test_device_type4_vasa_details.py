...
class TestDeviceType4VasaDetails(unittest.TestCase):
    """DeviceType4VasaDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4VasaDetails:
        """Test DeviceType4VasaDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4VasaDetails`
        """
        model = DeviceType4VasaDetails()
        if include_optional:
            return DeviceType4VasaDetails(
    ...
    def testDeviceType4VasaDetails(self):
        """Test DeviceType4VasaDetails"""
