...
class TestAlertContactsDetailsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AlertContactsDetailsList:
        """Test AlertContactsDetailsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertContactsDetailsList`
        """
        model = AlertContactsDetailsList()
        if include_optional:
