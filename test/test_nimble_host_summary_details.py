...
class TestNimbleHostSummaryDetails(unittest.TestCase):
    """NimbleHostSummaryDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleHostSummaryDetails:
        """Test NimbleHostSummaryDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleHostSummaryDetails`
        """
        model = NimbleHostSummaryDetails()
        if include_optional:
            return NimbleHostSummaryDetails(
                access_protocol = 'fc',
    ...
    def testNimbleHostSummaryDetails(self):
        """Test NimbleHostSummaryDetails"""
