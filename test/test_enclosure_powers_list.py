...
class TestEnclosurePowersList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosurePowersList:
        """Test EnclosurePowersList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosurePowersList`
        """
        model = EnclosurePowersList()
        if include_optional:
            return EnclosurePowersList(
                ac_status = '',
