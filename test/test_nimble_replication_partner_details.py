...
class TestNimbleReplicationPartnerDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleReplicationPartnerDetails:
        """Test NimbleReplicationPartnerDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleReplicationPartnerDetails`
        """
        model = NimbleReplicationPartnerDetails()
        if include_optional:
            return NimbleReplicationPartnerDetails(
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/replicationpartners/2a0df0fe6f7dc7bb16000000000000000000004009',
                array_serial = '',
                cfg_sync_status = '',
                creation_time = 3400,
