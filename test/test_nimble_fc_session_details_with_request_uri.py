...
class TestNimbleFCSessionDetailsWithRequestUri(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleFCSessionDetailsWithRequestUri:
        """Test NimbleFCSessionDetailsWithRequestUri
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleFCSessionDetailsWithRequestUri`
        """
        model = NimbleFCSessionDetailsWithRequestUri()
        if include_optional:
            return NimbleFCSessionDetailsWithRequestUri(
                request_uri = 'api/v1/storage-systems/device-type2/2a0df0fe6f7dc7bb16000000000000000000004817/fibre-channel-sessions/2a0df0fe6f7dc7bb16000000000000000000004007',
