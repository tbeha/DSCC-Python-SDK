...
class TestNimbleFibreChannelInterfaceDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleFibreChannelInterfaceDetails:
        """Test NimbleFibreChannelInterfaceDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleFibreChannelInterfaceDetails`
        """
        model = NimbleFibreChannelInterfaceDetails()
        if include_optional:
            return NimbleFibreChannelInterfaceDetails(
