...
class TestPrimeraHostPathListObj(unittest.TestCase):
    """PrimeraHostPathListObj unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimeraHostPathListObj:
        """Test PrimeraHostPathListObj
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraHostPathListObj`
        """
        model = PrimeraHostPathListObj()
        if include_optional:
            return PrimeraHostPathListObj(
                ip_addr = '1.1.1.1',
    ...
    def testPrimeraHostPathListObj(self):
        """Test PrimeraHostPathListObj"""
