...
class TestEnclosureSledList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosureSledList:
        """Test EnclosureSledList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosureSledList`
        """
        model = EnclosureSledList()
        if include_optional:
            return EnclosureSledList(
