...
class TestDeviceType4Hosts(unittest.TestCase):
    """DeviceType4Hosts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4Hosts:
        """Test DeviceType4Hosts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4Hosts`
        """
        model = DeviceType4Hosts()
        if include_optional:
            return DeviceType4Hosts(
