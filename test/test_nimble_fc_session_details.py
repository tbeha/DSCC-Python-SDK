...
class TestNimbleFCSessionDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleFCSessionDetails:
        """Test NimbleFCSessionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleFCSessionDetails`
        """
        model = NimbleFCSessionDetails()
        if include_optional:
            return NimbleFCSessionDetails(
