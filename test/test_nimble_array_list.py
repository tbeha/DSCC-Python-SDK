...
class TestNimbleArrayList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleArrayList:
        """Test NimbleArrayList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleArrayList`
        """
        model = NimbleArrayList()
        if include_optional:
            return NimbleArrayList(
                items = [
