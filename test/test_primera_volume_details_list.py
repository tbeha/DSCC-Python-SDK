...
class TestPrimeraVolumeDetailsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrimeraVolumeDetailsList:
        """Test PrimeraVolumeDetailsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraVolumeDetailsList`
        """
        model = PrimeraVolumeDetailsList()
        if include_optional:
            return PrimeraVolumeDetailsList(
                admin_allocation_settings = dscc.models.user_allocation_settings.userAllocationSettings(
                    ha = dscc.models.deprecated_device_type4user_allocation_settings_single_ha.DeprecatedDeviceType4userAllocationSettingsSingle_HA(
                        ...
                        key = 'hajbod-10', ), 
                    raid_type = '', 
                    device_speed = dscc.models.device_speed.deviceSpeed(
                        text = '', 
                        value = 56, ), 
                    device_type = '', 
                    disk_filter = '', 
                ...
                compression_policy = '',
                console_uri = '/block/volumes/device-type1/f9860a60fd9ff04d2bfa7663622ae401?systemUid=4UW0002936',
                ...
                snapshot_allocation_settings = dscc.models.user_allocation_settings.userAllocationSettings(
                    ha = dscc.models.deprecated_device_type4user_allocation_settings_single_ha.DeprecatedDeviceType4userAllocationSettingsSingle_HA(
                        default = 'Magazine', 
                        key = 'hajbod-10', ), 
                    raid_type = '', 
                ...
                user_allocation_settings = dscc.models.user_allocation_settings.userAllocationSettings(
                    ha = dscc.models.deprecated_device_type4user_allocation_settings_single_ha.DeprecatedDeviceType4userAllocationSettingsSingle_HA(
                        default = 'Magazine', 
                        key = 'hajbod-10', ), 
                    raid_type = '', 
                ...
                vlun_sector_size = 56,
                volume_id = 56,
                volume_performance = dscc.models.volume_performance_details.volumePerformanceDetails(
