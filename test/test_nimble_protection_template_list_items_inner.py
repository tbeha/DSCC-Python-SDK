...
class TestNimbleProtectionTemplateListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleProtectionTemplateListItemsInner:
        """Test NimbleProtectionTemplateListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleProtectionTemplateListItemsInner`
        """
        model = NimbleProtectionTemplateListItemsInner()
        if include_optional:
            return NimbleProtectionTemplateListItemsInner(
