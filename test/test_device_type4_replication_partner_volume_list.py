...
class TestDeviceType4ReplicationPartnerVolumeList(unittest.TestCase):
    """DeviceType4ReplicationPartnerVolumeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4ReplicationPartnerVolumeList:
        """Test DeviceType4ReplicationPartnerVolumeList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4ReplicationPartnerVolumeList`
        """
        model = DeviceType4ReplicationPartnerVolumeList()
        if include_optional:
            return DeviceType4ReplicationPartnerVolumeList(
    ...
    def testDeviceType4ReplicationPartnerVolumeList(self):
        """Test DeviceType4ReplicationPartnerVolumeList"""
