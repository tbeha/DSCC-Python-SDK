...
class TestEnclosurePowersSummaryList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnclosurePowersSummaryList:
        """Test EnclosurePowersSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosurePowersSummaryList`
        """
        model = EnclosurePowersSummaryList()
        if include_optional:
            return EnclosurePowersSummaryList(
                items = [
                    dscc.models.enclosure_powers_list.enclosurePowersList(
                        ac_status = '', 
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-powers',
                total = 1
            )
        else:
            return EnclosurePowersSummaryList(
