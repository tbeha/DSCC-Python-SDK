...
class TestDeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm(unittest.TestCase):
    """DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm:
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm`
        """
        model = DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm()
        if include_optional:
            return DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm(
                items = [
    ...
    def testDeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm(self):
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardTpm"""
