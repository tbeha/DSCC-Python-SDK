...
class TestNodeCardDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeCardDetails:
        """Test NodeCardDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeCardDetails`
        """
        model = NodeCardDetails()
        if include_optional:
            return NodeCardDetails(
                ...
                console_uri = 'data-ops-manager/storage-systems/device-type1/SGH014XGSP/nodes/e9d353bf98fc1a6bdb90b824e3ca14b5/node-cards/60c3831bf1e682693d0319c10333af92',
                customer_id = 'string',
                ...
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC018D94/nodes/e9d353bf98fc1a6bdb90b824e3ca14b5/node-cards/9aeec8a12315995e1efc340a79b6b5bd',
