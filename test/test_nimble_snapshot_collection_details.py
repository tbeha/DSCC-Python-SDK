...
class TestNimbleSnapshotCollectionDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleSnapshotCollectionDetails:
        """Test NimbleSnapshotCollectionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleSnapshotCollectionDetails`
        """
        model = NimbleSnapshotCollectionDetails()
        if include_optional:
