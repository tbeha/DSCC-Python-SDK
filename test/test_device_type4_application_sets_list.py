...
class TestDeviceType4ApplicationSetsList(unittest.TestCase):
    """DeviceType4ApplicationSetsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4ApplicationSetsList:
        """Test DeviceType4ApplicationSetsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4ApplicationSetsList`
        """
        model = DeviceType4ApplicationSetsList()
        if include_optional:
            return DeviceType4ApplicationSetsList(
                items = [
                    dscc.models.device_type4_application_sets.DeviceType4ApplicationSets(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC01F0FF/applicationsets',
                total = 1
            )
        else:
            return DeviceType4ApplicationSetsList(
    ...
    def testDeviceType4ApplicationSetsList(self):
        """Test DeviceType4ApplicationSetsList"""
