...
class TestPrimeraPoolsSummaryList(unittest.TestCase):
    """PrimeraPoolsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimeraPoolsSummaryList:
        """Test PrimeraPoolsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraPoolsSummaryList`
        """
        model = PrimeraPoolsSummaryList()
        if include_optional:
            return PrimeraPoolsSummaryList(
                items = [
                    dscc.models.primera_pool_list.primeraPoolList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/api/v1/storage-systems/device-type1/7CE809P009/storage-pools',
                total = 1
            )
        else:
            return PrimeraPoolsSummaryList(
    ...
    def testPrimeraPoolsSummaryList(self):
        """Test PrimeraPoolsSummaryList"""
