...
class TestNodeBatteriesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NodeBatteriesList:
        """Test NodeBatteriesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeBatteriesList`
        """
        model = NodeBatteriesList()
        if include_optional:
            return NodeBatteriesList(
