...
class TestNimbleSnapshotFilterableFields(unittest.TestCase):
    """NimbleSnapshotFilterableFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleSnapshotFilterableFields:
        """Test NimbleSnapshotFilterableFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleSnapshotFilterableFields`
        """
        model = NimbleSnapshotFilterableFields()
        if include_optional:
            return NimbleSnapshotFilterableFields(
    ...
    def testNimbleSnapshotFilterableFields(self):
        """Test NimbleSnapshotFilterableFields"""
