...
class TestNimbleControllerListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleControllerListItemsInner:
        """Test NimbleControllerListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleControllerListItemsInner`
        """
        model = NimbleControllerListItemsInner()
        if include_optional:
            return NimbleControllerListItemsInner(
