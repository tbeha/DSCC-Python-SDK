...
class TestPrimeraVolumesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrimeraVolumesList:
        """Test PrimeraVolumesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimeraVolumesList`
        """
        model = PrimeraVolumesList()
        if include_optional:
            return PrimeraVolumesList(
                items = [
                    dscc.models.primera_volume_details_list.PrimeraVolumeDetailsList(
