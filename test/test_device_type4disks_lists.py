...
class TestDeviceType4disksLists(unittest.TestCase):
    """DeviceType4disksLists unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4disksLists:
        """Test DeviceType4disksLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4disksLists`
        """
        model = DeviceType4disksLists()
        if include_optional:
            return DeviceType4disksLists(
    ...
    def testDeviceType4disksLists(self):
        """Test DeviceType4disksLists"""
