...
class TestDeviceType4EnclosureConnectorsSummaryList(unittest.TestCase):
    """DeviceType4EnclosureConnectorsSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosureConnectorsSummaryList:
        """Test DeviceType4EnclosureConnectorsSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosureConnectorsSummaryList`
        """
        model = DeviceType4EnclosureConnectorsSummaryList()
        if include_optional:
            return DeviceType4EnclosureConnectorsSummaryList(
                items = [
                    dscc.models.device_type4enclosure_connectors_list.DeviceType4enclosureConnectorsList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type4/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-connectors',
                total = 1
            )
        else:
            return DeviceType4EnclosureConnectorsSummaryList(
    ...
    def testDeviceType4EnclosureConnectorsSummaryList(self):
        """Test DeviceType4EnclosureConnectorsSummaryList"""
