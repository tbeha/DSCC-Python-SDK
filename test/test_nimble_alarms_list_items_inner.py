...
class TestNimbleAlarmsListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleAlarmsListItemsInner:
        """Test NimbleAlarmsListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleAlarmsListItemsInner`
        """
        model = NimbleAlarmsListItemsInner()
        if include_optional:
            return NimbleAlarmsListItemsInner(
                ack_time = 3400,
