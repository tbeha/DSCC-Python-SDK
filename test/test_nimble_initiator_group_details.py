...
class TestNimbleInitiatorGroupDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleInitiatorGroupDetails:
        """Test NimbleInitiatorGroupDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleInitiatorGroupDetails`
        """
        model = NimbleInitiatorGroupDetails()
        if include_optional:
            return NimbleInitiatorGroupDetails(
                request_uri = 'api/v1/storage-systems/devicetype2/2a0df0fe6f7dc7bb16000000000000000000004817/host-groups/2a0df0fe6f7dc7bb16000000000000000000004007',
