...
class TestNimbleNetworkInterfaceListItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NimbleNetworkInterfaceListItemsInner:
        """Test NimbleNetworkInterfaceListItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleNetworkInterfaceListItemsInner`
        """
        model = NimbleNetworkInterfaceListItemsInner()
        if include_optional:
            return NimbleNetworkInterfaceListItemsInner(
