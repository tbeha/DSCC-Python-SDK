...
class TestEnclosureFanSummaryList(unittest.TestCase):
    """EnclosureFanSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnclosureFanSummaryList:
        """Test EnclosureFanSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnclosureFanSummaryList`
        """
        model = EnclosureFanSummaryList()
        if include_optional:
            return EnclosureFanSummaryList(
                items = [
                    dscc.models.enclosure_fan_list.enclosureFanList(
                ...
                page_limit = 1,
                page_offset = 1,
                request_uri = '/v1/storage-systems/device-type1/2FF70002AC018D94/enclosures/9c3c4f29a82fd8d632ff379116fa0b8f/enclosure-fans',
                total = 1
            )
        else:
            return EnclosureFanSummaryList(
    ...
    def testEnclosureFanSummaryList(self):
        """Test EnclosureFanSummaryList"""
