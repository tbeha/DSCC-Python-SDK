...
class TestDeviceType4SwitchPSList(unittest.TestCase):
    """DeviceType4SwitchPSList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4SwitchPSList:
        """Test DeviceType4SwitchPSList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4SwitchPSList`
        """
        model = DeviceType4SwitchPSList()
        if include_optional:
            return DeviceType4SwitchPSList(
    ...
    def testDeviceType4SwitchPSList(self):
        """Test DeviceType4SwitchPSList"""
