...
class TestDeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu(unittest.TestCase):
    """DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu:
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu`
        """
        model = DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu()
        if include_optional:
            return DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu(
                items = [
    ...
    def testDeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu(self):
        """Test DeviceType4EnclosureCardDetailedFieldsEnclosureCardCpu"""
