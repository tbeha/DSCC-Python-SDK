...
class TestNimbleAccessControlRecordFieldsWithSortKey(unittest.TestCase):
    """NimbleAccessControlRecordFieldsWithSortKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NimbleAccessControlRecordFieldsWithSortKey:
        """Test NimbleAccessControlRecordFieldsWithSortKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NimbleAccessControlRecordFieldsWithSortKey`
        """
        model = NimbleAccessControlRecordFieldsWithSortKey()
        if include_optional:
            return NimbleAccessControlRecordFieldsWithSortKey(
                access_protocol = 'fc',
    ...
    def testNimbleAccessControlRecordFieldsWithSortKey(self):
        """Test NimbleAccessControlRecordFieldsWithSortKey"""
